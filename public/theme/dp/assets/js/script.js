	...
	if($('.datanew').length > 0) {
		$('.datanew').DataTable({
			...
			"language": {
				...
				xinfo: "_START_ - _END_ of _TOTAL_ items",
				xpaginate: {
		...
		'<li class="sidebar-icons">' +
			'<a class="toggle tipinfo open-layout open-siderbar" href="javascript:void(0);" data-toggle="tooltip" data-placement="left" data-bs-original-title="Tooltip on left">' +
				'<div class="tooltip-five ">' +
					'<img src="/theme/dp/assets/img/icons/siderbar-icon2.svg" class="feather-five" alt="">' +
					...
					'<div class="col-xl-6 col-sm-6 col-12">' +
						'<div class="sidebar-logo">' +
							'<a href="index" class="logo">' +
								'<img src="/theme/dp/assets/img/logo.png" alt="Logo" class="img-flex">' +
							'</a>' +
						'</div>' +
					'</div>' +
					'<div class="col-xl-6 col-sm-6 col-12">' +
						'<a class="btn-closed" href="javascript:void(0);"><img class="img-fliud" src="/theme/dp/assets/img/icons/sidebar-delete-icon.svg" alt="demo"></a>' +
					'</div>' +
				'</div>' +
			'</div>' +
		'</div>' +
			...
			'<div class="row align-items-center">' +
				...
				'<div class="col-xl-12 col-sm-6 col-12">' +
					'<div class="sidebar-image align-center">' +
						'<img class="img-fliud" src="/theme/dp/assets/img/demo-one.png" alt="demo">' +
					'</div>' +
					'<div class="row">' +
			...
			'<ul class="sticky-sidebar">' +
				'<li class="sidebar-icons">' +
					'<a href="#" class="add-setting" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-original-title="Tooltip on left">' +
						'<img src="/theme/dp/assets/img/icons/sidebar-icon-01.svg" class="feather-five" alt="">' +
					'</a>' +
				'</li>' +
				'<li class="sidebar-icons">' +
					'<a href="#" class="navigation-add" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-original-title="Tooltip on left">' +
						'<img src="/theme/dp/assets/img/icons/sidebar-icon-02.svg" class="feather-five" alt="">' +
					'</a>' +
				'</li>' +
				'<li class="sidebar-icons">' +
					'<a href="https://themeforest.net/item/dreamspos-pos-inventory-management-admin-dashboard-template/38834413" target="_blank" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-original-title="Tooltip on left">' +
						'<img src="/theme/dp/assets/img/icons/sidebar-icon-03.svg" class="feather-five" alt="">' +
					'</a>' +
				'</li>' +
			'</ul>' +
		'</div>' +
		...
		'<div class="sidebar-settings preview-toggle">' +
			'<div class="sidebar-content sticky-sidebar-one">' +
				'<div class="sidebar-header">' +
					...
					'<a class="sidebar-close" href="#"><img src="/theme/dp/assets/img/icons/close-icon.svg" alt=""></a>' +
				'</div>' +
				'<div class="sidebar-body">' +
					'<h6 class="theme-title">Choose Mode</h6>' +
					'<div class="switch-wrapper">' +
						'<div id="dark-mode-toggle">' +
							'<span class="light-mode active"> <img src="/theme/dp/assets/img/icons/sun-icon.svg" class="me-2" alt=""> Light</span>' +
						...
						'<div class="col-xl-6 ere">' +
							'<div class="layout-wrap">' +								
								...
								'<div class="layout-img">' +
									'<img class="img-fliud" src="/theme/dp/assets/img/theme/layout-ltr.png" alt="layout">' +
								'</div>' +
							'</div>' +
						'</div>' +
						'<div class="col-xl-6 ere">' +
							'<div class="layout-wrap">' +								
								...
								'</div>' +
								'<div class="layout-img">' +
									'<img class="img-fliud" src="/theme/dp/assets/img/theme/layout-rtl.png" alt="layout">' +
								'</div>' +
							'</div>' +
						'</div>' +
					'</div>' +
					'<div class="row  ">' +
						'<div class="col-xl-6 ere">' +
							'<div class="layout-wrap">' +								
								...
								'</div>' +
								'<div class="layout-img">' +
									'<img class="img-fliud" src="/theme/dp/assets/img/theme/layout-04.png" alt="layout">' +
								'</div>' +
							'</div>' +
						'</div>' +
						'<div class="col-xl-6 ere">' +
						 	'<div class="layout-wrap">' +								
								...
								'</div>' +
							 	'<div class="layout-img">' +
									 '<img class="img-fliud" src="/theme/dp/assets/img/theme/layout-01.png" alt="layout">' +
							 	'</div>' +
						 	'</div>' +
						'</div>' +
					'</div>' +
				 	...
				 	'<div class="row  ">' +
						'<div class="col-xl-6 ere">' +
							'<div class="layout-wrap">' +								
								...
								'</div>' +
								'<div class="layout-img">' +
									'<img class="img-fliud" src="/theme/dp/assets/img/theme/layout-03.png" alt="layout">' +
								'</div>' +
							'</div>' +
						'</div>' +
						'<div class="col-xl-6 ere">' +
	...
	$(".quantity-btn").on("click", function () {
		...
		if ($('#phone').length > 0) {
			...
			window.intlTelInput(input, {
				utilsScript: "/theme/dp/assets/plugins/intltelinput/js/utils.js",
			});
		}
