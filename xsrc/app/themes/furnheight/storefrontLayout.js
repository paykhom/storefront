    ...
    <main class="content-wrapper">
      ...
      <section class="bg-body-tertiary min-vh-100 d-flex align-items-center overflow-hidden" style="margin-top: -110px; padding-top: 110px">
        <div class="container h-100 py-5 my-md-2 my-lg-3 my-xl-4 mb-xxl-5">
          ...
          <div class="row align-items-center justify-content-center gx-3 gx-sm-4 mb-3 mb-sm-4">
            ...
            <div class="col-lg-1 col-xl-2 d-none d-lg-flex justify-content-end">
              <div class="position-relative user-select-none" style="width: 262px">
                ...
                <div class="swiper position-relative z-2 opacity-60 rounded-circle pe-none swiper-coverflow swiper-3d swiper-initialized swiper-horizontal swiper-watch-progress" id="thumbsPrev" data-swiper="{
                  ...
                  <div class="swiper-wrapper" style="transform: translate3d(0px, 0px, 0px);" id="swiper-wrapper-981069db264d116b5" aria-live="polite">
                    <div class="swiper-slide swiper-slide-visible swiper-slide-fully-visible swiper-slide-active" style="width: 262px; transform: translate3d(0px, 0px, 0px) rotateX(0deg) rotateY(0deg) scale(1); z-index: 1;" role="group" aria-label="1 / 4" data-swiper-slide-index="0">
                      <div class="ratio ratio-1x1">
                        <img src="/themes/cartzilla/assets/img/home/furniture/hero-slider/th04.png" alt="Thumbnail">
                      </div>
                    </div>
                    <div class="swiper-slide swiper-slide-next" style="width: 262px; transform: translate3d(100px, 0px, 200px) rotateX(0deg) rotateY(0deg) scale(1.3); z-index: 0;" role="group" aria-label="2 / 4" data-swiper-slide-index="1">
                      <div class="ratio ratio-1x1">
                        <img src="/themes/cartzilla/assets/img/home/furniture/hero-slider/th01.png" alt="Thumbnail">
                      </div>
                    </div>
                    <div class="swiper-slide" style="width: 262px; transform: translate3d(200px, 0px, 400px) rotateX(0deg) rotateY(0deg) scale(1.6); z-index: -1;" role="group" aria-label="3 / 4" data-swiper-slide-index="2">
                      <div class="ratio ratio-1x1">
                        <img src="/themes/cartzilla/assets/img/home/furniture/hero-slider/th02.png" alt="Thumbnail">
                      </div>
                    </div>
                    <div class="swiper-slide" role="group" aria-label="4 / 4" style="width: 262px; transform: translate3d(300px, 0px, 600px) rotateX(0deg) rotateY(0deg) scale(1.9); z-index: -2;" data-swiper-slide-index="3">
                      <div class="ratio ratio-1x1">
                        <img src="/themes/cartzilla/assets/img/home/furniture/hero-slider/th03.png" alt="Thumbnail">
                      </div>
                    </div>
                  </div>
            ...
            <div class="col-auto col-sm-1 order-1 order-lg-2 d-flex align-items-center justify-content-center">
              <button type="button" class="btn-prev btn btn-lg btn-icon btn-outline-secondary rounded-circle animate-slide-start" aria-label="Previous slide" tabindex="0" aria-controls="swiper-wrapper-1631fa2accf44491">
            ...
            <div class="col-sm-10 col-lg-8 col-xl-6 order-3">
              <div class="swiper user-select-none rounded-pill swiper-coverflow swiper-3d swiper-initialized swiper-horizontal swiper-watch-progress" data-swiper="{
                &quot;loop&quot;: true,
                &quot;grabCursor&quot;: true,
                &quot;speed&quot;: 600,
                ...
                <div class="swiper-wrapper" style="cursor: grab; transform: translate3d(0px, 0px, 0px);" id="swiper-wrapper-1631fa2accf44491" aria-live="polite">
                  <div class="swiper-slide swiper-slide-visible swiper-slide-fully-visible swiper-slide-active" data-swiper-binded="#description1" style="width: 614px; transform: translate3d(0px, 0px, 0px) rotateX(0deg) rotateY(0deg) scale(1); z-index: 1;" role="group" aria-label="1 / 4" data-swiper-slide-index="0">
                    <div class="ratio" style="--cz-aspect-ratio: calc(400 / 636 * 100%)">
                      <img src="/themes/cartzilla/assets/img/home/furniture/hero-slider/01.png" alt="Image">
                    </div>
                  </div>
                  <div class="swiper-slide swiper-slide-next" data-swiper-binded="#description2" style="width: 614px; transform: translate3d(100px, 0px, 200px) rotateX(0deg) rotateY(0deg) scale(1.3); z-index: 0;" role="group" aria-label="2 / 4" data-swiper-slide-index="1">
                    <div class="ratio" style="--cz-aspect-ratio: calc(400 / 636 * 100%)">
                      <img src="/themes/cartzilla/assets/img/home/furniture/hero-slider/02.png" alt="Image">
                    </div>
                  </div>
                  <div class="swiper-slide" data-swiper-binded="#description3" style="width: 614px; transform: translate3d(200px, 0px, 400px) rotateX(0deg) rotateY(0deg) scale(1.6); z-index: -1;" role="group" aria-label="3 / 4" data-swiper-slide-index="2">
                    <div class="ratio" style="--cz-aspect-ratio: calc(400 / 636 * 100%)">
                      <img src="/themes/cartzilla/assets/img/home/furniture/hero-slider/03.png" alt="Image">
                    </div>
                  </div>
                  <div class="swiper-slide" data-swiper-binded="#description4" role="group" aria-label="4 / 4" style="width: 614px; transform: translate3d(300px, 0px, 600px) rotateX(0deg) rotateY(0deg) scale(1.9); z-index: -2;" data-swiper-slide-index="3">
                    <div class="ratio" style="--cz-aspect-ratio: calc(400 / 636 * 100%)">
                      <img src="/themes/cartzilla/assets/img/home/furniture/hero-slider/04.png" alt="Image">
                    </div>
                  </div>
                </div>
            ...
            <div class="col-auto col-sm-1 order-2 order-sm-3 order-lg-4 d-flex align-items-center justify-content-center">
              <button type="button" class="btn-next btn btn-lg btn-icon btn-outline-secondary rounded-circle animate-slide-end" aria-label="Next slide" tabindex="0" aria-controls="swiper-wrapper-1631fa2accf44491">
            ...
            <div class="col-lg-1 col-xl-2 order-lg-5 d-none d-lg-block">
              <div class="position-relative user-select-none" style="width: 262px">
                <span class="position-absolute top-0 start-0 w-100 h-100 bg-white opacity-50 rounded-circle d-none-dark"></span>
                <span class="position-absolute top-0 start-0 w-100 h-100 bg-white rounded-circle d-none-dark d-none d-block-dark" style="opacity: .05"></span>
                <div class="swiper position-relative z-2 opacity-60 rounded-circle pe-none swiper-coverflow swiper-3d swiper-initialized swiper-horizontal swiper-watch-progress" id="thumbsNext" data-swiper="{
                  &quot;allowTouchMove&quot;: false,
                  &quot;loop&quot;: true,
                  &quot;effect&quot;: &quot;coverflow&quot;,
                  &quot;coverflowEffect&quot;: {
                  ...
                  <div class="swiper-wrapper" style="transform: translate3d(0px, 0px, 0px);" id="swiper-wrapper-5e9f7ff32085289d" aria-live="polite">
                    <div class="swiper-slide swiper-slide-visible swiper-slide-fully-visible swiper-slide-active" style="width: 262px; transform: translate3d(0px, 0px, 0px) rotateX(0deg) rotateY(0deg) scale(1); z-index: 1;" role="group" aria-label="1 / 4" data-swiper-slide-index="0">
                      <div class="ratio ratio-1x1">
                        <img src="/themes/cartzilla/assets/img/home/furniture/hero-slider/th02.png" alt="Thumbnail">
                      </div>
          ...
          <div class="swiper swiper-fade swiper-initialized swiper-horizontal swiper-watch-progress swiper-backface-hidden" id="captions" data-swiper="{
            &quot;allowTouchMove&quot;: false,
            &quot;loop&quot;: true,
            &quot;effect&quot;: &quot;fade&quot;
          }">
            <div class="swiper-wrapper" id="swiper-wrapper-92c8245672312673" aria-live="polite">
              <div class="swiper-slide bg-body-tertiary text-center swiper-slide-visible swiper-slide-fully-visible swiper-slide-active" style="width: 1251px; opacity: 1; transform: translate3d(0px, 0px, 0px);" role="group" aria-label="1 / 4" data-swiper-slide-index="0">
              ...
              <div class="swiper-slide bg-body-tertiary text-center swiper-slide-next" style="width: 1251px; opacity: 0; transform: translate3d(-1251px, 0px, 0px);" role="group" aria-label="2 / 4" data-swiper-slide-index="1">
              ...
              <div class="swiper-slide bg-body-tertiary text-center" style="width: 1251px; opacity: 0; transform: translate3d(-2502px, 0px, 0px);" role="group" aria-label="3 / 4" data-swiper-slide-index="2">
              ...
              <div class="swiper-slide bg-body-tertiary text-center" role="group" aria-label="4 / 4" style="width: 1251px; opacity: 0; transform: translate3d(-3753px, 0px, 0px);" data-swiper-slide-index="3">
      ...
      <section class="container py-5 my-2 my-sm-3 mb-md-2 mt-lg-4 my-xl-5">
        <div class="overflow-x-auto pt-xxl-3" data-simplebar="init" data-simplebar-auto-hide="false"><div class="simplebar-wrapper" style="margin: 0px;"><div class="simplebar-height-auto-observer-wrapper"><div class="simplebar-height-auto-observer"></div></div><div class="simplebar-mask"><div class="simplebar-offset" style="right: 0px; bottom: 0px;"><div class="simplebar-content-wrapper" tabindex="0" role="region" aria-label="scrollable content" style="height: auto; overflow: hidden;"><div class="simplebar-content" style="padding: 0px;">
                ...
                <div class="category-card-body">
                  <a class="d-block text-decoration-none" href="shop-catalog-furniture.html">
                    <div class="bg-body-tertiary rounded-pill mb-3 mx-auto" style="max-width: 164px">
                      <div class="ratio ratio-1x1">
                        <img src="/themes/cartzilla/assets/img/home/furniture/categories/01.png" class="rounded-pill" alt="Image">
                      </div>
                    </div>
              ...
              <div class="category-card w-100 text-center px-1 px-lg-2 px-xxl-3 mx-auto" style="min-width: 165px">
                <div class="category-card-body">
                  <a class="d-block text-decoration-none" href="shop-catalog-furniture.html">
                    <div class="bg-body-tertiary rounded-pill mb-3 mx-auto" style="max-width: 164px">
                      <div class="ratio ratio-1x1">
                        <img src="/themes/cartzilla/assets/img/home/furniture/categories/02.png" class="rounded-pill" alt="Image">
                      </div>
                    </div>
              ...
              <div class="category-card w-100 text-center px-1 px-lg-2 px-xxl-3 mx-auto" style="min-width: 165px">
                <div class="category-card-body">
                  <a class="d-block text-decoration-none" href="shop-catalog-furniture.html">
                    <div class="bg-body-tertiary rounded-pill mb-3 mx-auto" style="max-width: 164px">
                      <div class="ratio ratio-1x1">
                        <img src="/themes/cartzilla/assets/img/home/furniture/categories/03.png" class="rounded-pill" alt="Image">
                      </div>
                    </div>
              ...
              <div class="category-card w-100 text-center px-1 px-lg-2 px-xxl-3 mx-auto" style="min-width: 165px">
                <div class="category-card-body">
                  <a class="d-block text-decoration-none" href="shop-catalog-furniture.html">
                    <div class="bg-body-tertiary rounded-pill mb-3 mx-auto" style="max-width: 164px">
                      <div class="ratio ratio-1x1">
                        <img src="/themes/cartzilla/assets/img/home/furniture/categories/04.png" class="rounded-pill" alt="Image">
                      </div>
                    </div>
              ...
              <div class="category-card w-100 text-center px-1 px-lg-2 px-xxl-3 mx-auto" style="min-width: 165px">
                <div class="category-card-body">
                  <a class="d-block text-decoration-none" href="shop-catalog-furniture.html">
                    <div class="bg-body-tertiary rounded-pill mb-3 mx-auto" style="max-width: 164px">
                      <div class="ratio ratio-1x1">
                        <img src="/themes/cartzilla/assets/img/home/furniture/categories/05.png" class="rounded-pill" alt="Image">
                      </div>
                    </div>
              ...
              <div class="category-card w-100 text-center px-1 px-lg-2 px-xxl-3 mx-auto" style="min-width: 165px">
                <div class="category-card-body">
                  <a class="d-block text-decoration-none" href="shop-catalog-furniture.html">
                    <div class="bg-body-tertiary rounded-pill mb-3 mx-auto" style="max-width: 164px">
                      <div class="ratio ratio-1x1">
                        <img src="/themes/cartzilla/assets/img/home/furniture/categories/06.png" class="rounded-pill" alt="Image">
                      </div>
                    </div>
        ...
        </div></div></div></div><div class="simplebar-placeholder" style="width: 1251px; height: 242px;"></div></div><div class="simplebar-track simplebar-horizontal" style="visibility: hidden;"><div class="simplebar-scrollbar simplebar-visible" style="width: 0px; display: none;"></div></div><div class="simplebar-track simplebar-vertical" style="visibility: hidden;"><div class="simplebar-scrollbar simplebar-visible" style="height: 0px; display: none;"></div></div></div>
      </section>
      ...
      <section class="container pb-5 mt-md-n2 mb-2 mb-sm-3 mb-md-4 mb-xl-5">
        ...
        <div class="position-relative pb-xxl-3">
          ...
          <button type="button" class="popular-prev btn btn-icon btn-outline-secondary bg-body rounded-circle animate-slide-start position-absolute top-50 start-0 z-2 translate-middle mt-n5 d-none d-sm-inline-flex" aria-label="Previous slide" tabindex="0" aria-controls="swiper-wrapper-09a31aff5fd2cadb">
            <i class="ci-chevron-left fs-lg animate-target"></i>
          </button>
          <button type="button" class="popular-next btn btn-icon btn-outline-secondary bg-body rounded-circle animate-slide-end position-absolute top-50 start-100 z-2 translate-middle mt-n5 d-none d-sm-inline-flex" aria-label="Next slide" tabindex="0" aria-controls="swiper-wrapper-09a31aff5fd2cadb">
          ...
          <div class="swiper pt-3 pt-sm-4 swiper-initialized swiper-horizontal swiper-backface-hidden" data-swiper="{
            ...
            <div class="swiper-wrapper" id="swiper-wrapper-09a31aff5fd2cadb" aria-live="polite">

              <!-- Item -->
              <div class="swiper-slide swiper-slide-active" style="width: 294.75px; margin-right: 24px;" role="group" aria-label="1 / 6" data-swiper-slide-index="0">
                <div class="animate-underline">
                  <a class="hover-effect-opacity ratio ratio-1x1 d-block mb-3" href="shop-product-furniture.html">
                    <img src="/themes/cartzilla/assets/img/shop/furniture/04.png" class="hover-effect-target opacity-100" alt="Product">
                    <img src="/themes/cartzilla/assets/img/shop/furniture/04-hover.jpg" class="position-absolute top-0 start-0 hover-effect-target opacity-0 rounded-4" alt="Room">
                  </a>
              ...
              <!-- Item -->
              <div class="swiper-slide swiper-slide-next" style="width: 294.75px; margin-right: 24px;" role="group" aria-label="2 / 6" data-swiper-slide-index="1">
                <div class="animate-underline">
                  <a class="hover-effect-opacity ratio ratio-1x1 d-block mb-3" href="shop-product-furniture.html">
                    <img src="/themes/cartzilla/assets/img/shop/furniture/05.png" class="hover-effect-target opacity-100" alt="Product">
                    <img src="/themes/cartzilla/assets/img/shop/furniture/05-hover.jpg" class="position-absolute top-0 start-0 hover-effect-target opacity-0 rounded-4" alt="Room">
                  </a>
                  <div class="d-flex gap-2 mb-3">
              ...
              <!-- Item -->
              <div class="swiper-slide" style="width: 294.75px; margin-right: 24px;" role="group" aria-label="3 / 6" data-swiper-slide-index="2">
                <div class="animate-underline">
                  <a class="hover-effect-opacity ratio ratio-1x1 d-block mb-3" href="shop-product-furniture.html">
                    <div class="position-absolute top-0 start-0 z-2 mt-2 mt-sm-3 ms-2 ms-sm-3">
                      <span class="badge text-bg-danger">-13%</span>
                    </div>
                    <img src="/themes/cartzilla/assets/img/shop/furniture/06.png" class="hover-effect-target opacity-100" alt="Product">
                    <img src="/themes/cartzilla/assets/img/shop/furniture/06-hover.jpg" class="position-absolute top-0 start-0 hover-effect-target opacity-0 rounded-4" alt="Room">
                  </a>
                  <div class="d-flex gap-2 mb-3">
              ...
              <!-- Item -->
              <div class="swiper-slide" style="width: 294.75px; margin-right: 24px;" role="group" aria-label="4 / 6" data-swiper-slide-index="3">
                <div class="animate-underline">
                  <a class="hover-effect-opacity ratio ratio-1x1 d-block mb-3" href="shop-product-furniture.html">
                    <img src="/themes/cartzilla/assets/img/shop/furniture/08.png" class="hover-effect-target opacity-100" alt="Product">
                    <img src="/themes/cartzilla/assets/img/shop/furniture/08-hover.jpg" class="position-absolute top-0 start-0 hover-effect-target opacity-0 rounded-4" alt="Room">
                  </a>
                  <div class="d-flex gap-2 mb-3">
              ...
              <!-- Item -->
              <div class="swiper-slide" style="width: 294.75px; margin-right: 24px;" role="group" aria-label="5 / 6" data-swiper-slide-index="4">
                <div class="animate-underline">
                  <a class="hover-effect-opacity ratio ratio-1x1 d-block mb-3" href="shop-product-furniture.html">
                    <img src="/themes/cartzilla/assets/img/shop/furniture/02.png" class="hover-effect-target opacity-100" alt="Product">
                    <img src="/themes/cartzilla/assets/img/shop/furniture/02-hover.jpg" class="position-absolute top-0 start-0 hover-effect-target opacity-0 rounded-4" alt="Room">
                  </a>
                  <div class="d-flex gap-2 mb-3">
              ...
              <!-- Item -->
              <div class="swiper-slide" role="group" aria-label="6 / 6" data-swiper-slide-index="5" style="width: 294.75px; margin-right: 24px;">
                <div class="animate-underline">
                  <a class="hover-effect-opacity ratio ratio-1x1 d-block mb-3" href="shop-product-furniture.html">
                    <img src="/themes/cartzilla/assets/img/shop/furniture/07.png" class="hover-effect-target opacity-100" alt="Product">
                    <img src="/themes/cartzilla/assets/img/shop/furniture/07-hover.jpg" class="position-absolute top-0 start-0 hover-effect-target opacity-0 rounded-4" alt="Room">
                  </a>
                  <div class="d-flex gap-2 mb-3">
        ...
        <div class="d-flex justify-content-center gap-2 mt-1 pt-4 d-sm-none">
          <button type="button" class="popular-prev btn btn-icon btn-outline-secondary bg-body rounded-circle animate-slide-start me-1" aria-label="Previous slide" tabindex="0" aria-controls="swiper-wrapper-09a31aff5fd2cadb">
            <i class="ci-chevron-left fs-lg animate-target"></i>
          </button>
          <button type="button" class="popular-next btn btn-icon btn-outline-secondary bg-body rounded-circle animate-slide-end" aria-label="Next slide" tabindex="0" aria-controls="swiper-wrapper-09a31aff5fd2cadb">
            <i class="ci-chevron-right fs-lg animate-target"></i>
          </button>
        </div>
      </section>
      ...
      <section class="container pb-5 mb-sm-2 mb-md-3 mb-lg-4 mb-xl-5">
        ...
        <!-- Nav pills -->
        <nav class="overflow-x-auto mb-3" data-simplebar="init" data-simplebar-auto-hide="false"><div class="simplebar-wrapper" style="margin: 0px;"><div class="simplebar-height-auto-observer-wrapper"><div class="simplebar-height-auto-observer"></div></div><div class="simplebar-mask"><div class="simplebar-offset" style="right: 0px; bottom: 0px;"><div class="simplebar-content-wrapper" tabindex="0" role="region" aria-label="scrollable content" style="height: auto; overflow: hidden;"><div class="simplebar-content" style="padding: 0px;">
        ...
        </div></div></div></div><div class="simplebar-placeholder" style="width: 1251px; height: 56px;"></div></div><div class="simplebar-track simplebar-horizontal" style="visibility: hidden;"><div class="simplebar-scrollbar simplebar-visible" style="width: 0px; display: none;"></div></div><div class="simplebar-track simplebar-vertical" style="visibility: hidden;"><div class="simplebar-scrollbar simplebar-visible" style="height: 0px; display: none;"></div></div></nav>
        ...
        <div class="row g-4 g-sm-3 g-lg-4 mb-xxl-3">
          <div class="col-sm-5 d-flex flex-column gap-4 gap-sm-3 gap-lg-4">
            ...
            <div class="ratio" id="hotspots" style="--cz-aspect-ratio: calc(500 / 526 * 100%)">
              ...
              <img src="/themes/cartzilla/assets/img/home/furniture/gallery/01.jpg" class="rounded-5" alt="Image">
            </div>

            <!-- Item -->
            <div class="ratio" style="--cz-aspect-ratio: calc(529 / 526 * 100%)">
              <img src="/themes/cartzilla/assets/img/home/furniture/gallery/02.jpg" class="rounded-5" alt="Image">
            </div>
          </div>
          <div class="col-sm-7 d-flex flex-column gap-4 gap-sm-3 gap-lg-4">
            ...
            <div class="ratio" style="--cz-aspect-ratio: calc(664 / 746 * 100%)">
              <img src="/themes/cartzilla/assets/img/home/furniture/gallery/03.jpg" class="rounded-5" alt="Image">
            </div>

            <!-- Item -->
            <div class="ratio" style="--cz-aspect-ratio: calc(365 / 746 * 100%)">
              <img src="/themes/cartzilla/assets/img/home/furniture/gallery/04.jpg" class="rounded-5" alt="Image">
            </div>
          </div>
        </div>
      </section>
      ...
      <section class="container">
        <div class="row row-cols-1 row-cols-md-2 g-0 overflow-hidden rounded-5">
          ...
          <div class="col position-relative">
            ...
            <img src="/themes/cartzilla/assets/img/home/furniture/featured-product.png" class="position-absolute top-0 start-0 w-100 h-100 object-fit-cover z-1" alt="Image">
          ...
          <div class="col d-flex align-items-center justify-content-center bg-dark py-5 px-4 px-md-5" data-bs-theme="dark">
            <div class="text-center py-md-2 py-lg-3 py-xl-4" style="max-width: 400px">
              ...
              <div class="d-inline-flex pb-lg-2 pb-xl-0 mb-4 mb-xl-5">
                <img src="/themes/cartzilla/assets/img/home/furniture/featured-product-thumbnail.jpg" class="rounded" width="162" alt="Product">
              </div>
        ...
        <div class="row gy-5 mb-xxl-3">
          ...
          <article class="col-md-6">
            <a class="ratio d-flex hover-effect-scale rounded-4 overflow-hidden" href="#!" style="--cz-aspect-ratio: calc(500 / 636 * 100%)">
              <img src="/themes/cartzilla/assets/img/blog/grid/v2/01.jpg" class="hover-effect-target" alt="Image">
            </a>
            <div class="pt-4">
            ...
            <div class="row row-cols-1 row-cols-sm-2 gy-5">
              ...
              <article class="col">
                <a class="ratio d-flex hover-effect-scale rounded-4 overflow-hidden" href="#!" style="--cz-aspect-ratio: calc(260 / 306 * 100%)">
                  <img src="/themes/cartzilla/assets/img/blog/grid/v2/11.jpg" class="hover-effect-target" alt="Image">
                </a>
                <div class="pt-4">
                  <div class="nav pb-2 mb-1">
                    <a class="nav-link text-body fs-xs text-uppercase p-0" href="#!">Interior design</a>
              ...
              <article class="col">
                <a class="ratio d-flex hover-effect-scale rounded-4 overflow-hidden" href="#!" style="--cz-aspect-ratio: calc(260 / 306 * 100%)">
                  <img src="/themes/cartzilla/assets/img/blog/grid/v2/10.jpg" class="hover-effect-target" alt="Image">
                </a>
                <div class="pt-4">
                  <div class="nav pb-2 mb-1">
          ...
          <div class="col-md col-xl-8 order-md-2">
            <div class="text-center px-sm-4 mx-auto" style="max-width: 568px">
              ...
              <div class="d-flex justify-content-center gap-2 pt-4 pt-md-5 mt-1 mt-md-0">
                <a class="btn btn-icon fs-base btn-outline-secondary border-0" href="#!" data-bs-toggle="tooltip" data-bs-template="<div class=&quot;tooltip fs-xs mb-n2&quot; role=&quot;tooltip&quot;><div class=&quot;tooltip-inner bg-transparent text-white p-0&quot;></div></div>" aria-label="Follow us on YouTube" data-bs-original-title="YouTube">
                ...
                <a class="btn btn-icon fs-base btn-outline-secondary border-0" href="#!" data-bs-toggle="tooltip" data-bs-template="<div class=&quot;tooltip fs-xs mb-n2&quot; role=&quot;tooltip&quot;><div class=&quot;tooltip-inner bg-transparent text-white p-0&quot;></div></div>" aria-label="Follow us on Pinterest" data-bs-original-title="Pinterest">
