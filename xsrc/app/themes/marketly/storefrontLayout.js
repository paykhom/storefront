...
<html lang="en" data-bs-theme="light" data-pwa="true" dir="ltr"><head>
    ...
    <!-- SEO Meta Tags -->
    <title>Cartzilla | Marketplace</title>
    ...
    <main class="content-wrapper">
        ...
        <div class="container position-relative z-1 py-md-3 py-lg-4 py-xl-5">
          ...
          <div class="row pt-4 pt-sm-5 pb-4 pb-md-5 my-2 mt-sm-0 mb-sm-3 mb-md-0 mb-xl-2 mb-xxl-4">
            <div class="col-xl-10 pt-xxl-2">
              ...
              <p class="fs-lg mb-0">Discover top-notch 3D and vector illustrations, photos images, designs and mockups.</p>
            </div>
          </div>
          ...
          <div class="row row-cols-2 row-cols-sm-3 row-cols-lg-6 g-4 g-lg-3 g-xl-4 pb-2 mb-4">
            <div class="col">
              <a class="vstack position-relative animate-underline hover-effect-scale rounded-4 overflow-hidden text-dark-emphasis fw-medium text-decoration-none" href="shop-catalog-marketplace.html">
                <div class="ratio z-2 overflow-hidden" style="--cz-aspect-ratio: calc(130 / 196 * 100%)">
                  <img src="/themes/cartzilla/assets/img/home/marketplace/categories/01.jpg" class="hover-effect-target" alt="Image">
                </div>
            ...
            <div class="col">
              <a class="vstack position-relative animate-underline hover-effect-scale rounded-4 overflow-hidden text-dark-emphasis fw-medium text-decoration-none" href="shop-catalog-marketplace.html">
                <div class="ratio z-2 overflow-hidden" style="--cz-aspect-ratio: calc(130 / 196 * 100%)">
                  <img src="/themes/cartzilla/assets/img/home/marketplace/categories/02.jpg" class="hover-effect-target" alt="Image">
                </div>
                <div class="position-relative z-2 text-center py-3">
            ...
            <div class="col">
              <a class="vstack position-relative animate-underline hover-effect-scale rounded-4 overflow-hidden text-dark-emphasis fw-medium text-decoration-none" href="shop-catalog-marketplace.html">
                <div class="ratio z-2 overflow-hidden" style="--cz-aspect-ratio: calc(130 / 196 * 100%)">
                  <img src="/themes/cartzilla/assets/img/home/marketplace/categories/03.jpg" class="hover-effect-target" alt="Image">
                </div>
                <div class="position-relative z-2 text-center py-3">
            ...
            <div class="col">
              <a class="vstack position-relative animate-underline hover-effect-scale rounded-4 overflow-hidden text-dark-emphasis fw-medium text-decoration-none" href="shop-catalog-marketplace.html">
                <div class="ratio z-2 overflow-hidden" style="--cz-aspect-ratio: calc(130 / 196 * 100%)">
                  <img src="/themes/cartzilla/assets/img/home/marketplace/categories/04.jpg" class="hover-effect-target" alt="Image">
                </div>
                <div class="position-relative z-2 text-center py-3">
            ...
            <div class="col">
              <a class="vstack position-relative animate-underline hover-effect-scale rounded-4 overflow-hidden text-dark-emphasis fw-medium text-decoration-none" href="shop-catalog-marketplace.html">
                <div class="ratio z-2 overflow-hidden" style="--cz-aspect-ratio: calc(130 / 196 * 100%)">
                  <img src="/themes/cartzilla/assets/img/home/marketplace/categories/05.jpg" class="hover-effect-target" alt="Image">
                </div>
                <div class="position-relative z-2 text-center py-3">
            ...
            <div class="col">
              <a class="vstack position-relative animate-underline hover-effect-scale rounded-4 overflow-hidden text-dark-emphasis fw-medium text-decoration-none" href="shop-catalog-marketplace.html">
                <div class="ratio z-2 overflow-hidden" style="--cz-aspect-ratio: calc(130 / 196 * 100%)">
                  <img src="/themes/cartzilla/assets/img/home/marketplace/categories/06.jpg" class="hover-effect-target" alt="Image">
                </div>
                <div class="position-relative z-2 text-center py-3">
          ...
          <div class="d-sm-flex align-items-center gap-4 pb-2 pb-sm-4">
            ...
            <div class="d-flex gap-3">
              <a class="ratio ratio-1x1 d-flex flex-shrink-0" href="#!" style="width: 20px">
                <img src="/themes/cartzilla/assets/img/home/marketplace/formats/figma.png" alt="Figma">
              </a>
              <a class="ratio ratio-1x1 d-flex flex-shrink-0" href="#!" style="width: 20px">
                <img src="/themes/cartzilla/assets/img/home/marketplace/formats/framer.png" alt="Framer">
              </a>
              <a class="ratio ratio-1x1 d-flex flex-shrink-0" href="#!" style="width: 20px">
                <img src="/themes/cartzilla/assets/img/home/marketplace/formats/illustrator.png" alt="Illustrator">
              </a>
              <a class="ratio ratio-1x1 d-flex flex-shrink-0" href="#!" style="width: 20px">
                <img src="/themes/cartzilla/assets/img/home/marketplace/formats/webflow.png" alt="Webflow">
              </a>
              <a class="ratio ratio-1x1 d-flex flex-shrink-0" href="#!" style="width: 20px">
                <img src="/themes/cartzilla/assets/img/home/marketplace/formats/photoshop.png" alt="Photoshop">
              </a>
            </div>
          </div>
        </div>
      ...
      <section class="container pt-2 pt-sm-3 pt-md-4 pt-lg-5 pb-5 my-xxl-3">
        <div class="d-flex align-items-center justify-content-between gap-4 pt-5 pb-3 mb-1 mb-sm-2 mb-md-3">
          ...
          <div class="d-flex gap-2">
            <button type="button" class="btn btn-icon btn-outline-secondary animate-slide-start bg-body rounded-circle me-1" id="prod-prev" aria-label="Previous slide" tabindex="0" aria-controls="swiper-wrapper-fce07fbc0648b480">
              <i class="ci-chevron-left fs-lg animate-target"></i>
            </button>
            <button type="button" class="btn btn-icon btn-outline-secondary animate-slide-end bg-body rounded-circle" id="prod-next" aria-label="Next slide" tabindex="0" aria-controls="swiper-wrapper-fce07fbc0648b480">
        ...
        <div class="swiper swiper-initialized swiper-horizontal swiper-backface-hidden" data-swiper="{
          ...
          <div class="swiper-wrapper" id="swiper-wrapper-fce07fbc0648b480" aria-live="polite">

            <!-- Product -->
            <div class="swiper-slide swiper-slide-active" style="width: 613.5px; margin-right: 24px;" role="group" aria-label="1 / 3" data-swiper-slide-index="0">
              <div class="card animate-underline hover-effect-opacity hover-effect-scale rounded-4 overflow-hidden">
                <div class="card-img-top position-relative bg-body-tertiary overflow-hidden">
                  <a class="ratio d-block hover-effect-target" style="--cz-aspect-ratio: calc(220 / 304 * 100%)" href="shop-product-marketplace.html">
                    <img src="/themes/cartzilla/assets/img/home/marketplace/products/01.jpg" alt="Image">
                  </a>
                ...
                <div class="card-body p-3">
                  <div class="d-flex min-w-0 justify-content-between gap-3 mb-2">
                    <h3 class="nav min-w-0 mb-0">
                      <a class="nav-link fs-base text-truncate p-0" href="shop-product-marketplace.html">
                        <span class="text-truncate animate-target">Gradient 3D abstract shape illustration</span>
                      </a>
                    </h3>
                  ...
                  <div class="d-flex flex-wrap align-items-center justify-content-between gap-2">
                    <div class="nav align-items-center gap-1 fs-xs">
                      <a class="nav-link fs-xs text-body gap-1 p-0" href="shop-catalog-marketplace.html">
                        <div class="flex-shrink-0 border rounded-circle" style="width: 22px">
                          <div class="ratio ratio-1x1 rounded-circle overflow-hidden">
                            <img src="/themes/cartzilla/assets/img/shop/marketplace/avatars/01.png" alt="Avatar">
                          </div>
                        </div>
                        Createx Studio
                      </a>
                      <div class="text-body-secondary">in</div>
                      <a class="nav-link fs-xs text-body p-0" href="shop-catalog-marketplace.html">Vectors</a>
                    </div>
            ...
            <!-- Product -->
            <div class="swiper-slide swiper-slide-next" style="width: 613.5px; margin-right: 24px;" role="group" aria-label="2 / 3" data-swiper-slide-index="1">
              <div class="card animate-underline hover-effect-opacity hover-effect-scale rounded-4 overflow-hidden">
                <div class="card-img-top position-relative bg-body-tertiary overflow-hidden">
                  <a class="ratio d-block hover-effect-target" style="--cz-aspect-ratio: calc(220 / 304 * 100%)" href="shop-product-marketplace.html">
                    <img src="/themes/cartzilla/assets/img/home/marketplace/products/02.jpg" alt="Image">
                  </a>
                  <div class="position-absolute top-0 end-0 z-2 hover-effect-target opacity-0 pt-1 pt-sm-0 pe-1 pe-sm-0 mt-2 mt-sm-3 me-2 me-sm-3">
                    <button type="button" class="btn btn-sm btn-icon btn-light bg-light border-0 rounded-circle animate-pulse" aria-label="Add to wishlist">
                      <i class="ci-heart animate-target fs-sm"></i>
                ...
                <div class="card-body p-3">
                  <div class="d-flex min-w-0 justify-content-between gap-2 gap-sm-3 mb-2">
                    <h3 class="nav min-w-0 mb-0">
                      <a class="nav-link fs-base text-truncate p-0" href="shop-product-marketplace.html">
                        <span class="text-truncate animate-target">Beautiful gaming wallpaper 4K perfect for gaming monitors</span>
                      </a>
                    </h3>
                  ...
                  <div class="d-flex flex-wrap align-items-center justify-content-between gap-2">
                    <div class="nav align-items-center gap-1 fs-xs">
                      <a class="nav-link fs-xs text-body gap-1 p-0" href="shop-catalog-marketplace.html">
                        <div class="flex-shrink-0 border rounded-circle" style="width: 22px">
                          <div class="ratio ratio-1x1 rounded-circle overflow-hidden">
                            <img src="/themes/cartzilla/assets/img/shop/marketplace/avatars/02.png" alt="Avatar">
                          </div>
                        </div>
                        Magic FS
                      </a>
                      <div class="text-body-secondary">in</div>
                      <a class="nav-link fs-xs text-body p-0" href="shop-catalog-marketplace.html">AI images</a>
                    </div>
            ...
            <!-- Product -->
            <div class="swiper-slide" role="group" aria-label="3 / 3" data-swiper-slide-index="2" style="width: 613.5px; margin-right: 24px;">
              <div class="card animate-underline hover-effect-opacity hover-effect-scale rounded-4 overflow-hidden">
                <div class="card-img-top position-relative bg-body-tertiary overflow-hidden">
                  <a class="ratio d-block hover-effect-target" style="--cz-aspect-ratio: calc(220 / 304 * 100%)" href="shop-product-marketplace.html">
                    <img src="/themes/cartzilla/assets/img/home/marketplace/products/03.jpg" alt="Image">
                  </a>
                  <div class="position-absolute top-0 end-0 z-2 hover-effect-target opacity-0 pt-1 pt-sm-0 pe-1 pe-sm-0 mt-2 mt-sm-3 me-2 me-sm-3">
                    <button type="button" class="btn btn-sm btn-icon btn-light bg-light border-0 rounded-circle animate-pulse" aria-label="Add to wishlist">
                      <i class="ci-heart animate-target fs-sm"></i>
                ...
                <div class="card-body p-3">
                  <div class="d-flex min-w-0 justify-content-between gap-2 gap-sm-3 mb-2">
                    <h3 class="nav min-w-0 mb-0">
                      <a class="nav-link fs-base text-truncate p-0" href="shop-product-marketplace.html">
                        <span class="text-truncate animate-target">Glass effect 3D illustartion Cinema 4D</span>
                      </a>
                    </h3>
                  ...
                  <div class="d-flex flex-wrap align-items-center justify-content-between gap-2">
                    <div class="nav align-items-center gap-1 fs-xs">
                      <a class="nav-link fs-xs text-body gap-1 p-0" href="shop-catalog-marketplace.html">
                        <div class="flex-shrink-0 border rounded-circle" style="width: 22px">
                          <div class="ratio ratio-1x1 rounded-circle overflow-hidden">
                            <img src="/themes/cartzilla/assets/img/shop/marketplace/avatars/03.png" alt="Avatar">
                          </div>
                        </div>
                        MD Studio
                      </a>
                      <div class="text-body-secondary">in</div>
                      <a class="nav-link fs-xs text-body p-0" href="shop-catalog-marketplace.html">3D illustartions</a>
                    </div>
      ...
      <section class="container pt-2 pt-sm-3 pt-md-4 pt-lg-5 pb-5 my-xxl-3">
        ...
        <div class="row row-cols-2 row-cols-md-3 row-cols-lg-4 g-3 g-sm-4 g-lg-3 g-xl-4">
          ...
          <div class="col">
            <div class="card h-100 animate-underline hover-effect-opacity hover-effect-scale rounded-4 overflow-hidden">
              <div class="card-img-top position-relative bg-body-tertiary overflow-hidden">
                <a class="ratio d-block hover-effect-target" style="--cz-aspect-ratio: calc(220 / 304 * 100%)" href="shop-product-marketplace.html">
                  <img src="/themes/cartzilla/assets/img/shop/marketplace/12.jpg" alt="Image">
                </a>
                <div class="position-absolute top-0 end-0 z-2 hover-effect-target opacity-0 pt-1 pt-sm-0 pe-1 pe-sm-0 mt-2 mt-sm-3 me-2 me-sm-3">
                  <button type="button" class="btn btn-sm btn-icon btn-light bg-light border-0 rounded-circle animate-pulse" aria-label="Add to wishlist">
                    <i class="ci-heart animate-target fs-sm"></i>
          ...
          <div class="col">
            <div class="card h-100 animate-underline hover-effect-opacity hover-effect-scale rounded-4 overflow-hidden">
              <div class="card-img-top position-relative bg-body-tertiary overflow-hidden">
                <a class="ratio d-block hover-effect-target" style="--cz-aspect-ratio: calc(220 / 304 * 100%)" href="shop-product-marketplace.html">
                  <img src="/themes/cartzilla/assets/img/shop/marketplace/02.jpg" alt="Image">
                </a>
                <div class="position-absolute top-0 end-0 z-2 hover-effect-target opacity-0 pt-1 pt-sm-0 pe-1 pe-sm-0 mt-2 mt-sm-3 me-2 me-sm-3">
                  <button type="button" class="btn btn-sm btn-icon btn-light bg-light border-0 rounded-circle animate-pulse" aria-label="Add to wishlist">
                    <i class="ci-heart animate-target fs-sm"></i>
              ...
              <div class="card-body p-3">
                ...
                <div class="d-flex flex-wrap align-items-center justify-content-between gap-2">
                  <div class="nav align-items-center gap-1 fs-xs">
                    ...
                    <div class="text-body-secondary">in</div>
                    <a class="nav-link fs-xs text-body p-0" href="shop-catalog-marketplace.html">Mockups</a>
                  </div>
          ...
          <div class="col">
            <div class="card h-100 animate-underline hover-effect-opacity hover-effect-scale rounded-4 overflow-hidden">
              <div class="card-img-top position-relative bg-body-tertiary overflow-hidden">
                <a class="ratio d-block hover-effect-target" style="--cz-aspect-ratio: calc(220 / 304 * 100%)" href="shop-product-marketplace.html">
                  <img src="/themes/cartzilla/assets/img/shop/marketplace/09.jpg" alt="Image">
                </a>
                <div class="position-absolute top-0 end-0 z-2 hover-effect-target opacity-0 pt-1 pt-sm-0 pe-1 pe-sm-0 mt-2 mt-sm-3 me-2 me-sm-3">
                  <button type="button" class="btn btn-sm btn-icon btn-light bg-light border-0 rounded-circle animate-pulse" aria-label="Add to wishlist">
                    <i class="ci-heart animate-target fs-sm"></i>
                ...
                <div class="d-flex flex-wrap align-items-center justify-content-between gap-2">
                  <div class="nav align-items-center gap-1 fs-xs">
                    <a class="nav-link fs-xs text-body gap-1 p-0" href="shop-catalog-marketplace.html">
                      <div class="flex-shrink-0 border rounded-circle" style="width: 22px">
                        <div class="ratio ratio-1x1 rounded-circle overflow-hidden">
                          <img src="/themes/cartzilla/assets/img/shop/marketplace/avatars/04.png" alt="Avatar">
                        </div>
                      </div>
                      Fireby
                    </a>
                    <div class="text-body-secondary">in</div>
                    <a class="nav-link fs-xs text-body p-0" href="shop-catalog-marketplace.html">3D illustration</a>
                  </div>
          ...
          <div class="col">
            <div class="card h-100 animate-underline hover-effect-opacity hover-effect-scale rounded-4 overflow-hidden">
              <div class="card-img-top position-relative bg-body-tertiary overflow-hidden">
                <a class="ratio d-block hover-effect-target" style="--cz-aspect-ratio: calc(220 / 304 * 100%)" href="shop-product-marketplace.html">
                  <img src="/themes/cartzilla/assets/img/shop/marketplace/13.jpg" alt="Image">
                </a>
                <div class="position-absolute top-0 end-0 z-2 hover-effect-target opacity-0 pt-1 pt-sm-0 pe-1 pe-sm-0 mt-2 mt-sm-3 me-2 me-sm-3">
                  <button type="button" class="btn btn-sm btn-icon btn-light bg-light border-0 rounded-circle animate-pulse" aria-label="Add to wishlist">
                    <i class="ci-heart animate-target fs-sm"></i>
          ...
          <div class="col">
            <div class="card h-100 animate-underline hover-effect-opacity hover-effect-scale rounded-4 overflow-hidden">
              <div class="card-img-top position-relative bg-body-tertiary overflow-hidden">
                <a class="ratio d-block hover-effect-target" style="--cz-aspect-ratio: calc(220 / 304 * 100%)" href="shop-product-marketplace.html">
                  <img src="/themes/cartzilla/assets/img/shop/marketplace/14.jpg" alt="Image">
                </a>
                <div class="position-absolute top-0 end-0 z-2 hover-effect-target opacity-0 pt-1 pt-sm-0 pe-1 pe-sm-0 mt-2 mt-sm-3 me-2 me-sm-3">
                  <button type="button" class="btn btn-sm btn-icon btn-light bg-light border-0 rounded-circle animate-pulse" aria-label="Add to wishlist">
                    <i class="ci-heart animate-target fs-sm"></i>
              ...
              <div class="card-body p-3">
                ...
                <div class="d-flex flex-wrap align-items-center justify-content-between gap-2">
                  <div class="nav align-items-center gap-1 fs-xs">
                    ...
                    <div class="text-body-secondary">in</div>
                    <a class="nav-link fs-xs text-body p-0" href="shop-catalog-marketplace.html">Templates</a>
                  </div>
          ...
          <div class="col">
            <div class="card h-100 animate-underline hover-effect-opacity hover-effect-scale rounded-4 overflow-hidden">
              <div class="card-img-top position-relative bg-body-tertiary overflow-hidden">
                <a class="ratio d-block hover-effect-target" style="--cz-aspect-ratio: calc(220 / 304 * 100%)" href="shop-product-marketplace.html">
                  <img src="/themes/cartzilla/assets/img/shop/marketplace/03.jpg" alt="Image">
                </a>
                <div class="position-absolute top-0 end-0 z-2 hover-effect-target opacity-0 pt-1 pt-sm-0 pe-1 pe-sm-0 mt-2 mt-sm-3 me-2 me-sm-3">
                  <button type="button" class="btn btn-sm btn-icon btn-light bg-light border-0 rounded-circle animate-pulse" aria-label="Add to wishlist">
                    <i class="ci-heart animate-target fs-sm"></i>
          ...
          <div class="col">
            <div class="card h-100 animate-underline hover-effect-opacity hover-effect-scale rounded-4 overflow-hidden">
              <div class="card-img-top position-relative bg-body-tertiary overflow-hidden">
                <a class="ratio d-block hover-effect-target" style="--cz-aspect-ratio: calc(220 / 304 * 100%)" href="shop-product-marketplace.html">
                  <img src="/themes/cartzilla/assets/img/shop/marketplace/06.jpg" alt="Image">
                </a>
                <div class="position-absolute top-0 end-0 z-2 hover-effect-target opacity-0 pt-1 pt-sm-0 pe-1 pe-sm-0 mt-2 mt-sm-3 me-2 me-sm-3">
                  <button type="button" class="btn btn-sm btn-icon btn-light bg-light border-0 rounded-circle animate-pulse" aria-label="Add to wishlist">
                    <i class="ci-heart animate-target fs-sm"></i>
              ...
              <div class="card-body p-3">
                <div class="d-flex min-w-0 justify-content-between gap-2 gap-sm-3 mb-2">
                  <h3 class="nav min-w-0 mb-0">
                    <a class="nav-link text-truncate p-0" href="shop-product-marketplace.html">
                      <span class="text-truncate animate-target">A stunning set of tablet pro mockups</span>
                    </a>
                  </h3>
          ...
          <div class="col">
            <div class="card h-100 animate-underline hover-effect-opacity hover-effect-scale rounded-4 overflow-hidden">
              <div class="card-img-top position-relative bg-body-tertiary overflow-hidden">
                <a class="ratio d-block hover-effect-target" style="--cz-aspect-ratio: calc(220 / 304 * 100%)" href="shop-product-marketplace.html">
                  <img src="/themes/cartzilla/assets/img/shop/marketplace/18.jpg" alt="Image">
                </a>
                <div class="position-absolute top-0 end-0 z-2 hover-effect-target opacity-0 pt-1 pt-sm-0 pe-1 pe-sm-0 mt-2 mt-sm-3 me-2 me-sm-3">
                  <button type="button" class="btn btn-sm btn-icon btn-light bg-light border-0 rounded-circle animate-pulse" aria-label="Add to wishlist">
                    <i class="ci-heart animate-target fs-sm"></i>
        ...
        <div class="text-center pt-3 mt-2 mt-sm-3">
          <a class="btn btn-lg btn-dark rounded-pill animate-slide-end" href="shop-catalog-marketplace.html">
        ...
        <div class="row row-cols-2 row-cols-md-4 gy-4 gx-3 gx-sm-4 gx-md-3 gx-xl-4">
          ...
          <div class="col">
            <div class="position-relative animate-underline">
              <div class="ratio bg-body-tertiary rounded overflow-hidden mb-1" style="--cz-aspect-ratio: calc(160 / 306 * 100%)">
                <img src="/themes/cartzilla/assets/img/home/marketplace/collections/01.jpg" alt="Image">
              </div>
              <div class="d-flex gap-1">
                <div class="ratio bg-body-tertiary rounded overflow-hidden" style="--cz-aspect-ratio: calc(160 / 151 * 100%)">
                  <img src="/themes/cartzilla/assets/img/home/marketplace/collections/02.jpg" alt="Image">
                </div>
                <div class="ratio bg-body-tertiary rounded overflow-hidden" style="--cz-aspect-ratio: calc(160 / 151 * 100%)">
                  <img src="/themes/cartzilla/assets/img/home/marketplace/collections/03.jpg" alt="Image">
                </div>
              </div>
              <div class="d-flex min-w-0 justify-content-between gap-2 gap-sm-3 pt-3">
                <h3 class="nav min-w-0 mb-0">
                  <a class="nav-link fs-base text-truncate stretched-link p-0" href="shop-catalog-marketplace.html">
                    <span class="text-truncate animate-target">Vectors</span>
                  </a>
                </h3>
                <button type="button" class="btn btn-sm btn-icon btn-light bg-transparent border-0 rounded-0 animate-pulse position-relative z-3" aria-label="Add to wishlist">
                  <i class="ci-heart animate-target fs-sm"></i>
                </button>
              </div>
          ...
          <div class="col">
            <div class="position-relative animate-underline">
              <div class="ratio bg-body-tertiary rounded overflow-hidden mb-1" style="--cz-aspect-ratio: calc(160 / 306 * 100%)">
                <img src="/themes/cartzilla/assets/img/home/marketplace/collections/04.jpg" alt="Image">
              </div>
              <div class="d-flex gap-1">
                <div class="ratio bg-body-tertiary rounded overflow-hidden" style="--cz-aspect-ratio: calc(160 / 151 * 100%)">
                  <img src="/themes/cartzilla/assets/img/home/marketplace/collections/05.jpg" alt="Image">
                </div>
                <div class="ratio bg-body-tertiary rounded overflow-hidden" style="--cz-aspect-ratio: calc(160 / 151 * 100%)">
                  <img src="/themes/cartzilla/assets/img/home/marketplace/collections/06.jpg" alt="Image">
                </div>
              </div>
              <div class="d-flex min-w-0 justify-content-between gap-2 gap-sm-3 pt-3">
                <h3 class="nav min-w-0 mb-0">
          ...
          <div class="col">
            <div class="position-relative animate-underline">
              <div class="ratio bg-body-tertiary rounded overflow-hidden mb-1" style="--cz-aspect-ratio: calc(160 / 306 * 100%)">
                <img src="/themes/cartzilla/assets/img/home/marketplace/collections/07.jpg" alt="Image">
              </div>
              <div class="d-flex gap-1">
                <div class="ratio bg-body-tertiary rounded overflow-hidden" style="--cz-aspect-ratio: calc(160 / 151 * 100%)">
                  <img src="/themes/cartzilla/assets/img/home/marketplace/collections/08.jpg" alt="Image">
                </div>
                <div class="ratio bg-body-tertiary rounded overflow-hidden" style="--cz-aspect-ratio: calc(160 / 151 * 100%)">
                  <img src="/themes/cartzilla/assets/img/home/marketplace/collections/09.jpg" alt="Image">
                </div>
              </div>
              <div class="d-flex min-w-0 justify-content-between gap-2 gap-sm-3 pt-3">
                <h3 class="nav min-w-0 mb-0">
          ...
          <div class="col">
            <div class="position-relative animate-underline">
              <div class="ratio bg-body-tertiary rounded overflow-hidden mb-1" style="--cz-aspect-ratio: calc(160 / 306 * 100%)">
                <img src="/themes/cartzilla/assets/img/home/marketplace/collections/10.jpg" alt="Image">
              </div>
              <div class="d-flex gap-1">
                <div class="ratio bg-body-tertiary rounded overflow-hidden" style="--cz-aspect-ratio: calc(160 / 151 * 100%)">
                  <img src="/themes/cartzilla/assets/img/home/marketplace/collections/11.jpg" alt="Image">
                </div>
                <div class="ratio bg-body-tertiary rounded overflow-hidden" style="--cz-aspect-ratio: calc(160 / 151 * 100%)">
                  <img src="/themes/cartzilla/assets/img/home/marketplace/collections/12.jpg" alt="Image">
                </div>
              </div>
              <div class="d-flex min-w-0 justify-content-between gap-2 gap-sm-3 pt-3">
                <h3 class="nav min-w-0 mb-0">
    ...
    <div class="floating-buttons position-fixed top-50 end-0 z-sticky me-3 me-xl-4 pb-4">
      <a class="btn-scroll-top btn btn-sm bg-body border-0 rounded-pill shadow animate-slide-end" href="#top">
        ...
        <svg class="position-absolute top-0 start-0 w-100 h-100 z-1" viewBox="0 0 62 32" fill="none" xmlns="http://www.w3.org/2000/svg">
          <rect x=".75" y=".75" width="60.5" height="30.5" rx="15.25" stroke="currentColor" stroke-width="1.5" stroke-miterlimit="10" style="stroke-dasharray: 155.201; stroke-dashoffset: 143.869;"></rect>
        </svg>
      </a>
    ...
    <div class="offcanvas offcanvas-end pb-sm-2 px-sm-2" id="shoppingCart" tabindex="-1" aria-labelledby="shoppingCartLabel" style="width: 500px">
      ...
      <div class="offcanvas-body d-flex flex-column gap-4 pt-2">
        ...
        <div class="d-flex align-items-center">
          <a class="flex-sm-shrink-0" href="shop-product-marketplace.html" style="width: 142px">
            <div class="ratio bg-body-tertiary rounded overflow-hidden" style="--cz-aspect-ratio: calc(110 / 142 * 100%)">
              <img src="/themes/cartzilla/assets/img/home/marketplace/cart/01.jpg" alt="Thumbnail">
            </div>
          </a>
          <div class="w-100 min-w-0 ps-3">
            ...
            <div class="d-flex align-items-center justify-content-between gap-1">
              <div class="w-100" style="max-width: 185px">
                <div class="choices" data-type="select-one" tabindex="0" role="listbox" aria-haspopup="true" aria-expanded="false"><div class="form-select form-select-sm rounded-pill"><select class="form-select form-select-sm rounded-pill choices__input" data-select="{
                  &quot;classNames&quot;: {
                    &quot;containerInner&quot;: [&quot;form-select&quot;, &quot;form-select-sm&quot;, &quot;rounded-pill&quot;]
                  },
                  &quot;removeItemButton&quot;: false
                }" aria-label="Small pill select" hidden="" tabindex="-1" data-choice="active">
                  <option value="standard" selected="">Standard license</option>
                  <option value="extended">Extended license</option>
                </select><div class="choices__list choices__list--single"><div class="choices__item choices__item--selectable" data-item="" data-id="1" data-value="standard" aria-selected="true" role="option">Standard license</div></div></div><div class="choices__list choices__list--dropdown" aria-expanded="false"><div class="choices__list" role="listbox"><div id="choices--fw44-item-choice-1" class="choices__item choices__item--choice is-selected choices__item--selectable is-highlighted" role="option" data-choice="" data-id="1" data-value="standard" data-choice-selectable="" aria-selected="true">Standard license</div><div id="choices--fw44-item-choice-2" class="choices__item choices__item--choice choices__item--selectable" role="option" data-choice="" data-id="2" data-value="extended" data-choice-selectable="">Extended license</div></div></div></div>
              </div>
        ...
        <div class="d-flex align-items-center">
          <a class="flex-sm-shrink-0" href="shop-product-marketplace.html" style="width: 142px">
            <div class="ratio bg-body-tertiary rounded overflow-hidden" style="--cz-aspect-ratio: calc(110 / 142 * 100%)">
              <img src="/themes/cartzilla/assets/img/home/marketplace/cart/02.jpg" alt="Thumbnail">
            </div>
          </a>
          <div class="w-100 min-w-0 ps-3">
            <h5 class="d-flex animate-underline mb-2">
            ...
            <div class="d-flex align-items-center justify-content-between gap-2">
              <div class="w-100" style="max-width: 185px">
                <div class="choices" data-type="select-one" tabindex="0" role="listbox" aria-haspopup="true" aria-expanded="false"><div class="form-select form-select-sm rounded-pill"><select class="form-select form-select-sm rounded-pill choices__input" data-select="{
                  ...
                  <option value="standard" selected="">Standard license</option>
                  <option value="extended">Extended license</option>
                </select><div class="choices__list choices__list--single"><div class="choices__item choices__item--selectable" data-item="" data-id="1" data-value="standard" aria-selected="true" role="option">Standard license</div></div></div><div class="choices__list choices__list--dropdown" aria-expanded="false"><div class="choices__list" role="listbox"><div id="choices--cfom-item-choice-1" class="choices__item choices__item--choice is-selected choices__item--selectable is-highlighted" role="option" data-choice="" data-id="1" data-value="standard" data-choice-selectable="" aria-selected="true">Standard license</div><div id="choices--cfom-item-choice-2" class="choices__item choices__item--choice choices__item--selectable" role="option" data-choice="" data-id="2" data-value="extended" data-choice-selectable="">Extended license</div></div></div></div>
              </div>
              <button type="button" class="btn btn-icon btn-sm flex-shrink-0 fs-sm" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-sm" data-bs-title="Remove" aria-label="Remove from cart">
                <i class="ci-trash fs-base"></i>
              </button>
        ...
        <div class="d-flex align-items-center">
          <a class="flex-sm-shrink-0" href="shop-product-marketplace.html" style="width: 142px">
            <div class="ratio bg-body-tertiary rounded overflow-hidden" style="--cz-aspect-ratio: calc(110 / 142 * 100%)">
              <img src="/themes/cartzilla/assets/img/home/marketplace/cart/03.jpg" alt="Thumbnail">
            </div>
          </a>
          <div class="w-100 min-w-0 ps-3">
            <h5 class="d-flex animate-underline mb-2">
            ...
            <div class="d-flex align-items-center justify-content-between gap-2">
              <div class="w-100" style="max-width: 185px">
                <div class="choices" data-type="select-one" tabindex="0" role="listbox" aria-haspopup="true" aria-expanded="false"><div class="form-select form-select-sm rounded-pill"><select class="form-select form-select-sm rounded-pill choices__input" data-select="{
                  ...
                  <option value="standard" selected="">Standard license</option>
                  <option value="extended">Extended license</option>
                </select><div class="choices__list choices__list--single"><div class="choices__item choices__item--selectable" data-item="" data-id="1" data-value="standard" aria-selected="true" role="option">Standard license</div></div></div><div class="choices__list choices__list--dropdown" aria-expanded="false"><div class="choices__list" role="listbox"><div id="choices--r18t-item-choice-1" class="choices__item choices__item--choice is-selected choices__item--selectable is-highlighted" role="option" data-choice="" data-id="1" data-value="standard" data-choice-selectable="" aria-selected="true">Standard license</div><div id="choices--r18t-item-choice-2" class="choices__item choices__item--choice choices__item--selectable" role="option" data-choice="" data-id="2" data-value="extended" data-choice-selectable="">Extended license</div></div></div></div>
              </div>
              <button type="button" class="btn btn-icon btn-sm flex-shrink-0 fs-sm" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-sm" data-bs-title="Remove" aria-label="Remove from cart">
                <i class="ci-trash fs-base"></i>
              </button>
