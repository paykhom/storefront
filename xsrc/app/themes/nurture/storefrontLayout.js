...
<html lang="en" data-bs-theme="light" data-pwa="true" dir="ltr"><head>
    ...
    <link rel="stylesheet" href="/themes/cartzilla/assets/vendor/simplebar/simplebar.min.css">
    <link rel="stylesheet" href="/themes/cartzilla/assets/vendor/choices.js/choices.min.css">
  ...
  <body>
      ...
      <div class="container py-lg-1">
        <div class="overflow-auto" data-simplebar="init"><div class="simplebar-wrapper" style="margin: 0px;"><div class="simplebar-height-auto-observer-wrapper"><div class="simplebar-height-auto-observer"></div></div><div class="simplebar-mask"><div class="simplebar-offset" style="right: 0px; bottom: 0px;"><div class="simplebar-content-wrapper" tabindex="0" role="region" aria-label="scrollable content" style="height: auto; overflow: hidden;"><div class="simplebar-content" style="padding: 0px;">
          <div class="nav flex-nowrap justify-content-between gap-4 py-2">
            ...
            <a class="nav-link align-items-center animate-underline gap-2 p-0" href="shop-catalog-grocery.html">
              <span class="d-flex align-items-center justify-content-center bg-body-tertiary rounded-circle" style="width: 40px; height: 40px">
                <img src="/themes/cartzilla/assets/img/mega-menu/grocery/th01.png" width="30" alt="Image">
              </span>
              <span class="d-block animate-target fw-semibold text-nowrap ms-1">Vegetables</span>
            </a>
            <a class="nav-link align-items-center animate-underline gap-2 p-0" href="shop-catalog-grocery.html">
              <span class="d-flex align-items-center justify-content-center bg-body-tertiary rounded-circle" style="width: 40px; height: 40px">
                <img src="/themes/cartzilla/assets/img/mega-menu/grocery/th02.png" width="30" alt="Image">
              </span>
            ...
            <a class="nav-link align-items-center animate-underline gap-2 m-0" href="shop-catalog-grocery.html">
              <span class="d-flex align-items-center justify-content-center bg-body-tertiary rounded-circle" style="width: 40px; height: 40px">
                <img src="/themes/cartzilla/assets/img/mega-menu/grocery/th03.png" width="30" alt="Image">
              </span>
              <span class="d-block animate-target fw-semibold text-nowrap ms-1">Poultry meat</span>
            </a>
            <a class="nav-link align-items-center animate-underline gap-2 p-0" href="shop-catalog-grocery.html">
              <span class="d-flex align-items-center justify-content-center bg-body-tertiary rounded-circle" style="width: 40px; height: 40px">
                <img src="/themes/cartzilla/assets/img/mega-menu/grocery/th04.png" width="30" alt="Image">
              </span>
              <span class="d-block animate-target fw-semibold text-nowrap ms-1">Fresh fruits</span>
            </a>
            <a class="nav-link align-items-center animate-underline gap-2 p-0" href="shop-catalog-grocery.html">
              <span class="d-flex align-items-center justify-content-center bg-body-tertiary rounded-circle" style="width: 40px; height: 40px">
                <img src="/themes/cartzilla/assets/img/mega-menu/grocery/th05.png" width="30" alt="Image">
              </span>
              <span class="d-block animate-target fw-semibold text-nowrap ms-1">St. Patrick's day</span>
            </a>
            <a class="nav-link align-items-center animate-underline gap-2 p-0" href="shop-catalog-grocery.html">
              <span class="d-flex align-items-center justify-content-center bg-body-tertiary rounded-circle" style="width: 40px; height: 40px">
                <img src="/themes/cartzilla/assets/img/mega-menu/grocery/th06.png" width="30" alt="Image">
              </span>
              <span class="d-block animate-target fw-semibold text-nowrap ms-1">Exotic fruits</span>
            </a>
          </div>
        </div></div></div></div><div class="simplebar-placeholder" style="width: 1251px; height: 72px;"></div></div><div class="simplebar-track simplebar-horizontal" style="visibility: hidden;"><div class="simplebar-scrollbar" style="width: 0px; display: none;"></div></div><div class="simplebar-track simplebar-vertical" style="visibility: hidden;"><div class="simplebar-scrollbar" style="height: 0px; display: none;"></div></div></div>
      </div>
    </section>
    ...
    <main class="content-wrapper">
      ...
      <section class="position-relative">
        <div class="swiper position-absolute top-0 start-0 w-100 h-100 swiper-fade swiper-initialized swiper-horizontal swiper-watch-progress swiper-backface-hidden" data-swiper="{
          &quot;effect&quot;: &quot;fade&quot;,
          &quot;loop&quot;: true,
          &quot;speed&quot;: 400,
          &quot;pagination&quot;: {
          ...
          <div class="swiper-wrapper" id="swiper-wrapper-f4b7da8946b2093e" aria-live="off" style="transition-duration: 0ms; transition-delay: 0ms;">

            <!-- Slide -->
            <div class="swiper-slide swiper-slide-prev" style="background-color: rgb(109, 175, 202); width: 1351px; opacity: 1; transform: translate3d(0px, 0px, 0px); transition-duration: 0ms;" role="group" aria-label="1 / 3" data-swiper-slide-index="0">
              ...
              <img src="/themes/cartzilla/assets/img/home/grocery/hero-slider/01.jpg" class="position-absolute top-0 start-0 w-100 h-100 object-fit-cover rtl-flip" alt="Image">
            </div>

            <!-- Slide -->
            <div class="swiper-slide swiper-slide-visible swiper-slide-fully-visible swiper-slide-active" style="background-color: rgb(90, 121, 120); width: 1351px; opacity: 1; transform: translate3d(-1351px, 0px, 0px); transition-duration: 0ms;" role="group" aria-label="2 / 3" data-swiper-slide-index="1">
              <div class="position-absolute d-flex align-items-center w-100 h-100 z-2">
                <div class="container mt-lg-n4">
                  <div class="row">
              ...
              <img src="/themes/cartzilla/assets/img/home/grocery/hero-slider/02.jpg" class="position-absolute top-0 start-0 w-100 h-100 object-fit-cover rtl-flip" alt="Image">
            </div>

            <!-- Slide -->
            <div class="swiper-slide swiper-slide-next" style="background-color: rgb(249, 156, 3); width: 1351px; opacity: 0; transform: translate3d(-2702px, 0px, 0px); transition-duration: 0ms;" role="group" aria-label="3 / 3" data-swiper-slide-index="2">
              <div class="position-absolute d-flex align-items-center w-100 h-100 z-2">
                <div class="container mt-lg-n4">
                  <div class="row">
                    <div class="col-9 col-sm-8 col-md-7 col-lg-6">
              ...
              <img src="/themes/cartzilla/assets/img/home/grocery/hero-slider/03.jpg" class="position-absolute top-0 start-0 w-100 h-100 object-fit-cover rtl-flip" alt="Image">
            </div>
          </div>

          <!-- Slider pagination (Bullets) -->
          <div class="swiper-pagination pb-sm-2 swiper-pagination-clickable swiper-pagination-bullets swiper-pagination-horizontal"><span class="swiper-pagination-bullet" tabindex="0" role="button" aria-label="Go to slide 1"></span><span class="swiper-pagination-bullet swiper-pagination-bullet-active" tabindex="0" role="button" aria-label="Go to slide 2" aria-current="true"></span><span class="swiper-pagination-bullet" tabindex="0" role="button" aria-label="Go to slide 3"></span></div>
      ...
      <section class="container pt-4 pb-5 mb-2 mb-sm-3 mb-lg-4 mb-xl-5">
        <div class="swiper swiper-initialized swiper-horizontal swiper-backface-hidden" data-swiper="{
          ...
          <div class="swiper-wrapper" id="swiper-wrapper-910a8510a8eb9dbd1d" aria-live="polite">

            <!-- Category -->
            <div class="swiper-slide h-auto swiper-slide-active" style="width: 401px; margin-right: 24px;" role="group" aria-label="1 / 3">
              <div class="position-relative d-flex justify-content-between align-items-center h-100 bg-primary-subtle rounded-5 overflow-hidden ps-2 ps-xl-3">
                ...
                <div class="ratio w-100 align-self-end rtl-flip" style="max-width: 216px; --cz-aspect-ratio: calc(240 / 216 * 100%)">
                  <img src="/themes/cartzilla/assets/img/home/grocery/featured/01.png" alt="Image">
                </div>
              </div>
            </div>

            <!-- Category -->
            <div class="swiper-slide h-auto swiper-slide-next" style="width: 401px; margin-right: 24px;" role="group" aria-label="2 / 3">
              <div class="position-relative d-flex justify-content-between align-items-center h-100 bg-success-subtle rounded-5 overflow-hidden ps-2 ps-xl-3">
                ...
                <div class="ratio w-100 align-self-end rtl-flip" style="max-width: 216px; --cz-aspect-ratio: calc(240 / 216 * 100%)">
                  <img src="/themes/cartzilla/assets/img/home/grocery/featured/02.png" alt="Image">
                </div>
              </div>
            </div>

            <!-- Category -->
            <div class="swiper-slide h-auto" role="group" aria-label="3 / 3" style="width: 401px; margin-right: 24px;">
              <div class="position-relative d-flex justify-content-between align-items-center h-100 bg-info-subtle rounded-5 overflow-hidden ps-2 ps-xl-3">
                ...
                <div class="ratio w-100 align-self-end rtl-flip" style="max-width: 216px; --cz-aspect-ratio: calc(240 / 216 * 100%)">
                  <img src="/themes/cartzilla/assets/img/home/grocery/featured/03.png" alt="Image">
                </div>
              </div>
            </div>
          </div>
          ...
          <!-- Slider pagination (Bullets) -->
          <div class="swiper-pagination position-static mt-3 mt-sm-4 swiper-pagination-clickable swiper-pagination-bullets swiper-pagination-horizontal swiper-pagination-lock"><span class="swiper-pagination-bullet swiper-pagination-bullet-active" tabindex="0" role="button" aria-label="Go to slide 1" aria-current="true"></span></div>
        <span class="swiper-notification" aria-live="assertive" aria-atomic="true"></span></div>
      </section>
          ...
          <div class="col-lg-3 pb-2 pb-sm-3 pb-md-4 mb-5 mb-lg-0">
            ...
            <div class="row nav g-3 g-sm-4">
              <div class="col-sm-6 col-md-4 col-lg-12 d-flex">
                <div class="position-relative d-flex min-w-0 align-items-center">
                  <div class="d-flex flex-shrink-0 align-items-center justify-content-center bg-body-tertiary rounded-circle" style="width: 56px; height: 56px">
                    <img src="/themes/cartzilla/assets/img/shop/grocery/categories/01.png" width="40" alt="Image">
                  </div>
              ...
              <div class="col-sm-6 col-md-4 col-lg-12 d-flex">
                <div class="position-relative d-flex min-w-0 align-items-center">
                  <div class="d-flex flex-shrink-0 align-items-center justify-content-center bg-body-tertiary rounded-circle" style="width: 56px; height: 56px">
                    <img src="/themes/cartzilla/assets/img/shop/grocery/categories/02.png" width="40" alt="Image">
                  </div>
                  <div class="min-w-0 ps-3">
                    <a class="nav-link animate-underline stretched-link fs-base fw-semibold p-0 mb-1" href="shop-catalog-grocery.html">
              ...
              <div class="col-sm-6 col-md-4 col-lg-12 d-flex">
                <div class="position-relative d-flex min-w-0 align-items-center">
                  <div class="d-flex flex-shrink-0 align-items-center justify-content-center bg-body-tertiary rounded-circle" style="width: 56px; height: 56px">
                    <img src="/themes/cartzilla/assets/img/shop/grocery/categories/03.png" width="40" alt="Image">
                  </div>
                  <div class="min-w-0 ps-3">
                    <a class="nav-link animate-underline stretched-link fs-base fw-semibold p-0 mb-1" href="shop-catalog-grocery.html">
              ...
              <div class="col-sm-6 col-md-4 col-lg-12 d-flex">
                <div class="position-relative d-flex min-w-0 align-items-center">
                  <div class="d-flex flex-shrink-0 align-items-center justify-content-center bg-body-tertiary rounded-circle" style="width: 56px; height: 56px">
                    <img src="/themes/cartzilla/assets/img/shop/grocery/categories/04.png" width="40" alt="Image">
                  </div>
                  <div class="min-w-0 ps-3">
                    <a class="nav-link animate-underline stretched-link fs-base fw-semibold p-0 mb-1" href="shop-catalog-grocery.html">
              ...
              <div class="col-sm-6 col-md-4 col-lg-12 d-flex">
                <div class="position-relative d-flex min-w-0 align-items-center">
                  <div class="d-flex flex-shrink-0 align-items-center justify-content-center bg-body-tertiary rounded-circle" style="width: 56px; height: 56px">
                    <img src="/themes/cartzilla/assets/img/shop/grocery/categories/05.png" width="40" alt="Image">
                  </div>
                  <div class="min-w-0 ps-3">
                    <a class="nav-link animate-underline stretched-link fs-base fw-semibold p-0 mb-1" href="shop-catalog-grocery.html">
              ...
              <div class="col-sm-6 col-md-4 col-lg-12 d-flex">
                <div class="position-relative d-flex min-w-0 align-items-center">
                  <div class="d-flex flex-shrink-0 align-items-center justify-content-center bg-body-tertiary rounded-circle" style="width: 56px; height: 56px">
                    <img src="/themes/cartzilla/assets/img/shop/grocery/categories/06.png" width="40" alt="Image">
                  </div>
                  <div class="min-w-0 ps-3">
                    <a class="nav-link animate-underline stretched-link fs-base fw-semibold p-0 mb-1" href="shop-catalog-grocery.html">
              ...
              <div class="col-sm-6 col-md-4 col-lg-12 d-flex">
                <div class="position-relative d-flex min-w-0 align-items-center">
                  <div class="d-flex flex-shrink-0 align-items-center justify-content-center bg-body-tertiary rounded-circle" style="width: 56px; height: 56px">
                    <img src="/themes/cartzilla/assets/img/shop/grocery/categories/07.png" width="40" alt="Image">
                  </div>
                  <div class="min-w-0 ps-3">
                    <a class="nav-link animate-underline stretched-link fs-base fw-semibold p-0 mb-1" href="shop-catalog-grocery.html">
              ...
              <div class="col-sm-6 col-md-4 col-lg-12 d-flex">
                <div class="position-relative d-flex min-w-0 align-items-center">
                  <div class="d-flex flex-shrink-0 align-items-center justify-content-center bg-body-tertiary rounded-circle" style="width: 56px; height: 56px">
                    <img src="/themes/cartzilla/assets/img/shop/grocery/categories/08.png" width="40" alt="Image">
                  </div>
                  <div class="min-w-0 ps-3">
                    <a class="nav-link animate-underline stretched-link fs-base fw-semibold p-0 mb-1" href="shop-catalog-grocery.html">
                  ...
                  <div class="position-relative z-2">
                    ...
                    <a class="d-block p-2 p-lg-3" href="shop-product-grocery.html">
                      <div class="ratio" style="--cz-aspect-ratio: calc(160 / 191 * 100%)">
                        <img src="/themes/cartzilla/assets/img/shop/grocery/01.png" alt="Image">
                      </div>
                    </a>
                    <div class="position-absolute w-100 start-0 bottom-0">
                      <div class="d-flex justify-content-end px-2 px-lg-3 pb-2 pb-lg-3">
                        <div class="count-input count-input-collapsible collapsed justify-content-between w-100 bg-transparent border-0 rounded-2">
                          <button type="button" class="btn btn-icon btn-sm btn-primary" data-decrement="" aria-label="Decrement quantity" disabled="">
              ...
              <div class="col">
                <div class="card product-card h-100 bg-transparent border-0 shadow-none">
                  <div class="position-relative z-2">
                    ...
                    <a class="d-block p-2 p-lg-3" href="shop-product-grocery.html">
                      <div class="ratio" style="--cz-aspect-ratio: calc(160 / 191 * 100%)">
                        <img src="/themes/cartzilla/assets/img/shop/grocery/02.png" alt="Image">
                      </div>
                    </a>
                    <div class="position-absolute w-100 start-0 bottom-0">
                      <div class="d-flex justify-content-end px-2 px-lg-3 pb-2 pb-lg-3">
              ...
              <div class="col">
                <div class="card product-card h-100 bg-transparent border-0 shadow-none">
                  <div class="position-relative z-2">
                    ...
                    <a class="d-block p-2 p-lg-3" href="shop-product-grocery.html">
                      <div class="ratio" style="--cz-aspect-ratio: calc(160 / 191 * 100%)">
                        <img src="/themes/cartzilla/assets/img/shop/grocery/03.png" alt="Image">
                      </div>
                    </a>
                    <div class="position-absolute w-100 start-0 bottom-0">
                      <div class="d-flex justify-content-end px-2 px-lg-3 pb-2 pb-lg-3">
              ...
              <div class="col">
                <div class="card product-card h-100 bg-transparent border-0 shadow-none">
                  <div class="position-relative z-2">
                    ...
                    <a class="d-block p-2 p-lg-3" href="shop-product-grocery.html">
                      <div class="ratio" style="--cz-aspect-ratio: calc(160 / 191 * 100%)">
                        <img src="/themes/cartzilla/assets/img/shop/grocery/04.png" alt="Image">
                      </div>
                    </a>
                    <div class="position-absolute w-100 start-0 bottom-0">
                      <div class="d-flex justify-content-end px-2 px-lg-3 pb-2 pb-lg-3">
              ...
              <div class="col">
                <div class="card product-card h-100 bg-transparent border-0 shadow-none">
                  <div class="position-relative z-2">
                    ...
                    <a class="d-block p-2 p-lg-3" href="shop-product-grocery.html">
                      <div class="ratio" style="--cz-aspect-ratio: calc(160 / 191 * 100%)">
                        <img src="/themes/cartzilla/assets/img/shop/grocery/05.png" alt="Image">
                      </div>
                    </a>
                    <div class="position-absolute w-100 start-0 bottom-0">
                      <div class="d-flex justify-content-end px-2 px-lg-3 pb-2 pb-lg-3">
              ...
              <div class="col">
                <div class="card product-card h-100 bg-transparent border-0 shadow-none">
                  <div class="position-relative z-2">
                    ...
                    <a class="d-block p-2 p-lg-3" href="shop-product-grocery.html">
                      <div class="ratio" style="--cz-aspect-ratio: calc(160 / 191 * 100%)">
                        <img src="/themes/cartzilla/assets/img/shop/grocery/06.png" alt="Image">
                      </div>
                    </a>
                    <div class="position-absolute w-100 start-0 bottom-0">
                      <div class="d-flex justify-content-end px-2 px-lg-3 pb-2 pb-lg-3">
              ...
              <div class="col">
                <div class="card product-card h-100 bg-transparent border-0 shadow-none">
                  <div class="position-relative z-2">
                    ...
                    <a class="d-block p-2 p-lg-3" href="shop-product-grocery.html">
                      <div class="ratio" style="--cz-aspect-ratio: calc(160 / 191 * 100%)">
                        <img src="/themes/cartzilla/assets/img/shop/grocery/07.png" alt="Image">
                      </div>
                    </a>
                    <div class="position-absolute w-100 start-0 bottom-0">
                      <div class="d-flex justify-content-end px-2 px-lg-3 pb-2 pb-lg-3">
              ...
              <div class="col">
                <div class="card product-card h-100 bg-transparent border-0 shadow-none">
                  <div class="position-relative z-2">
                    ...
                    <a class="d-block p-2 p-lg-3" href="shop-product-grocery.html">
                      <div class="ratio" style="--cz-aspect-ratio: calc(160 / 191 * 100%)">
                        <img src="/themes/cartzilla/assets/img/shop/grocery/08.png" alt="Image">
                      </div>
                    </a>
                    <div class="position-absolute w-100 start-0 bottom-0">
                      <div class="d-flex justify-content-end px-2 px-lg-3 pb-2 pb-lg-3">
      ...
      <section class="container pb-5 mb-2 mb-sm-3 mb-lg-4 mb-xl-5">
        ...
        <div class="swiper pb-lg-2 swiper-initialized swiper-horizontal swiper-backface-hidden" data-swiper="{
          &quot;slidesPerView&quot;: 1,
          &quot;spaceBetween&quot;: 24,
          &quot;pagination&quot;: {
            &quot;el&quot;: &quot;.swiper-pagination&quot;,
          ...
          <div class="swiper-wrapper" id="swiper-wrapper-923a4106820a6d6105" aria-live="polite">

            <!-- Category -->
            <div class="swiper-slide text-center swiper-slide-active" style="width: 294.75px; margin-right: 24px;" role="group" aria-label="1 / 4">
        ...
        <div class="row">
            ...
            <div class="pe-lg-2 pe-xl-4">
              <div class="rounded-4 overflow-hidden" style="background-color: #a6cddc" data-bs-theme="light">
                ...
                <div class="ratio mt-n2" style="--cz-aspect-ratio: calc(240 / 282 * 100%)">
                  <img src="/themes/cartzilla/assets/img/shop/grocery/banner.jpg" alt="Banner">
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-sm-7 col-md-8 col-lg-9">
            ...
            <div class="swiper swiper-initialized swiper-horizontal swiper-backface-hidden" data-swiper="{
              ...
              <div class="swiper-wrapper" id="swiper-wrapper-ee55a4d750a76e73" aria-live="polite">

                <!-- Product -->
                <div class="swiper-slide h-auto swiper-slide-active" style="width: 215.25px; margin-right: 24px;" role="group" aria-label="1 / 4">
                  <div class="card product-card h-100 bg-transparent border-0 shadow-none">
                    <div class="position-relative z-2">
                      <button type="button" class="btn btn-icon btn-sm btn-secondary animate-pulse fs-sm bg-body border-0 position-absolute top-0 end-0 z-2 mt-1 mt-sm-2 me-1 me-sm-2" aria-label="Add to Wishlist">
                        <i class="ci-heart animate-target"></i>
                      ...
                      <a class="d-block p-2 p-lg-3" href="shop-product-grocery.html">
                        <div class="ratio" style="--cz-aspect-ratio: calc(160 / 191 * 100%)">
                          <img src="/themes/cartzilla/assets/img/shop/grocery/09.png" alt="Image">
                        </div>
                      </a>
                      <div class="position-absolute w-100 start-0 bottom-0">
                        <div class="d-flex justify-content-end px-2 px-lg-3 pb-2 pb-lg-3">
                ...
                <!-- Product -->
                <div class="swiper-slide h-auto swiper-slide-next" style="width: 215.25px; margin-right: 24px;" role="group" aria-label="2 / 4">
                  <div class="card product-card h-100 bg-transparent border-0 shadow-none">
                    <div class="position-relative z-2">
                      <button type="button" class="btn btn-icon btn-sm btn-secondary animate-pulse fs-sm bg-body border-0 position-absolute top-0 end-0 z-2 mt-1 mt-sm-2 me-1 me-sm-2" aria-label="Add to Wishlist">
                        <i class="ci-heart animate-target"></i>
                      ...
                      <a class="d-block p-2 p-lg-3" href="shop-product-grocery.html">
                        <div class="ratio" style="--cz-aspect-ratio: calc(160 / 191 * 100%)">
                          <img src="/themes/cartzilla/assets/img/shop/grocery/10.png" alt="Image">
                        </div>
                      </a>
                      <div class="position-absolute w-100 start-0 bottom-0">
                        <div class="d-flex justify-content-end px-2 px-lg-3 pb-2 pb-lg-3">
                ...
                <!-- Product -->
                <div class="swiper-slide h-auto" style="width: 215.25px; margin-right: 24px;" role="group" aria-label="3 / 4">
                  <div class="card product-card h-100 bg-transparent border-0 shadow-none">
                    <div class="position-relative z-2">
                      <button type="button" class="btn btn-icon btn-sm btn-secondary animate-pulse fs-sm bg-body border-0 position-absolute top-0 end-0 z-2 mt-1 mt-sm-2 me-1 me-sm-2" aria-label="Add to Wishlist">
                        <i class="ci-heart animate-target"></i>
                      ...
                      <a class="d-block p-2 p-lg-3" href="shop-product-grocery.html">
                        <div class="ratio" style="--cz-aspect-ratio: calc(160 / 191 * 100%)">
                          <img src="/themes/cartzilla/assets/img/shop/grocery/11.png" alt="Image">
                        </div>
                      </a>
                      <div class="position-absolute w-100 start-0 bottom-0">
                        <div class="d-flex justify-content-end px-2 px-lg-3 pb-2 pb-lg-3">
                ...
                <!-- Product -->
                <div class="swiper-slide h-auto" role="group" aria-label="4 / 4" style="width: 215.25px; margin-right: 24px;">
                  <div class="card product-card h-100 bg-transparent border-0 shadow-none">
                    <div class="position-relative z-2">
                      <button type="button" class="btn btn-icon btn-sm btn-secondary animate-pulse fs-sm bg-body border-0 position-absolute top-0 end-0 z-2 mt-1 mt-sm-2 me-1 me-sm-2" aria-label="Add to Wishlist">
                        <i class="ci-heart animate-target"></i>
                      ...
                      <a class="d-block p-2 p-lg-3" href="shop-product-grocery.html">
                        <div class="ratio" style="--cz-aspect-ratio: calc(160 / 191 * 100%)">
                          <img src="/themes/cartzilla/assets/img/shop/grocery/12.png" alt="Image">
                        </div>
                      </a>
                      <div class="position-absolute w-100 start-0 bottom-0">
                        <div class="d-flex justify-content-end px-2 px-lg-3 pb-2 pb-lg-3">
            ...
            <div class="d-flex flex-column gap-1 gap-md-2">
              ...
              <div class="position-relative d-flex align-items-start align-items-sm-center mb-4">
                <div class="ratio" style="--cz-aspect-ratio: calc(140 / 196 * 100%); max-width: 196px">
                  <img src="/themes/cartzilla/assets/img/home/grocery/recipes/01.jpg" class="rounded" alt="Image">
                </div>
              ...
              <div class="position-relative d-flex align-items-start align-items-sm-center mb-4">
                <div class="ratio" style="--cz-aspect-ratio: calc(140 / 196 * 100%); max-width: 196px">
                  <img src="/themes/cartzilla/assets/img/home/grocery/recipes/02.jpg" class="rounded" alt="Image">
                </div>
                <div class="ps-3 ps-xl-4">
                  <h3 class="fs-base fw-medium lh-base mb-2 mb-xl-3">
              ...
              <div class="position-relative d-flex align-items-start align-items-sm-center mb-4">
                <div class="ratio" style="--cz-aspect-ratio: calc(140 / 196 * 100%); max-width: 196px">
                  <img src="/themes/cartzilla/assets/img/home/grocery/recipes/03.jpg" class="rounded" alt="Image">
                </div>
                <div class="ps-3 ps-xl-4">
                  <h3 class="fs-base fw-medium lh-base mb-2 mb-xl-3">
            ...
            <div class="border rounded-5 p-4">
              <div class="d-sm-flex align-items-start align-items-md-center align-items-lg-start align-items-xl-center p-md-2 p-lg-0 p-xl-2 p-xxl-3">
                <a class="ratio d-block w-100 mb-4 mb-sm-0" href="#!" style="--cz-aspect-ratio: calc(404 / 286 * 100%); max-width: 286px">
                  <img src="/themes/cartzilla/assets/img/home/grocery/recipes/book-cover.jpg" class="rounded-4" alt="Book cover">
                </a>
          ...
          <div class="col-lg-7 mb-4 mb-lg-0">
            <div class="d-flex flex-column flex-sm-row align-items-center h-100 bg-body-tertiary rounded-5 overflow-hidden">
              ...
              <div class="ratio align-self-sm-end order-sm-1 rtl-flip" style="--cz-aspect-ratio: calc(284 / 330 * 100%); max-width: 330px">
                <img src="/themes/cartzilla/assets/img/home/grocery/banner01.png" alt="Image">
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-5">
            <div class="d-flex align-items-center h-100 bg-body-tertiary rounded-5 overflow-hidden">
              <div class="ratio align-self-end rtl-flip" style="--cz-aspect-ratio: calc(284 / 244 * 100%); max-width: 244px">
                <img src="/themes/cartzilla/assets/img/home/grocery/banner02.png" alt="Image">
              </div>
              <div class="p-4">
        ...
        <div class="container py-sm-1 py-md-2 py-lg-3">
          <div class="text-center mx-auto" style="max-width: 580px">
            ...
            <form class="needs-validation position-relative d-flex flex-column flex-sm-row gap-2 pt-3" novalidate="">
              <input type="email" class="form-control form-control-lg rounded-pill text-start" placeholder="Your email" aria-label="Your email address" required="">
      ...
      <div class="offcanvas-body d-flex flex-column gap-4 pt-2">
        ...
        <div class="d-flex align-items-center">
          <a class="position-relative flex-shrink-0" href="shop-product-grocery.html">
            ...
            <img src="/themes/cartzilla/assets/img/shop/grocery/thumbs/01.png" width="110" alt="Thumbnail">
          </a>
        ...
        <div class="d-flex align-items-center">
          <a class="flex-shrink-0" href="shop-product-grocery.html">
            <img src="/themes/cartzilla/assets/img/shop/grocery/thumbs/02.png" width="110" alt="Thumbnail">
          </a>
          <div class="w-100 ps-3">
            <h5 class="fs-sm fw-medium lh-base mb-2">
        ...
        <div class="d-flex align-items-center">
          <a class="flex-shrink-0" href="shop-product-grocery.html">
            <img src="/themes/cartzilla/assets/img/shop/grocery/thumbs/03.png" width="110" alt="Thumbnail">
          </a>
          <div class="w-100 ps-3">
            <h5 class="fs-sm fw-medium lh-base mb-2">
        ...
        <div class="d-flex align-items-center">
          <a class="flex-shrink-0" href="shop-product-grocery.html">
            <img src="/themes/cartzilla/assets/img/shop/grocery/thumbs/04.png" width="110" alt="Thumbnail">
          </a>
          <div class="w-100 ps-3">
            <h5 class="fs-sm fw-medium lh-base mb-2">
    ...
    <div class="offcanvas offcanvas-end pb-sm-2 px-sm-2" id="deliveryOptions" tabindex="-1" aria-labelledby="deliveryOptionsLabel" style="width: 500px">
      ...
      <div class="offcanvas-header flex-column align-items-start py-3 pt-lg-4">
        ...
        <ul class="nav nav-pills nav-justified w-100" role="tablist">
          ...
          <li class="nav-item" role="presentation">
            <button type="button" class="nav-link" id="pickup-tab" data-bs-toggle="tab" data-bs-target="#pickup-tab-pane" role="tab" aria-controls="pickup-tab-pane" aria-selected="false" tabindex="-1">
        ...
        <div class="tab-pane fade show active" id="delivery-tab-pane" role="tabpanel" aria-labelledby="delivery-tab">
          ...
          <div class="collapse delivery-address" id="deliveryAddressAdd">
            ...
            <div class="mb-3 mb-lg-4">
              ...
              <div class="choices" data-type="select-one" tabindex="0" role="listbox" aria-haspopup="true" aria-expanded="false"><div class="form-select form-select-lg rounded-pill"><select class="form-select form-select-lg rounded-pill choices__input" data-select="{
                &quot;classNames&quot;: {
                  &quot;containerInner&quot;: [&quot;form-select&quot;, &quot;form-select-lg&quot;, &quot;rounded-pill&quot;]
                }
              }" aria-label="Large pill select" hidden="" tabindex="-1" data-choice="active">
              ...
              </select><div class="choices__list choices__list--single"><div class="choices__item choices__placeholder choices__item--selectable" data-item="" data-id="1" data-value="" aria-selected="true" role="option" data-placeholder="" data-deletable="">Select state<button type="button" class="choices__button" aria-label="Remove item: " data-button="">Remove item</button></div></div></div><div class="choices__list choices__list--dropdown" aria-expanded="false"><div class="choices__list" role="listbox"><div id="choices--mniu-item-choice-1" class="choices__item choices__item--choice is-selected choices__placeholder choices__item--selectable is-highlighted" role="option" data-choice="" data-id="1" data-value="" data-choice-selectable="" aria-selected="true">Select state</div><div id="choices--mniu-item-choice-2" class="choices__item choices__item--choice choices__item--selectable" role="option" data-choice="" data-id="2" data-value="Arizona" data-choice-selectable="">Arizona</div><div id="choices--mniu-item-choice-3" class="choices__item choices__item--choice choices__item--selectable" role="option" data-choice="" data-id="3" data-value="California" data-choice-selectable="">California</div><div id="choices--mniu-item-choice-4" class="choices__item choices__item--choice choices__item--selectable" role="option" data-choice="" data-id="4" data-value="Montana" data-choice-selectable="">Montana</div><div id="choices--mniu-item-choice-5" class="choices__item choices__item--choice choices__item--selectable" role="option" data-choice="" data-id="5" data-value="Nevada" data-choice-selectable="">Nevada</div><div id="choices--mniu-item-choice-6" class="choices__item choices__item--choice choices__item--selectable" role="option" data-choice="" data-id="6" data-value="New Mexico" data-choice-selectable="">New Mexico</div><div id="choices--mniu-item-choice-7" class="choices__item choices__item--choice choices__item--selectable" role="option" data-choice="" data-id="7" data-value="Texas" data-choice-selectable="">Texas</div></div></div></div>
            </div>
            <div class="mb-3 mb-lg-4">
            ...
            <div class="mb-3 mb-lg-4">
              ...
              </select><div class="choices__list choices__list--single"><div class="choices__item choices__placeholder choices__item--selectable" data-item="" data-id="1" data-value="" aria-selected="true" role="option" data-placeholder="" data-deletable="">Select city<button type="button" class="choices__button" aria-label="Remove item: " data-button="">Remove item</button></div></div></div><div class="choices__list choices__list--dropdown" aria-expanded="false"><div class="choices__list" role="listbox"><div id="choices--5wld-item-choice-1" class="choices__item choices__item--choice is-selected choices__placeholder choices__item--selectable is-highlighted" role="option" data-choice="" data-id="1" data-value="" data-choice-selectable="" aria-selected="true">Select city</div><div id="choices--5wld-item-choice-2" class="choices__item choices__item--choice choices__item--selectable" role="option" data-choice="" data-id="2" data-value="Austin" data-choice-selectable="">Austin</div><div id="choices--5wld-item-choice-3" class="choices__item choices__item--choice choices__item--selectable" role="option" data-choice="" data-id="3" data-value="Helena" data-choice-selectable="">Helena</div><div id="choices--5wld-item-choice-4" class="choices__item choices__item--choice choices__item--selectable" role="option" data-choice="" data-id="4" data-value="Sacramento" data-choice-selectable="">Sacramento</div><div id="choices--5wld-item-choice-5" class="choices__item choices__item--choice choices__item--selectable" role="option" data-choice="" data-id="5" data-value="Santa Fe" data-choice-selectable="">Santa Fe</div><div id="choices--5wld-item-choice-6" class="choices__item choices__item--choice choices__item--selectable" role="option" data-choice="" data-id="6" data-value="Las Vegas" data-choice-selectable="">Las Vegas</div><div id="choices--5wld-item-choice-7" class="choices__item choices__item--choice choices__item--selectable" role="option" data-choice="" data-id="7" data-value="Phoenix" data-choice-selectable="">Phoenix</div></div></div></div>
            </div>
          ...
          <div class="collapse pickup-options" id="pickupStoreAdd">
            ...
            <div class="mb-3 mb-lg-4">
              ...
              <div class="choices" data-type="select-one" tabindex="0" role="listbox" aria-haspopup="true" aria-expanded="false"><div class="form-select form-select-lg rounded-pill"><select class="form-select form-select-lg rounded-pill choices__input" data-select="{
                ...
                <option value="New Mexico">New Mexico</option>
                <option value="Texas">Texas</option>
              </select><div class="choices__list choices__list--single"><div class="choices__item choices__item--selectable" data-item="" data-id="3" data-value="California" aria-selected="true" role="option" data-deletable="">California<button type="button" class="choices__button" aria-label="Remove item: California" data-button="">Remove item</button></div></div></div><div class="choices__list choices__list--dropdown" aria-expanded="false"><div class="choices__list" role="listbox"><div id="choices--o4zy-item-choice-1" class="choices__item choices__item--choice choices__placeholder choices__item--selectable is-highlighted" role="option" data-choice="" data-id="1" data-value="" data-choice-selectable="" aria-selected="true">Select state</div><div id="choices--o4zy-item-choice-2" class="choices__item choices__item--choice choices__item--selectable" role="option" data-choice="" data-id="2" data-value="Arizona" data-choice-selectable="">Arizona</div><div id="choices--o4zy-item-choice-3" class="choices__item choices__item--choice is-selected choices__item--selectable" role="option" data-choice="" data-id="3" data-value="California" data-choice-selectable="">California</div><div id="choices--o4zy-item-choice-4" class="choices__item choices__item--choice choices__item--selectable" role="option" data-choice="" data-id="4" data-value="Montana" data-choice-selectable="">Montana</div><div id="choices--o4zy-item-choice-5" class="choices__item choices__item--choice choices__item--selectable" role="option" data-choice="" data-id="5" data-value="Nevada" data-choice-selectable="">Nevada</div><div id="choices--o4zy-item-choice-6" class="choices__item choices__item--choice choices__item--selectable" role="option" data-choice="" data-id="6" data-value="New Mexico" data-choice-selectable="">New Mexico</div><div id="choices--o4zy-item-choice-7" class="choices__item choices__item--choice choices__item--selectable" role="option" data-choice="" data-id="7" data-value="Texas" data-choice-selectable="">Texas</div></div></div></div>
            </div>
            <div class="mb-4">
              <label class="form-label">City *</label>
              <div class="choices" data-type="select-one" tabindex="0" role="listbox" aria-haspopup="true" aria-expanded="false"><div class="form-select form-select-lg rounded-pill"><select class="form-select form-select-lg rounded-pill choices__input" data-select="{
                ...
                <option value="Las Vegas">Las Vegas</option>
                <option value="Phoenix">Phoenix</option>
              </select><div class="choices__list choices__list--single"><div class="choices__item choices__item--selectable" data-item="" data-id="4" data-value="Sacramento" aria-selected="true" role="option" data-deletable="">Sacramento<button type="button" class="choices__button" aria-label="Remove item: Sacramento" data-button="">Remove item</button></div></div></div><div class="choices__list choices__list--dropdown" aria-expanded="false"><div class="choices__list" role="listbox"><div id="choices--tuh0-item-choice-1" class="choices__item choices__item--choice choices__placeholder choices__item--selectable is-highlighted" role="option" data-choice="" data-id="1" data-value="" data-choice-selectable="" aria-selected="true">Select city</div><div id="choices--tuh0-item-choice-2" class="choices__item choices__item--choice choices__item--selectable" role="option" data-choice="" data-id="2" data-value="Austin" data-choice-selectable="">Austin</div><div id="choices--tuh0-item-choice-3" class="choices__item choices__item--choice choices__item--selectable" role="option" data-choice="" data-id="3" data-value="Helena" data-choice-selectable="">Helena</div><div id="choices--tuh0-item-choice-4" class="choices__item choices__item--choice is-selected choices__item--selectable" role="option" data-choice="" data-id="4" data-value="Sacramento" data-choice-selectable="">Sacramento</div><div id="choices--tuh0-item-choice-5" class="choices__item choices__item--choice choices__item--selectable" role="option" data-choice="" data-id="5" data-value="Santa Fe" data-choice-selectable="">Santa Fe</div><div id="choices--tuh0-item-choice-6" class="choices__item choices__item--choice choices__item--selectable" role="option" data-choice="" data-id="6" data-value="Las Vegas" data-choice-selectable="">Las Vegas</div><div id="choices--tuh0-item-choice-7" class="choices__item choices__item--choice choices__item--selectable" role="option" data-choice="" data-id="7" data-value="Phoenix" data-choice-selectable="">Phoenix</div></div></div></div>
            </div>
    ...
    <script src="/themes/cartzilla/assets/vendor/simplebar/simplebar.min.js"></script>
    <script src="/themes/cartzilla/assets/vendor/choices.js/choices.min.js"></script>
