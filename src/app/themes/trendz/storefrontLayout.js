    ...
    <main class="content-wrapper">
                ...
                <div class="position-relative w-100 rtl-flip" style="max-width: 636px">
                  <a class="btn btn-icon btn-light rounded-circle shadow position-absolute z-2" href="#!" style="top: 30%; left: 46%" data-bs-toggle="popover" data-bs-html="true" data-bs-trigger="focus" data-bs-placement="right" data-bs-custom-class="popover-sm" data-bs-content="
                    <div class=&quot;d-flex align-items-start position-relative&quot;>
                      <img src=&quot;assets/img/home/fashion/v2/hero/hotspot01.png&quot; width=&quot;64&quot; alt=&quot;Image&quot;>
                      <div class=&quot;nav flex-column pt-2 ps-2 ms-1&quot;>
                        <a class=&quot;nav-link hover-effect-underline stretched-link p-0 mb-2&quot; href=&quot;shop-product-fashion.html&quot;>Women beige trench coat</a>
                  ...
                  <a class="btn btn-icon btn-light rounded-circle shadow position-absolute z-2" href="#!" style="top: 51%; left: 26%" data-bs-toggle="popover" data-bs-html="true" data-bs-trigger="focus" data-bs-placement="left" data-bs-custom-class="popover-sm" data-bs-content="
                    <div class=&quot;d-flex align-items-start position-relative&quot;>
                      <img src=&quot;assets/img/home/fashion/v2/hero/hotspot02.png&quot; width=&quot;64&quot; alt=&quot;Image&quot;>
                      <div class=&quot;nav flex-column pt-2 ps-2 ms-1&quot;>
                        <a class=&quot;nav-link hover-effect-underline stretched-link p-0 mb-2&quot; href=&quot;shop-product-fashion.html&quot;>White cotton blouset</a>
                  ...
                  <a class="btn btn-icon btn-light rounded-circle shadow position-absolute z-2" href="#!" style="top: 81%; left: 40%" data-bs-toggle="popover" data-bs-html="true" data-bs-trigger="focus" data-bs-placement="left" data-bs-custom-class="popover-sm" data-bs-content="
                    <div class=&quot;d-flex align-items-start position-relative&quot;>
                      <img src=&quot;assets/img/home/fashion/v2/hero/hotspot03.png&quot; width=&quot;64&quot; alt=&quot;Image&quot;>
                      <div class=&quot;nav flex-column pt-2 ps-2 ms-1&quot;>
                        <a class=&quot;nav-link hover-effect-underline stretched-link p-0 mb-2&quot; href=&quot;shop-product-fashion.html&quot;>Brown corduroy pants</a>
                  ...
                  <div class="ratio" style="--cz-aspect-ratio: calc(648 / 636 * 100%)">
                    <img src="/themes/cartzilla/assets/img/home/fashion/v2/hero/image.png" alt="Image">
                  </div>
                </div>
              </div>
            </div>
      ...
      <section class="container pt-4">
        <div class="swiper swiper-initialized swiper-horizontal swiper-backface-hidden" data-swiper="{
          ...
          <div class="swiper-wrapper" id="swiper-wrapper-ab83b47844a25df3" aria-live="polite">

            <!-- Category -->
            <div class="swiper-slide swiper-slide-active" style="width: 401px; margin-right: 24px;" role="group" aria-label="1 / 3">
              <div class="hover-effect-opacity position-relative">
                <div class="d-flex justify-content-between position-relative z-2 ps-2 ps-xl-3">
                  ...
                  <div class="ratio w-100 align-self-end" style="max-width: 220px; --cz-aspect-ratio: calc(305 / 220 * 100%)">
                    <img src="/themes/cartzilla/assets/img/home/fashion/v2/categories/01.png" alt="Image">
                  </div>
                </div>
            ...
            <!-- Category -->
            <div class="swiper-slide swiper-slide-next" style="width: 401px; margin-right: 24px;" role="group" aria-label="2 / 3">
              <div class="hover-effect-opacity position-relative">
                <div class="d-flex justify-content-between position-relative z-2 ps-2 ps-xl-3">
                  <div class="d-flex flex-column min-w-0 p-3">
                  ...
                  <div class="ratio w-100 align-self-end rtl-flip" style="max-width: 220px; --cz-aspect-ratio: calc(305 / 220 * 100%)">
                    <img src="/themes/cartzilla/assets/img/home/fashion/v2/categories/02.png" alt="Image">
                  </div>
                </div>
            ...
            <!-- Category -->
            <div class="swiper-slide" role="group" aria-label="3 / 3" style="width: 401px; margin-right: 24px;">
              <div class="hover-effect-opacity position-relative">
                <div class="d-flex justify-content-between position-relative z-2 ps-2 ps-xl-3">
                  <div class="d-flex flex-column min-w-0 p-3">
                  ...
                  <div class="ratio w-100 align-self-end rtl-flip" style="max-width: 220px; --cz-aspect-ratio: calc(305 / 220 * 100%)">
                    <img src="/themes/cartzilla/assets/img/home/fashion/v2/categories/03.png" alt="Image">
                  </div>
                </div>
        ...
        <div class="row row-cols-2 row-cols-md-3 row-cols-lg-4 gy-4 gy-md-5">
          ...
          <div class="col mb-2 mb-sm-3 mb-md-0">
            <div class="animate-underline hover-effect-opacity">
              <div class="position-relative mb-3">
                ...
                <a class="d-flex bg-body-tertiary rounded p-3" href="shop-product-fashion.html">
                  <div class="ratio" style="--cz-aspect-ratio: calc(308 / 274 * 100%)">
                    <img src="/themes/cartzilla/assets/img/shop/fashion/02.png" alt="Image">
                  </div>
                </a>
                <div class="hover-effect-target position-absolute start-0 bottom-0 w-100 z-2 opacity-0 pb-2 pb-sm-3 px-2 px-sm-3">
                  <div class="d-flex align-items-center justify-content-center gap-2 gap-xl-3 bg-body rounded-2 p-2">
          ...
          <div class="col-12 col-md-8 col-lg-6 mb-2 mb-sm-3 mb-md-0">
            <div class="position-relative bg-body-tertiary text-center rounded-4 p-4 p-sm-5 py-md-4 py-xl-5">
              ...
              <div class="swiper user-select-none mb-4 swiper-fade swiper-initialized swiper-horizontal swiper-watch-progress swiper-backface-hidden" data-swiper="{
                ...
                <div class="swiper-wrapper" id="swiper-wrapper-53e9a110bf063700e" aria-live="off" style="transition-duration: 300ms;">
                  
                  
                  <div class="swiper-slide swiper-slide-next" role="group" aria-label="3 / 3" style="width: 342px; opacity: 1; transform: translate3d(0px, 0px, 0px); transition-duration: 300ms;" data-swiper-slide-index="2">
                    <div class="ratio" style="--cz-aspect-ratio: calc(230 / 342 * 100%)">
                      <img src="/themes/cartzilla/assets/img/shop/fashion/banner03.png" alt="Image">
                    </div>
                  </div>
                <div class="swiper-slide swiper-slide-prev" style="width: 342px; opacity: 1; transform: translate3d(-342px, 0px, 0px); transition-duration: 300ms;" role="group" aria-label="1 / 3" data-swiper-slide-index="0">
                    <div class="ratio" style="--cz-aspect-ratio: calc(230 / 342 * 100%)">
                      <img src="/themes/cartzilla/assets/img/shop/fashion/banner01.png" alt="Image">
                    </div>
                  </div><div class="swiper-slide swiper-slide-visible swiper-slide-fully-visible swiper-slide-active" style="width: 342px; opacity: 1; transform: translate3d(-684px, 0px, 0px); transition-duration: 300ms;" role="group" aria-label="2 / 3" data-swiper-slide-index="1">
                    <div class="ratio" style="--cz-aspect-ratio: calc(230 / 342 * 100%)">
                      <img src="/themes/cartzilla/assets/img/shop/fashion/banner02.png" alt="Image">
                    </div>
                  </div></div>
              <span class="swiper-notification" aria-live="assertive" aria-atomic="true"></span></div>
      ...
      <section class="container pt-5 mt-2 mt-sm-3 mt-lg-4 mt-xl-5">
        ...
        <div class="position-relative px-4 px-md-3 px-lg-4">
          <div class="row position-relative z-2 justify-content-center">
            ...
            <div class="col-md-4 col-xl-5 order-md-2 d-flex justify-content-center justify-content-md-end py-4 py-md-3 py-lg-4">
              <div class="swiper m-0 swiper-initialized swiper-horizontal swiper-backface-hidden" data-swiper="{
                &quot;spaceBetween&quot;: 24,
                &quot;loop&quot;: true,
                &quot;speed&quot;: 400,
                ...
                <div class="swiper-wrapper" id="swiper-wrapper-41e407a9f6d671b3" aria-live="polite">

                  <!-- Item -->
                  <div class="swiper-slide h-auto swiper-slide-active" style="width: 416px; margin-right: 24px;" role="group" aria-label="1 / 2" data-swiper-slide-index="0">
                    <div class="card animate-underline h-100 rounded-5 border-0">
                      <div class="pt-3 px-3">
                        ...
                        <img src="/themes/cartzilla/assets/img/home/fashion/v2/offers-slider/product01.png" alt="Image">
                      </div>
                      ...
                      <div class="card-footer d-flex align-items-center justify-content-center bg-transparent border-0 pb-4" data-countdown-date="demoDate">
                        <div class="btn btn-secondary pe-none px-2">
                          <span data-days="">12</span>
                          <span>d</span>
                        </div>
                        <div class="animate-blinking text-body-tertiary fs-lg fw-medium mx-2">:</div>
                        <div class="btn btn-secondary pe-none px-2">
                          <span data-hours="">23</span>
                          <span>h</span>
                        </div>
                        <div class="animate-blinking text-body-tertiary fs-lg fw-medium mx-2">:</div>
                        <div class="btn btn-secondary pe-none px-2">
                          <span data-minutes="">35</span>
                          <span>m</span>
                        </div>
                      </div>
                    </div>
                  ...
                  <!-- Item -->
                  <div class="swiper-slide h-auto swiper-slide-next" role="group" aria-label="2 / 2" data-swiper-slide-index="1" style="width: 416px; margin-right: 24px;">
                    <div class="card animate-underline h-100 rounded-5 border-0">
                      <div class="pt-3 px-3">
                        <span class="badge text-bg-danger position-absolute top-0 start-0 z-2 mt-2 mt-sm-3 ms-2 ms-sm-3">-17%</span>
                        <img src="/themes/cartzilla/assets/img/home/fashion/v2/offers-slider/product02.png" alt="Image">
                      </div>
                      <div class="card-body text-center py-3">
                        <div class="d-flex justify-content-center min-w-0 fs-sm fw-medium text-dark-emphasis mb-2">
            ...
            <div class="swiper-pagination position-static d-md-none mt-n3 mb-2 swiper-pagination-clickable swiper-pagination-bullets swiper-pagination-horizontal" id="bullets"><span class="swiper-pagination-bullet swiper-pagination-bullet-active" tabindex="0" role="button" aria-label="Go to slide 1" aria-current="true"></span><span class="swiper-pagination-bullet" tabindex="0" role="button" aria-label="Go to slide 2"></span></div>
            ...
            <div class="col-sm-9 col-md-8 col-xl-7 order-md-1 align-self-end">
              <div class="swiper user-select-none swiper-fade swiper-initialized swiper-horizontal swiper-watch-progress swiper-backface-hidden" id="previewImages" data-swiper="{
                ...
                <div class="swiper-wrapper" id="swiper-wrapper-992aced9cf3046c6" aria-live="polite">
                  <div class="swiper-slide swiper-slide-visible swiper-slide-fully-visible swiper-slide-active" style="width: 692px; opacity: 1; transform: translate3d(0px, 0px, 0px);" role="group" aria-label="1 / 2" data-swiper-slide-index="0">
                    <div class="ratio" style="--cz-aspect-ratio: calc(542 / 718 * 100%)">
                      <img src="/themes/cartzilla/assets/img/home/fashion/v2/offers-slider/preview01.png" alt="Image">
                    </div>
                  </div>
                  <div class="swiper-slide swiper-slide-next" role="group" aria-label="2 / 2" style="width: 692px; opacity: 0; transform: translate3d(-692px, 0px, 0px);" data-swiper-slide-index="1">
                    <div class="ratio" style="--cz-aspect-ratio: calc(542 / 718 * 100%)">
                      <img src="/themes/cartzilla/assets/img/home/fashion/v2/offers-slider/preview02.png" alt="Image">
                    </div>
                  </div>
                </div>
          ...
          <div class="swiper position-absolute top-0 start-0 w-100 h-100 user-select-none swiper-fade swiper-initialized swiper-horizontal swiper-watch-progress swiper-backface-hidden" id="backgrounds" data-swiper="{
            &quot;allowTouchMove&quot;: false,
            &quot;loop&quot;: true,
            &quot;effect&quot;: &quot;fade&quot;,
            &quot;fadeEffect&quot;: {
            ...
            <div class="swiper-wrapper" id="swiper-wrapper-cbc27ac694827310f" aria-live="polite">
              <div class="swiper-slide swiper-slide-visible swiper-slide-fully-visible swiper-slide-active" style="width: 1251px; opacity: 1; transform: translate3d(0px, 0px, 0px);" role="group" aria-label="1 / 2" data-swiper-slide-index="0">
              ...
              <div class="swiper-slide swiper-slide-next" role="group" aria-label="2 / 2" style="width: 1251px; opacity: 0; transform: translate3d(-1251px, 0px, 0px);" data-swiper-slide-index="1">
        ...
        <div class="d-none d-md-flex justify-content-center gap-2 pt-3 mt-2 mt-lg-3">
          <button type="button" class="btn btn-icon btn-outline-secondary animate-slide-start rounded-circle me-1" id="offerPrev" aria-label="Previous slide" tabindex="0" aria-controls="swiper-wrapper-41e407a9f6d671b3">
            <i class="ci-chevron-left fs-lg animate-target"></i>
          </button>
          <button type="button" class="btn btn-icon btn-outline-secondary animate-slide-end rounded-circle" id="offerNext" aria-label="Next slide" tabindex="0" aria-controls="swiper-wrapper-41e407a9f6d671b3">
            ...
            <div class="row g-0 border rounded-5 overflow-hidden">
              <div class="col-8 col-md-4 d-flex flex-column border-end">
                <a class="hover-effect-opacity position-relative d-block text-body border-bottom" href="#!">
                  <img class="position-relative z-1 d-none-dark" src="/themes/cartzilla/assets/img/home/fashion/v2/brands/zara-light.svg" alt="Zara">
                  <img class="position-relative z-1 d-none d-block-dark" src="/themes/cartzilla/assets/img/home/fashion/v2/brands/zara-dark.svg" alt="Zara">
                ...
                <a class="hover-effect-opacity position-relative d-block h-100 text-body" href="#!">
                  <img class="position-relative z-1 d-none-dark" src="/themes/cartzilla/assets/img/home/fashion/v2/brands/brooks-light.svg" alt="Brooks">
                  <img class="position-relative z-1 d-none d-block-dark" src="/themes/cartzilla/assets/img/home/fashion/v2/brands/brooks-dark.svg" alt="Brooks">
                  <span class="hover-effect-target position-absolute top-0 start-0 w-100 h-100 bg-body-tertiary opacity-0"></span>
                </a>
              </div>
              <div class="col-4 col-md-2 d-flex">
                <div class="d-flex flex-column w-100">
                  <a class="hover-effect-opacity position-relative d-block border-bottom text-body" href="#!">
                    <img class="position-relative z-1 d-none-dark" src="/themes/cartzilla/assets/img/home/fashion/v2/brands/fila-light.svg" alt="Fila">
                    <img class="position-relative z-1 d-none d-block-dark" src="/themes/cartzilla/assets/img/home/fashion/v2/brands/fila-dark.svg" alt="Fila">
                    <span class="hover-effect-target position-absolute top-0 start-0 w-100 h-100 bg-body-tertiary opacity-0"></span>
                  </a>
                  <a class="hover-effect-opacity position-relative d-block h-100 text-body" href="#!">
                    <img class="position-relative z-1 d-none-dark" src="/themes/cartzilla/assets/img/home/fashion/v2/brands/adidas-light.svg" alt="Adidas">
                    <img class="position-relative z-1 d-none d-block-dark" src="/themes/cartzilla/assets/img/home/fashion/v2/brands/adidas-dark.svg" alt="Adidas">
                    <span class="hover-effect-target position-absolute top-0 start-0 w-100 h-100 bg-body-tertiary opacity-0"></span>
                  </a>
                </div>
                ...
                <div class="row row-cols-2 g-0 border-bottom border-end">
                  <div class="col">
                    <a class="hover-effect-opacity position-relative d-block text-body" href="#!">
                      <img class="position-relative z-1 d-none-dark" src="/themes/cartzilla/assets/img/home/fashion/v2/brands/hermes-light.svg" alt="Hermes">
                      <img class="position-relative z-1 d-none d-block-dark" src="/themes/cartzilla/assets/img/home/fashion/v2/brands/hermes-dark.svg" alt="Hermes">
                      <span class="hover-effect-target position-absolute top-0 start-0 w-100 h-100 bg-body-tertiary opacity-0"></span>
                    </a>
                  </div>
                  <div class="col border-start">
                    <a class="hover-effect-opacity position-relative d-block h-100 text-body" href="#!">
                      <img class="position-relative z-1 d-none-dark" src="/themes/cartzilla/assets/img/home/fashion/v2/brands/dior-light.svg" alt="Dior">
                      <img class="position-relative z-1 d-none d-block-dark" src="/themes/cartzilla/assets/img/home/fashion/v2/brands/dior-dark.svg" alt="Dior">
                      <span class="hover-effect-target position-absolute top-0 start-0 w-100 h-100 bg-body-tertiary opacity-0"></span>
                    </a>
                  </div>
                </div>
                <a class="hover-effect-opacity position-relative d-block h-100 border-end text-body" href="#!">
                  <img class="position-relative z-1 d-none-dark" src="/themes/cartzilla/assets/img/home/fashion/v2/brands/newbalance-light.svg" alt="New Balance">
                  <img class="position-relative z-1 d-none d-block-dark" src="/themes/cartzilla/assets/img/home/fashion/v2/brands/newbalance-dark.svg" alt="New Balance">
                  <span class="hover-effect-target position-absolute top-0 start-0 w-100 h-100 bg-body-tertiary opacity-0"></span>
                </a>
              </div>
              <div class="col-4 col-md-2">
                <a class="hover-effect-opacity position-relative d-block text-body border-bottom" href="#!">
                  <img class="position-relative z-1 d-none-dark" src="/themes/cartzilla/assets/img/home/fashion/v2/brands/puma-light.svg" alt="Puma">
                  <img class="position-relative z-1 d-none d-block-dark" src="/themes/cartzilla/assets/img/home/fashion/v2/brands/puma-dark.svg" alt="Puma">
                  <span class="hover-effect-target position-absolute top-0 start-0 w-100 h-100 bg-body-tertiary opacity-0"></span>
                </a>
                <a class="hover-effect-opacity position-relative d-block text-body" href="#!">
                  <img class="position-relative z-1 d-none-dark" src="/themes/cartzilla/assets/img/home/fashion/v2/brands/hm-light.svg" alt="H &amp; M">
                  <img class="position-relative z-1 d-none d-block-dark" src="/themes/cartzilla/assets/img/home/fashion/v2/brands/hm-dark.svg" alt="H &amp; M">
                  <span class="hover-effect-target position-absolute top-0 start-0 w-100 h-100 bg-body-tertiary opacity-0"></span>
                </a>
              </div>
            </div>
    ...
    <div class="alert alert-dismissible bg-dark text-white rounded-0 py-2 px-0 m-0 fade show" data-bs-theme="dark">
      <div class="container position-relative d-flex min-w-0">
        <div class="d-flex flex-nowrap align-items-center g-2 w-100 min-w-0 mx-auto mt-n1" style="max-width: 458px">
          <div class="nav me-2">
            <button type="button" class="nav-link fs-lg p-0" id="topbarPrev" aria-label="Previous slide" tabindex="0" aria-controls="swiper-wrapper-ffd65b10db5673b3b">
          ...
          <div class="swiper fs-sm text-white swiper-initialized swiper-horizontal swiper-backface-hidden" data-swiper="{
            ...
            <div class="swiper-wrapper min-w-0" id="swiper-wrapper-ffd65b10db5673b3b" aria-live="off" style="transition-duration: 0ms; transform: translate3d(-430px, 0px, 0px); transition-delay: 0ms;">
          ...
          <span class="swiper-notification" aria-live="assertive" aria-atomic="true"></span></div>
          <div class="nav ms-2">
            <button type="button" class="nav-link fs-lg p-0" id="topbarNext" aria-label="Next slide" tabindex="0" aria-controls="swiper-wrapper-ffd65b10db5673b3b">
