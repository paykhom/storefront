...
export default class StorefrontLayout extends View {
    ...
    *template() {
        yield `<!DOCTYPE html>
<html lang="en" data-bs-theme="light" data-pwa="true" dir="ltr"
	><head>
		<meta charset="utf-8" />
		...
		<!-- Customizer -->
		<script src="/themes/cartzilla/assets/js/customizer.min.js"></script
		><style id="customizer-styles">
			:root,[data-bs-theme="light"]{}[data-bs-theme="dark"]{}.btn-primary{}.btn-success{}.btn-warning{}.btn-danger{}.btn-info{}.btn-outline-primary{}.btn-outline-success{}.btn-outline-warning{}.btn-outline-danger{}.btn-outline-info{}
		</style>
	</head>
							...
							<span class="d-none d-sm-flex flex-shrink-0 text-primary me-2">
								<svg xmlns="http://www.w3.org/2000/svg" width="36" height="36">
									...
									<defs>
										<path
											id="czlogo"
											d="M18.689 28.654a1.94 1.94 0 0 1-1.936 1.935 1.94 1.94 0 0 1-1.936-1.935 1.94 1.94 0 0 1 1.936-1.935 1.94 1.94 0 0 1 1.936 1.935z"></path>
									</defs>
								</svg>
							</span>
							Cartzilla
									...
									<div class="navbar-nav">
										<div class="dropdown w-100">
											...
											<ul
															...
															<div class="d-none d-lg-block">
																...
																<div
																	...
																	<div class="text-center px-2">
																		<span
																			class="badge bg-danger bg-opacity-10 text-danger fs-sm rounded-pill mb-2"
																			>Save up to $400</span
																		>
																	...
																	<img
																		src="/themes/cartzilla/assets/img/mega-menu/electronics/01.png"
																		width="252"
														...
														<div class="d-flex flex-column flex-lg-row h-100 gap-4">
															...
															<div class="d-none d-lg-block">
																...
																<div
																	...
																	<img
																		src="/themes/cartzilla/assets/img/mega-menu/electronics/02.png"
																		width="252"
																		alt="iPad Pro" />
																	<div class="text-center mt-4">
																		<a
																...
																<div
																	...
																	<div class="text-center px-2">
																		<div class="fs-sm text-light-emphasis mb-2"
																			...
																			<span class="fw-semibold">$500</span></div
																		>
																		<div class="h2 mb-4">LG OLED 4K Smart TV</div>
																	</div>
																	<img
																		src="/themes/cartzilla/assets/img/mega-menu/electronics/03.png"
																		width="252"
																		alt="Smart TV" />
																	<div class="text-center mt-4">
																		<a
														...
														<div class="d-flex flex-column flex-lg-row h-100 gap-4">
															...
															<div class="d-none d-lg-block">
																...
																<div
																	...
																	<img
																		src="/themes/cartzilla/assets/img/mega-menu/electronics/04.png"
																		width="252"
																		alt="Nest Audio" />
																	<div class="text-center mt-4">
																		<a
														...
														<div class="d-flex flex-column flex-lg-row h-100 gap-4">
															...
															<div class="d-none d-lg-block">
																...
																<div
																	...
																	<img
																		src="/themes/cartzilla/assets/img/mega-menu/electronics/05.png"
																		width="252"
																		alt="Canon Camera" />
																	<div class="text-center mt-4">
																		<a
															...
															<div class="d-none d-lg-block">
																...
																<div
																	...
																	<div class="text-center px-2">
																		<div class="fs-sm text-light-emphasis mb-2"
																			>Best deal! Save up to
																			<span class="fw-semibold">$200</span></div
																		>
																		<div class="h2 mb-4">Epson Color Printers</div>
																	</div>
																	<img
																		src="/themes/cartzilla/assets/img/mega-menu/electronics/06.png"
																		width="252"
																		alt="Epson Printer" />
																	<div class="text-center mt-4">
																		<a
														...
														<div class="d-flex flex-column flex-lg-row h-100 gap-4">
															...
															<div class="d-none d-lg-block">
																...
																<div
																	...
																	<img
																		src="/themes/cartzilla/assets/img/mega-menu/electronics/07.png"
																		width="252"
																		alt="Power Station" />
																	<div class="text-center mt-4">
																		<a
															...
															<div class="d-none d-lg-block">
																...
																<div
																	...
																	<div class="text-center px-2">
																		...
																		>
																		<div class="fs-sm text-light-emphasis mb-2"
																			>Starts from $119.99</div
																		>
																		<div class="h2 mb-4">Wireless Headphones</div>
																	</div>
																	<img
																		src="/themes/cartzilla/assets/img/mega-menu/electronics/08.png"
																		width="252"
														...
														<div class="d-flex flex-column flex-lg-row h-100 gap-4">
															...
															<div class="d-none d-lg-block">
																...
																<div
																	...
																	<img
																		src="/themes/cartzilla/assets/img/mega-menu/electronics/09.png"
																		width="252"
																		alt="Pixel Watch" />
																	<div class="text-center mt-4">
																		<a
														...
														<div class="d-flex flex-column flex-lg-row h-100 gap-4">
															...
															<div class="d-none d-lg-block">
																...
																<div
																	...
																	<img
																		src="/themes/cartzilla/assets/img/mega-menu/electronics/10.png"
																		width="252"
																		alt="Powerbank" />
																	<div class="text-center mt-4">
																		<a
															...
															<div class="d-none d-lg-block">
																...
																<div
																	...
																	<div class="text-center px-2">
																		...
																		>
																		<div class="fs-sm text-light-emphasis mb-2"
																			>Starts from $89.99</div
																		>
																		<div class="h2 mb-4">Samsung SSD Deals</div>
																	</div>
																	<img
																		src="/themes/cartzilla/assets/img/mega-menu/electronics/11.png"
																		width="252"
																		alt="SSD" />
																	<div class="text-center mt-4">
																		<a
												...
												<li class="dropend position-static">
													<div
														class="position-relative rounded pb-2 px-lg-2"
														tabindex="0"
														data-bs-toggle="dropdown"
														data-bs-trigger="hover">
														<a
														...
														<div class="d-flex flex-column flex-lg-row h-100 gap-lg-4">
															...
															<div class="d-none d-lg-block">
																...
																<div
																	...
																	<img
																		src="/themes/cartzilla/assets/img/mega-menu/electronics/12.png"
																		width="252"
																		alt="Xbox" />
																	<div class="text-center mt-4">
																		<a
											...
											<ul class="dropdown-menu">
													...
													<a class="dropdown-item d-block mb-0" href="home-electronics.html">
														...
														<div
															...
															<img
																...
																src="/themes/cartzilla/assets/img/mega-menu/demo-preview/electronics-light.jpg"
																alt="Electronics Store" />
															<img
																class="position-relative z-2 d-none d-block-dark"
																src="/themes/cartzilla/assets/img/mega-menu/demo-preview/electronics-dark.jpg"
																alt="Electronics Store" />
															<span
												...
												<li class="hover-effect-opacity px-2 mx-n2">
													<a class="dropdown-item d-block mb-0" href="home-fashion-v1.html">
														...
														<div
															...
															<img
																class="position-relative z-2 d-none-dark"
																src="/themes/cartzilla/assets/img/mega-menu/demo-preview/fashion-1-light.jpg"
																alt="Fashion Store v.1" />
															<img
																class="position-relative z-2 d-none d-block-dark"
																src="/themes/cartzilla/assets/img/mega-menu/demo-preview/fashion-1-dark.jpg"
																alt="Fashion Store v.1" />
															<span
																class="position-absolute top-0 start-0 w-100 h-100 rounded rounded-start-0 d-none-dark"
																style="box-shadow: .875rem .5rem 2rem -.5rem #676f7b; opacity: .1"></span>
												...
												<li class="hover-effect-opacity px-2 mx-n2">
													<a class="dropdown-item d-block mb-0" href="home-fashion-v2.html">
														...
														<span class="d-block fs-xs text-body-secondary"
															>Hero banner with hotspots</span
														>
														<div
															class="d-none d-lg-block hover-effect-target position-absolute top-0 start-100 bg-body border border-light-subtle rounded rounded-start-0 transition-none invisible opacity-0 pt-2 px-2 ms-n2"
															style="width: 212px; height: calc(100% + 2px); margin-top: -1px">
															<img
																class="position-relative z-2 d-none-dark"
																src="/themes/cartzilla/assets/img/mega-menu/demo-preview/fashion-2-light.jpg"
																alt="Fashion Store v.2" />
															<img
																class="position-relative z-2 d-none d-block-dark"
																src="/themes/cartzilla/assets/img/mega-menu/demo-preview/fashion-2-dark.jpg"
																alt="Fashion Store v.2" />
															<span
																class="position-absolute top-0 start-0 w-100 h-100 rounded rounded-start-0 d-none-dark"
																style="box-shadow: .875rem .5rem 2rem -.5rem #676f7b; opacity: .1"></span>
												...
												<li class="hover-effect-opacity px-2 mx-n2">
													<a class="dropdown-item d-block mb-0" href="home-furniture.html">
														...
														<div
															...
															<img
																class="position-relative z-2 d-none-dark"
																src="/themes/cartzilla/assets/img/mega-menu/demo-preview/furniture-light.jpg"
																alt="Furniture Store" />
															<img
																class="position-relative z-2 d-none d-block-dark"
																src="/themes/cartzilla/assets/img/mega-menu/demo-preview/furniture-dark.jpg"
																alt="Furniture Store" />
															<span
																class="position-absolute top-0 start-0 w-100 h-100 rounded rounded-start-0 d-none-dark"
																style="box-shadow: .875rem .5rem 2rem -.5rem #676f7b; opacity: .1"></span>
												...
												<li class="hover-effect-opacity px-2 mx-n2">
													<a class="dropdown-item d-block mb-0" href="home-grocery.html">
														...
														<span class="d-block fs-xs text-body-secondary"
															>Hero slider + Category cards</span
														>
														<div
															class="d-none d-lg-block hover-effect-target position-absolute top-0 start-100 bg-body border border-light-subtle rounded rounded-start-0 transition-none invisible opacity-0 pt-2 px-2 ms-n2"
															style="width: 212px; height: calc(100% + 2px); margin-top: -1px">
															<img
																class="position-relative z-2 d-none-dark"
																src="/themes/cartzilla/assets/img/mega-menu/demo-preview/grocery-light.jpg"
																alt="Grocery Store" />
															<img
																class="position-relative z-2 d-none d-block-dark"
																src="/themes/cartzilla/assets/img/mega-menu/demo-preview/grocery-dark.jpg"
																alt="Grocery Store" />
															<span
																class="position-absolute top-0 start-0 w-100 h-100 rounded rounded-start-0 d-none-dark"
																style="box-shadow: .875rem .5rem 2rem -.5rem #676f7b; opacity: .1"></span>
												...
												<li class="hover-effect-opacity px-2 mx-n2">
													<a class="dropdown-item d-block mb-0" href="home-marketplace.html">
														...
														<span class="d-block fs-xs text-body-secondary"
															>Multi-vendor, digital goods</span
														>
														<div
															class="d-none d-lg-block hover-effect-target position-absolute top-0 start-100 bg-body border border-light-subtle rounded rounded-start-0 transition-none invisible opacity-0 pt-2 px-2 ms-n2"
															style="width: 212px; height: calc(100% + 2px); margin-top: -1px">
															<img
																class="position-relative z-2 d-none-dark"
																src="/themes/cartzilla/assets/img/mega-menu/demo-preview/marketplace-light.jpg"
																alt="Marketplace" />
															<img
																class="position-relative z-2 d-none d-block-dark"
																src="/themes/cartzilla/assets/img/mega-menu/demo-preview/marketplace-dark.jpg"
																alt="Marketplace" />
															<span
																class="position-absolute top-0 start-0 w-100 h-100 rounded rounded-start-0 d-none-dark"
																style="box-shadow: .875rem .5rem 2rem -.5rem #676f7b; opacity: .1"></span>
												...
												<li class="hover-effect-opacity px-2 mx-n2">
													<a class="dropdown-item d-block mb-0" href="home-single-store.html">
														...
														<span class="d-block fs-xs text-body-secondary"
															>Single product / mono brand</span
														>
														<div
															class="d-none d-lg-block hover-effect-target position-absolute top-0 start-100 bg-body border border-light-subtle rounded rounded-start-0 transition-none invisible opacity-0 pt-2 px-2 ms-n2"
															style="width: 212px; height: calc(100% + 2px); margin-top: -1px">
															<img
																class="position-relative z-2 d-none-dark"
																src="/themes/cartzilla/assets/img/mega-menu/demo-preview/single-store-light.jpg"
																alt="Single Product Store" />
															<img
																class="position-relative z-2 d-none d-block-dark"
																src="/themes/cartzilla/assets/img/mega-menu/demo-preview/single-store-dark.jpg"
																alt="Single Product Store" />
															<span
																class="position-absolute top-0 start-0 w-100 h-100 rounded rounded-start-0 d-none-dark"
																style="box-shadow: .875rem .5rem 2rem -.5rem #676f7b; opacity: .1"></span>
										...
										<li class="nav-item dropdown me-lg-n1 me-xl-0">
											...
											<ul class="dropdown-menu">
												...
												<li class="dropend">
													...
													<ul class="dropdown-menu">
														<li
															><a class="dropdown-item" href="contact-v1.html"
																>Contact v.1</a
															></li
														>
														<li
														...
														>
														<li
															><a class="dropdown-item" href="contact-v3.html"
																>Contact v.3</a
															></li
														>
													</ul>
												...
												<li class="dropend">
													...
													<ul class="dropdown-menu">
														<li
															><a class="dropdown-item" href="help-topics-v1.html"
																>Help Topics v.1</a
															></li
														>
														<li
															><a class="dropdown-item" href="help-topics-v2.html"
																>Help Topics v.2</a
															></li
														>
														<li
															><a class="dropdown-item" href="help-single-article-v1.html"
																>Help Single Article v.1</a
															></li
														>
														<li
															><a class="dropdown-item" href="help-single-article-v2.html"
																>Help Single Article v.2</a
															></li
														>
													</ul>
												</li>
												<li class="dropend">
													...
													<ul class="dropdown-menu">
														<li
															><a class="dropdown-item" href="404-electronics.html"
																>404 Electronics</a
															></li
														>
														<li
															><a class="dropdown-item" href="404-fashion.html"
																>404 Fashion</a
															></li
														>
														<li
															><a class="dropdown-item" href="404-furniture.html"
																>404 Furniture</a
															></li
														>
														<li
															><a class="dropdown-item" href="404-grocery.html"
																>404 Grocery</a
															></li
														>
													</ul>
												...
												<li
													><a class="dropdown-item" href="terms-and-conditions.html"
														>Terms &amp; Conditions</a
													></li
												>
											</ul>
    ...
    <!-- /Page content -->
			...
			<div class="container position-relative z-1 pt-sm-2 pt-md-3 pt-lg-4" data-bs-theme="dark">
					...
					<div class="row">
						<div
							...
							<div class="dropdown" style="max-width: 250px">
								<button
									type="button"
									class="btn btn-secondary dropdown-toggle justify-content-between w-100"
									data-bs-toggle="dropdown"
									aria-haspopup="true"
									aria-expanded="false">
				...
				<div class="d-md-flex align-items-center border-top py-4">
					<div class="d-flex gap-2 gap-sm-3 justify-content-center ms-md-auto mb-4 mb-md-0 order-md-2">
						<div>
							<img src="/themes/cartzilla/assets/img/payment-methods/visa-dark-mode.svg" alt="Visa" />
						</div>
						<div>
							<img src="/themes/cartzilla/assets/img/payment-methods/mastercard.svg" alt="Mastercard" />
						</div>
						<div>
							<img src="/themes/cartzilla/assets/img/payment-methods/paypal-dark-mode.svg" alt="PayPal" />
						</div>
						<div>
							<img src="/themes/cartzilla/assets/img/payment-methods/google-pay-dark-mode.svg" alt="Google Pay" />
						</div>
						<div>
							<img src="/themes/cartzilla/assets/img/payment-methods/apple-pay-dark-mode.svg" alt="Apple Pay" />
						</div>
					</div>
			...
			<a class="btn-scroll-top btn btn-sm bg-body border-0 rounded-pill shadow animate-slide-end" href="#top">
				...
				<svg
					...
					<rect
						...
						style="stroke-dasharray: 155.201; stroke-dashoffset: 155.201;"></rect>
				</svg>
			</a>
			<a
			...
			<div class="offcanvas-body">
					...
					<div class="pb-4 mb-2">
						...
						<div class="alert alert-info p-2 mt-2 mb-0">
							<div class="d-flex text-body-emphasis fs-xs py-1 pe-1">
								...
								<div class="ps-2"
									>To switch the text direction of your webpage from LTR to RTL, please consult the
				...
				<div class="customizer-collapse collapse" id="customizerCode">
					...
					<p class="fs-sm pb-1"
						...
						your HTML document after the following link to the main stylesheet:<br /><code
							>&lt;link href="/themes/cartzilla/assets/css/theme.min.css"&gt;</code
						></p
					>
		...
		<div
			...
			<div class="offcanvas-header flex-column align-items-start py-3 pt-lg-4">
				...
				<p class="fs-sm"
					>Buy
					<span class="text-dark-emphasis fw-semibold">$183</span>
					more to get
			...
			<div class="offcanvas-body d-flex flex-column gap-4 pt-2">
				...
				<div class="d-flex align-items-center">
					<a class="position-relative flex-shrink-0" href="shop-product-general-electronics.html">
						...
						<img src="/themes/cartzilla/assets/img/shop/electronics/thumbs/09.png" width="110" alt="iPad Pro" />
					</a>
					<div class="w-100 min-w-0 ps-2 ps-sm-3">
						<h5 class="d-flex animate-underline mb-2">
							<a
						...
						<div class="h6 pb-1 mb-2"
							>$989.00 <del class="text-body-tertiary fs-xs fw-normal">$1,099.00</del></div
						>
						<div class="d-flex align-items-center justify-content-between">
							<div class="count-input rounded-2">
								<button
				...
				<div class="d-flex align-items-center">
					<a class="flex-shrink-0" href="shop-product-general-electronics.html">
						<img src="/themes/cartzilla/assets/img/shop/electronics/thumbs/01.png" width="110" alt="Smart Watch" />
					</a>
					<div class="w-100 min-w-0 ps-2 ps-sm-3">
						<h5 class="d-flex animate-underline mb-2">
							<a
