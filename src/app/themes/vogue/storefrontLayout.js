  ...
  <body>
          ...
          <div class="dropdown d-none d-md-block nav">
            <a class="nav-link dropdown-toggle py-1 px-0" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" aria-label="Country select: USA">
              <div class="ratio ratio-1x1" style="width: 20px">
                <img src="/themes/cartzilla/assets/img/flags/en-us.png" alt="USA">
              </div>
            </a>
            <ul class="dropdown-menu fs-sm" style="--cz-dropdown-spacer: .5rem">
              <li>
                <a class="dropdown-item" href="#!">
                  <img src="/themes/cartzilla/assets/img/flags/en-uk.png" class="flex-shrink-0 me-2" width="20" alt="United Kingdom">
                  United Kingdom
                </a>
              </li>
              <li>
                <a class="dropdown-item" href="#!">
                  <img src="/themes/cartzilla/assets/img/flags/fr.png" class="flex-shrink-0 me-2" width="20" alt="France">
                  France
                </a>
              </li>
              <li>
                <a class="dropdown-item" href="#!">
                  <img src="/themes/cartzilla/assets/img/flags/de.png" class="flex-shrink-0 me-2" width="20" alt="Deutschland">
                  Deutschland
                </a>
              </li>
              <li>
                <a class="dropdown-item" href="#!">
                  <img src="/themes/cartzilla/assets/img/flags/it.png" class="flex-shrink-0 me-2" width="20" alt="Italia">
                  Italia
                </a>
              </li>
            </ul>
                  ...
                  <div class="dropdown position-static pb-lg-2">
                    ...
                    <div class="dropdown-menu w-100 p-4 px-xl-5" style="--cz-dropdown-spacer: .75rem">
                      ...
                      <ul class="nav nav-underline justify-content-lg-center mt-n2 mt-lg-0 mb-4" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                          <button type="button" class="nav-link text-uppercase" id="mens-tab" data-bs-toggle="tab" data-bs-target="#mens-tab-pane" role="tab" aria-controls="mens-tab-pane" aria-selected="false" tabindex="-1">
                            Men's
                          </button>
                        </li>
                        <li class="nav-item" role="presentation">
                          <button type="button" class="nav-link text-uppercase" id="kids-tab" data-bs-toggle="tab" data-bs-target="#kids-tab-pane" role="tab" aria-controls="kids-tab-pane" aria-selected="false" tabindex="-1">
                            Kids'
                          </button>
                        </li>
                      </ul>
                          ...
                          <div class="row g-4">
                            ...
                            <div class="col-lg-4 d-none d-lg-block" data-bs-theme="light">
                              <div class="position-relative d-flex flex-column h-100 rounded-4 overflow-hidden p-4">
                                ...
                                <img src="/themes/cartzilla/assets/img/mega-menu/fashion/01.jpg" class="position-absolute top-0 start-0 w-100 h-100 object-fit-cover rtl-flip" alt="Image">
                              </div>
                            </div>
                          </div>
                        </div>
                          ...
                          <div class="row g-4">
                            ...
                            <div class="col-lg-4 d-none d-lg-block" data-bs-theme="dark">
                              <div class="position-relative d-flex flex-column h-100 rounded-4 overflow-hidden p-4">
                                ...
                                <img src="/themes/cartzilla/assets/img/mega-menu/fashion/02.jpg" class="position-absolute top-0 start-0 w-100 h-100 object-fit-cover rtl-flip" alt="Image">
                              </div>
                            </div>
                          </div>
                        </div>
                          ...
                          <div class="row g-4">
                            ...
                            <div class="col-lg-4 d-none d-lg-block" data-bs-theme="light">
                              <div class="position-relative d-flex flex-column h-100 rounded-4 overflow-hidden p-4">
                                ...
                                <img src="/themes/cartzilla/assets/img/mega-menu/fashion/03.jpg" class="position-absolute top-0 start-0 w-100 h-100 object-fit-cover rtl-flip" alt="Image">
                              </div>
                            </div>
                          </div>
                        </div>
    ...
    <main class="content-wrapper">
          ...
          <div class="row">
            ...
            <div class="col-md-6 col-lg-5 d-flex flex-column">
              <div class="py-4 mt-auto">
                <div class="swiper pb-1 pt-3 pt-sm-4 py-md-4 py-lg-3 swiper-initialized swiper-horizontal swiper-backface-hidden" data-swiper="{
                  &quot;spaceBetween&quot;: 24,
                  &quot;loop&quot;: true,
                  &quot;speed&quot;: 400,
                  ...
                  <div class="swiper-wrapper align-items-center" id="swiper-wrapper-45179e9a2c4d2619" aria-live="off" style="transition-duration: 0ms; transform: translate3d(-531px, 0px, 0px); transition-delay: 0ms;">

                    <!-- Item -->
                    <div class="swiper-slide text-center text-md-start swiper-slide-prev" style="width: 507px; margin-right: 24px;" role="group" aria-label="1 / 3" data-swiper-slide-index="0">
                    ...
                    <!-- Item -->
                    <div class="swiper-slide text-center text-md-start swiper-slide-active" style="width: 507px; margin-right: 24px;" role="group" aria-label="2 / 3" data-swiper-slide-index="1">
                    ...
                    <!-- Item -->
                    <div class="swiper-slide text-center text-md-start swiper-slide-next" role="group" aria-label="3 / 3" data-swiper-slide-index="2" style="width: 507px; margin-right: 24px;">
              ...
              <div class="d-flex justify-content-center justify-content-md-start pb-4 pb-xl-5 mt-n1 mt-md-auto mb-md-3 mb-lg-4">
                <div class="swiper-pagination position-static w-auto pb-1 swiper-pagination-clickable swiper-pagination-bullets swiper-pagination-horizontal" id="sliderBullets"><span class="swiper-pagination-bullet" tabindex="0" role="button" aria-label="Go to slide 1"></span><span class="swiper-pagination-bullet swiper-pagination-bullet-active" tabindex="0" role="button" aria-label="Go to slide 2" aria-current="true"></span><span class="swiper-pagination-bullet" tabindex="0" role="button" aria-label="Go to slide 3"></span></div>
              </div>
            </div>
            ...
            <div class="col-md-6 col-lg-7 align-self-end">
              <div class="position-relative ms-md-n4">
                ...
                <div class="swiper position-absolute top-0 start-0 w-100 h-100 user-select-none swiper-fade swiper-initialized swiper-horizontal swiper-watch-progress swiper-backface-hidden" id="heroImages" data-swiper="{
                  ...
                  <div class="swiper-wrapper" id="swiper-wrapper-ed5cc119ff487295" aria-live="polite" style="transition-duration: 0ms; transition-delay: 0ms;">
                    <div class="swiper-slide swiper-slide-prev" style="width: 744px; opacity: 0; transform: translate3d(0px, 0px, 0px); transition-duration: 0ms;" role="group" aria-label="1 / 3" data-swiper-slide-index="0">
                      <img src="/themes/cartzilla/assets/img/home/fashion/v1/hero-slider/01.png" class="rtl-flip" alt="Image">
                    </div>
                    <div class="swiper-slide swiper-slide-visible swiper-slide-fully-visible swiper-slide-active" style="width: 744px; opacity: 1; transform: translate3d(-744px, 0px, 0px); transition-duration: 0ms;" role="group" aria-label="2 / 3" data-swiper-slide-index="1">
                      <img src="/themes/cartzilla/assets/img/home/fashion/v1/hero-slider/02.png" class="rtl-flip" alt="Image">
                    </div>
                    <div class="swiper-slide swiper-slide-next" role="group" aria-label="3 / 3" style="width: 744px; opacity: 0; transform: translate3d(-1488px, 0px, 0px); transition-duration: 0ms;" data-swiper-slide-index="2">
                      <img src="/themes/cartzilla/assets/img/home/fashion/v1/hero-slider/03.png" class="rtl-flip" alt="Image">
                    </div>
                  </div>
      ...
      <section class="container py-5 my-2 my-sm-3 my-lg-4 my-xl-5">
        <div class="row align-items-lg-center py-xxl-3">
            ...
            <div class="ps-md-3 ps-lg-4 ps-xl-0">
              <div class="d-flex align-items-center justify-content-between pb-4 mb-md-1 mb-lg-2 mb-xl-3">
                ...
                <div class="d-flex gap-2">
                  <button type="button" class="btn btn-icon btn-outline-secondary animate-slide-start rounded-circle me-1" id="popularPrev" aria-label="Previous slide" tabindex="0" aria-controls="swiper-wrapper-109ba7c9c2dff1fc5">
                    <i class="ci-chevron-left fs-lg animate-target"></i>
                  </button>
                  <button type="button" class="btn btn-icon btn-outline-secondary animate-slide-end rounded-circle" id="popularNext" aria-label="Next slide" tabindex="0" aria-controls="swiper-wrapper-109ba7c9c2dff1fc5">
              ...
              <div class="swiper swiper-initialized swiper-horizontal swiper-backface-hidden" data-swiper="{
                ...
                <div class="swiper-wrapper" id="swiper-wrapper-109ba7c9c2dff1fc5" aria-live="polite">

                  <!-- Products list slide -->
                  <div class="swiper-slide swiper-slide-active" style="width: 507px; margin-right: 24px;" role="group" aria-label="1 / 2" data-swiper-slide-index="0">
                    <div class="d-flex flex-column gap-3 gap-lg-4">
                      <div class="d-flex align-items-center position-relative bg-body-tertiary rounded overflow-hidden animate-underline">
                        <img src="/themes/cartzilla/assets/img/shop/fashion/thumbs/01.png" width="110" alt="Thumbnail">
                      ...
                      <div class="d-flex align-items-center position-relative bg-body-tertiary rounded overflow-hidden animate-underline">
                        <img src="/themes/cartzilla/assets/img/shop/fashion/thumbs/02.png" width="110" alt="Thumbnail">
                        <div class="nav flex-column gap-2 min-w-0 p-3">
                          <a class="nav-link text-dark-emphasis stretched-link w-100 min-w-0 p-0" href="shop-product-fashion.html">
                      ...
                      <div class="d-flex align-items-center position-relative bg-body-tertiary rounded overflow-hidden animate-underline">
                        <img src="/themes/cartzilla/assets/img/shop/fashion/thumbs/03.png" width="110" alt="Thumbnail">
                        <div class="nav flex-column gap-2 min-w-0 p-3">
                          <a class="nav-link text-dark-emphasis stretched-link w-100 min-w-0 p-0" href="shop-product-fashion.html">
                  ...
                  <!-- Products list slide -->
                  <div class="swiper-slide swiper-slide-next" role="group" aria-label="2 / 2" data-swiper-slide-index="1" style="width: 507px; margin-right: 24px;">
                    <div class="d-flex flex-column gap-3 gap-lg-4">
                      <div class="d-flex align-items-center position-relative bg-body-tertiary rounded overflow-hidden animate-underline">
                        <img src="/themes/cartzilla/assets/img/shop/fashion/thumbs/04.png" width="110" alt="Thumbnail">
                        <div class="nav flex-column gap-2 min-w-0 p-3">
                          <a class="nav-link text-dark-emphasis stretched-link w-100 min-w-0 p-0" href="shop-product-fashion.html">
                      ...
                      <div class="d-flex align-items-center position-relative bg-body-tertiary rounded overflow-hidden animate-underline">
                        <img src="/themes/cartzilla/assets/img/shop/fashion/thumbs/05.png" width="110" alt="Thumbnail">
                        <div class="nav flex-column gap-2 min-w-0 p-3">
                          <a class="nav-link text-dark-emphasis stretched-link w-100 min-w-0 p-0" href="shop-product-fashion.html">
                      ...
                      <div class="d-flex align-items-center position-relative bg-body-tertiary rounded overflow-hidden animate-underline">
                        <img src="/themes/cartzilla/assets/img/shop/fashion/thumbs/06.png" width="110" alt="Thumbnail">
                        <div class="nav flex-column gap-2 min-w-0 p-3">
                          <a class="nav-link text-dark-emphasis stretched-link w-100 min-w-0 p-0" href="shop-product-fashion.html">
          ...
          <div class="col-md-6 order-md-1">
            <div class="swiper user-select-none swiper-fade swiper-initialized swiper-horizontal swiper-watch-progress swiper-backface-hidden" id="sliderImages" data-swiper="{
              &quot;allowTouchMove&quot;: false,
              &quot;loop&quot;: true,
              &quot;effect&quot;: &quot;fade&quot;,
              &quot;fadeEffect&quot;: {
              ...
              <div class="swiper-wrapper" id="swiper-wrapper-9e82adba57d4810ea" aria-live="polite">
                <div class="swiper-slide swiper-slide-visible swiper-slide-fully-visible swiper-slide-active" style="width: 614px; opacity: 1; transform: translate3d(0px, 0px, 0px);" role="group" aria-label="1 / 2" data-swiper-slide-index="0">
                  <div class="ratio d-none d-md-block" style="--cz-aspect-ratio: calc(720 / 636 * 100%)"></div>
                  <div class="ratio ratio-4x3 d-md-none"></div>
                  <img src="/themes/cartzilla/assets/img/home/fashion/v1/popular/01.jpg" class="position-absolute top-0 start-0 w-100 h-100 object-fit-cover rounded-5" alt="Image">
                </div>
                <div class="swiper-slide swiper-slide-next" role="group" aria-label="2 / 2" style="width: 614px; opacity: 0; transform: translate3d(-614px, 0px, 0px);" data-swiper-slide-index="1">
                  <div class="ratio d-none d-md-block" style="--cz-aspect-ratio: calc(720 / 636 * 100%)"></div>
                  <div class="ratio ratio-4x3 d-md-none"></div>
                  <img src="/themes/cartzilla/assets/img/home/fashion/v1/popular/02.jpg" class="position-absolute top-0 start-0 w-100 h-100 object-fit-cover rounded-5" style="object-position: center top" alt="Image">
                </div>
              </div>
            <span class="swiper-notification" aria-live="assertive" aria-atomic="true"></span><span class="swiper-notification" aria-live="assertive" aria-atomic="true"></span></div>
          </div>
              ...
              <div class="position-relative mb-3">
                ...
                <a class="d-flex bg-body-tertiary rounded p-3" href="shop-product-fashion.html">
                  <div class="ratio" style="--cz-aspect-ratio: calc(308 / 274 * 100%)">
                    <img src="/themes/cartzilla/assets/img/shop/fashion/01.png" alt="Image">
                  </div>
                </a>
          ...
          <div class="col mb-2 mb-sm-3 mb-md-0">
            <div class="animate-underline hover-effect-opacity">
              <div class="position-relative mb-3">
                ...
                <a class="d-flex bg-body-tertiary rounded p-3" href="shop-product-fashion.html">
                  <div class="ratio" style="--cz-aspect-ratio: calc(308 / 274 * 100%)">
                    <img src="/themes/cartzilla/assets/img/shop/fashion/08.png" alt="Image">
                  </div>
                </a>
                <div class="hover-effect-target position-absolute start-0 bottom-0 w-100 z-2 opacity-0 pb-2 pb-sm-3 px-2 px-sm-3">
                  <div class="d-flex align-items-center justify-content-center gap-2 gap-xl-3 bg-body rounded-2 p-2">
            ...
            <div class="animate-underline hover-effect-opacity">
              <div class="position-relative mb-3">
                ...
                <a class="d-flex bg-body-tertiary rounded p-3" href="#!">
                  <div class="ratio" style="--cz-aspect-ratio: calc(308 / 274 * 100%)">
                    <img src="/themes/cartzilla/assets/img/shop/fashion/11.png" alt="Image">
                  </div>
                </a>
                <div class="hover-effect-target position-absolute start-0 bottom-0 w-100 z-2 opacity-0 pb-2 pb-sm-3 px-2 px-sm-3">
                  <div class="d-flex align-items-center justify-content-center gap-2 gap-xl-3 bg-body rounded-2 p-2">
          ...
          <div class="col mb-2 mb-sm-3 mb-md-0">
            <div class="animate-underline hover-effect-opacity">
              <div class="position-relative mb-3">
                ...
                <a class="d-flex bg-body-tertiary rounded p-3" href="shop-product-fashion.html">
                  <div class="ratio" style="--cz-aspect-ratio: calc(308 / 274 * 100%)">
                    <img src="/themes/cartzilla/assets/img/shop/fashion/04.png" alt="Image">
                  </div>
                </a>
              </div>
              <div class="nav mb-2">
          ...
          <div class="col mb-2 mb-sm-3 mb-md-0">
            <div class="animate-underline hover-effect-opacity">
              <div class="position-relative mb-3">
                ...
                <a class="d-flex bg-body-tertiary rounded p-3" href="shop-product-fashion.html">
                  <div class="ratio" style="--cz-aspect-ratio: calc(308 / 274 * 100%)">
                    <img src="/themes/cartzilla/assets/img/shop/fashion/09.png" alt="Image">
                  </div>
                </a>
                <div class="hover-effect-target position-absolute start-0 bottom-0 w-100 z-2 opacity-0 pb-2 pb-sm-3 px-2 px-sm-3">
                  <div class="d-flex align-items-center justify-content-center gap-2 gap-xl-3 bg-body rounded-2 p-2">
          ...
          <div class="col mb-2 mb-sm-3 mb-md-0">
            <div class="animate-underline hover-effect-opacity">
              <div class="position-relative mb-3">
                ...
                <a class="d-flex bg-body-tertiary rounded p-3" href="shop-product-fashion.html">
                  <div class="ratio" style="--cz-aspect-ratio: calc(308 / 274 * 100%)">
                    <img src="/themes/cartzilla/assets/img/shop/fashion/10.png" alt="Image">
                  </div>
                </a>
              </div>
              <div class="nav mb-2">
          ...
          <div class="col mb-2 mb-sm-3 mb-md-0">
            <div class="animate-underline hover-effect-opacity">
              <div class="position-relative mb-3">
                ...
                <a class="d-flex bg-body-tertiary rounded p-3" href="shop-product-fashion.html">
                  <div class="ratio" style="--cz-aspect-ratio: calc(308 / 274 * 100%)">
                    <img src="/themes/cartzilla/assets/img/shop/fashion/05.png" alt="Image">
                  </div>
                </a>
              </div>
              <div class="nav mb-2">
          ...
          <div class="col mb-2 mb-sm-3 mb-md-0">
            <div class="animate-underline hover-effect-opacity">
              <div class="position-relative mb-3">
                ...
                <a class="d-flex bg-body-tertiary rounded p-3" href="shop-product-fashion.html">
                  <div class="ratio" style="--cz-aspect-ratio: calc(308 / 274 * 100%)">
                    <img src="/themes/cartzilla/assets/img/shop/fashion/06.png" alt="Image">
                  </div>
                </a>
                <div class="hover-effect-target position-absolute start-0 bottom-0 w-100 z-2 opacity-0 pb-2 pb-sm-3 px-2 px-sm-3">
                  <div class="d-flex align-items-center justify-content-center gap-2 gap-xl-3 bg-body rounded-2 p-2">
      ...
      <section class="container pb-5 mb-2 mb-sm-3 mb-lg-4 mb-xl-5">
        ...
        <div class="row align-items-center pb-xxl-3">
          ...
          <div class="col-md-7 order-md-2 mb-4 mb-md-0">
            <div class="swiper user-select-none swiper-fade swiper-initialized swiper-horizontal swiper-watch-progress swiper-backface-hidden" id="previewImages" data-swiper="{
              &quot;allowTouchMove&quot;: false,
              &quot;loop&quot;: true,
              &quot;effect&quot;: &quot;fade&quot;,
              &quot;fadeEffect&quot;: {
              ...
              <div class="swiper-wrapper" id="swiper-wrapper-9f1717741b10a8347" aria-live="polite">
                <div class="swiper-slide swiper-slide-visible swiper-slide-fully-visible swiper-slide-active" style="width: 720px; opacity: 1; transform: translate3d(0px, 0px, 0px);" role="group" aria-label="1 / 2" data-swiper-slide-index="0">
                  <div class="ratio" style="--cz-aspect-ratio: calc(720 / 746 * 100%)">
                    <img src="/themes/cartzilla/assets/img/home/fashion/v1/collection/01.jpg" class="rounded-5" alt="Image">
                  </div>
                </div>
                <div class="swiper-slide swiper-slide-next" role="group" aria-label="2 / 2" style="width: 720px; opacity: 0; transform: translate3d(-720px, 0px, 0px);" data-swiper-slide-index="1">
                  <div class="ratio" style="--cz-aspect-ratio: calc(720 / 746 * 100%)">
                    <img src="/themes/cartzilla/assets/img/home/fashion/v1/collection/02.jpg" class="rounded-5" alt="Image">
                  </div>
                </div>
              </div>
            <span class="swiper-notification" aria-live="assertive" aria-atomic="true"></span><span class="swiper-notification" aria-live="assertive" aria-atomic="true"></span></div>
          ...
          <div class="col-md-5 order-md-1 text-center">
            ...
            <div class="d-flex align-items-center justify-content-center">
              ...
              <!-- Prev button -->
              <button type="button" class="btn btn-icon btn-outline-secondary animate-slide-start rounded-circle mt-n5" id="collectionPrev" aria-label="Previous slide" tabindex="0" aria-controls="swiper-wrapper-a69f19abc1d81382">
                <i class="ci-chevron-left fs-lg animate-target"></i>
              </button>

              <!-- Slider -->
              <div class="swiper mx-3 mx-lg-4 swiper-initialized swiper-horizontal swiper-backface-hidden" data-swiper="{
                &quot;spaceBetween&quot;: 24,
                &quot;loop&quot;: true,
                &quot;speed&quot;: 400,
                ...
                <div class="swiper-wrapper" id="swiper-wrapper-a69f19abc1d81382" aria-live="polite">

                  <!-- Item -->
                  <div class="swiper-slide swiper-slide-active" style="width: 306px; margin-right: 24px;" role="group" aria-label="1 / 2" data-swiper-slide-index="0">
                    <div class="animate-underline hover-effect-opacity">
                      <a class="d-flex bg-body-tertiary rounded p-3 mb-3" href="shop-product-fashion.html">
                        <div class="ratio" style="--cz-aspect-ratio: calc(308 / 274 * 100%)">
                          <img src="/themes/cartzilla/assets/img/shop/fashion/03.png" alt="Image">
                        </div>
                      </a>
                  ...
                  <!-- Item -->
                  <div class="swiper-slide swiper-slide-next" role="group" aria-label="2 / 2" data-swiper-slide-index="1" style="width: 306px; margin-right: 24px;">
                    <div class="animate-underline hover-effect-opacity">
                      <a class="d-flex bg-body-tertiary rounded p-3 mb-3" href="shop-product-fashion.html">
                        <div class="ratio" style="--cz-aspect-ratio: calc(308 / 274 * 100%)">
                          <img src="/themes/cartzilla/assets/img/shop/fashion/12.png" alt="Image">
                        </div>
                      </a>
                      <div class="nav justify-content-center mb-2">
                        <a class="nav-link animate-target min-w-0 text-dark-emphasis p-0" href="shop-product-fashion.html">
              ...
              <!-- Next button -->
              <button type="button" class="btn btn-icon btn-outline-secondary animate-slide-end rounded-circle mt-n5" id="collectionNext" aria-label="Next slide" tabindex="0" aria-controls="swiper-wrapper-a69f19abc1d81382">
                <i class="ci-chevron-right fs-lg animate-target"></i>
              </button>
            </div>
          </div>
      ...
      <section class="container pb-5 mb-1 mb-sm-3 mb-lg-4 mb-xl-5">
        <div class="swiper my-md-3 swiper-initialized swiper-horizontal swiper-backface-hidden" data-swiper="{
          &quot;slidesPerView&quot;: 2,
          &quot;pagination&quot;: {
      ...
      <section class="bg-body-tertiary py-5">
        <div class="container py-1 py-sm-2 py-md-3 py-lg-4 py-xl-5">
          ...
          <div class="position-relative pb-xxl-3">
            ...
            <button type="button" class="btn btn-icon btn-outline-secondary bg-body rounded-circle animate-slide-start position-absolute top-50 start-0 z-2 translate-middle d-none d-sm-inline-flex mt-n4" id="reviewsPrev" aria-label="Previous slide" tabindex="0" aria-controls="swiper-wrapper-ff6101721dd5a3f97">
              <i class="ci-chevron-left fs-lg animate-target"></i>
            </button>
            <button type="button" class="btn btn-icon btn-outline-secondary bg-body rounded-circle animate-slide-end position-absolute top-50 start-100 z-2 translate-middle d-none d-sm-inline-flex mt-n4" id="reviewsNext" aria-label="Next slide" tabindex="0" aria-controls="swiper-wrapper-ff6101721dd5a3f97">
              <i class="ci-chevron-right fs-lg animate-target"></i>
            </button>
            ...
            <div class="swiper swiper-initialized swiper-horizontal swiper-backface-hidden" data-swiper="{
              ...
              <div class="swiper-wrapper" id="swiper-wrapper-ff6101721dd5a3f97" aria-live="polite">

                <!-- Review -->
                <div class="swiper-slide h-auto swiper-slide-active" style="width: 401px; margin-right: 24px;" role="group" aria-label="1 / 5" data-swiper-slide-index="0">
                  <div class="card h-100 border-0 rounded-4 p-sm-2">
                    <div class="card-body">
                      <div class="d-flex align-items-center mb-3">
                        <div class="ratio ratio-1x1 flex-shrink-0" style="max-width: 80px">
                          <img src="/themes/cartzilla/assets/img/home/fashion/v1/reviews/01.png" width="80" alt="Image">
                        </div>
                        <div class="ps-2 ms-1">
                ...
                <!-- Review -->
                <div class="swiper-slide h-auto swiper-slide-next" style="width: 401px; margin-right: 24px;" role="group" aria-label="2 / 5" data-swiper-slide-index="1">
                  <div class="card h-100 border-0 rounded-4 p-sm-2">
                    <div class="card-body">
                      <div class="d-flex align-items-center mb-3">
                        <div class="ratio ratio-1x1 flex-shrink-0" style="max-width: 80px">
                          <img src="/themes/cartzilla/assets/img/home/fashion/v1/reviews/02.png" width="80" alt="Image">
                        </div>
                        <div class="ps-2 ms-1">
                          <div class="d-flex gap-1 fs-xs pb-2 mb-1">
                            <i class="ci-star-filled text-warning"></i>
                ...
                <!-- Review -->
                <div class="swiper-slide h-auto" style="width: 401px; margin-right: 24px;" role="group" aria-label="3 / 5" data-swiper-slide-index="2">
                  <div class="card h-100 border-0 rounded-4 p-sm-2">
                    <div class="card-body">
                      <div class="d-flex align-items-center mb-3">
                        <div class="ratio ratio-1x1 flex-shrink-0" style="max-width: 80px">
                          <img src="/themes/cartzilla/assets/img/home/fashion/v1/reviews/03.png" width="80" alt="Image">
                        </div>
                        <div class="ps-2 ms-1">
                          <div class="d-flex gap-1 fs-xs pb-2 mb-1">
                            <i class="ci-star-filled text-warning"></i>
                ...
                <!-- Review -->
                <div class="swiper-slide h-auto" style="width: 401px; margin-right: 24px;" role="group" aria-label="4 / 5" data-swiper-slide-index="3">
                  <div class="card h-100 border-0 rounded-4 p-sm-2">
                    <div class="card-body">
                      <div class="d-flex align-items-center mb-3">
                        <div class="ratio ratio-1x1 flex-shrink-0" style="max-width: 80px">
                          <img src="/themes/cartzilla/assets/img/home/fashion/v1/reviews/04.png" width="80" alt="Image">
                        </div>
                        <div class="ps-2 ms-1">
                          <div class="d-flex gap-1 fs-xs pb-2 mb-1">
                            <i class="ci-star-filled text-warning"></i>
                ...
                <!-- Review -->
                <div class="swiper-slide h-auto" role="group" aria-label="5 / 5" data-swiper-slide-index="4" style="width: 401px; margin-right: 24px;">
                  <div class="card h-100 border-0 rounded-4 p-sm-2">
                    <div class="card-body">
                      <div class="d-flex align-items-center mb-3">
                        <div class="ratio ratio-1x1 flex-shrink-0" style="max-width: 80px">
                          <img src="/themes/cartzilla/assets/img/home/fashion/v1/reviews/05.png" width="80" alt="Image">
                        </div>
                        <div class="ps-2 ms-1">
                          <div class="d-flex gap-1 fs-xs pb-2 mb-1">
                            <i class="ci-star-filled text-warning"></i>
              ...
              <!-- Pagination (Bullets) -->
              <div class="swiper-pagination position-static pt-3 mt-sm-1 mt-md-2 mt-lg-3 swiper-pagination-clickable swiper-pagination-bullets swiper-pagination-horizontal"><span class="swiper-pagination-bullet swiper-pagination-bullet-active" tabindex="0" role="button" aria-label="Go to slide 1" aria-current="true"></span><span class="swiper-pagination-bullet" tabindex="0" role="button" aria-label="Go to slide 2"></span><span class="swiper-pagination-bullet" tabindex="0" role="button" aria-label="Go to slide 3"></span><span class="swiper-pagination-bullet" tabindex="0" role="button" aria-label="Go to slide 4"></span><span class="swiper-pagination-bullet" tabindex="0" role="button" aria-label="Go to slide 5"></span></div>
            <span class="swiper-notification" aria-live="assertive" aria-atomic="true"></span></div>
          </div>
        </div>
      </section>
      ...
      <section class="container pt-5 mt-1 mt-sm-2 mt-md-3 mt-lg-4 mt-xl-5">
        ...
        <div class="overflow-x-auto pb-3 mb-n3" data-simplebar="init"><div class="simplebar-wrapper" style="margin: 0px 0px -16px;"><div class="simplebar-height-auto-observer-wrapper"><div class="simplebar-height-auto-observer"></div></div><div class="simplebar-mask"><div class="simplebar-offset" style="right: 0px; bottom: 0px;"><div class="simplebar-content-wrapper" tabindex="0" role="region" aria-label="scrollable content" style="height: auto; overflow: hidden;"><div class="simplebar-content" style="padding: 0px 0px 16px;">
          <div class="d-flex gap-2 gap-md-3 gap-lg-4" style="min-width: 700px">
            <a class="hover-effect-scale hover-effect-opacity position-relative w-100 overflow-hidden" href="#!">
              ...
              <div class="hover-effect-target ratio ratio-1x1">
                <img src="/themes/cartzilla/assets/img/instagram/01.jpg" alt="Instagram image">
              </div>
            </a>
            <a class="hover-effect-scale hover-effect-opacity position-relative w-100 overflow-hidden" href="#!">
              <span class="hover-effect-target position-absolute top-0 start-0 w-100 h-100 bg-black bg-opacity-25 opacity-0 z-1"></span>
              <i class="ci-instagram hover-effect-target fs-4 text-white position-absolute top-50 start-50 translate-middle opacity-0 z-2"></i>
              <div class="hover-effect-target ratio ratio-1x1">
                <img src="/themes/cartzilla/assets/img/instagram/02.jpg" alt="Instagram image">
              </div>
            </a>
            <a class="hover-effect-scale hover-effect-opacity position-relative w-100 overflow-hidden" href="#!">
              <span class="hover-effect-target position-absolute top-0 start-0 w-100 h-100 bg-black bg-opacity-25 opacity-0 z-1"></span>
              <i class="ci-instagram hover-effect-target fs-4 text-white position-absolute top-50 start-50 translate-middle opacity-0 z-2"></i>
              <div class="hover-effect-target ratio ratio-1x1">
                <img src="/themes/cartzilla/assets/img/instagram/03.jpg" alt="Instagram image">
              </div>
            </a>
            <a class="hover-effect-scale hover-effect-opacity position-relative w-100 overflow-hidden" href="#!">
              <span class="hover-effect-target position-absolute top-0 start-0 w-100 h-100 bg-black bg-opacity-25 opacity-0 z-1"></span>
              <i class="ci-instagram hover-effect-target fs-4 text-white position-absolute top-50 start-50 translate-middle opacity-0 z-2"></i>
              <div class="hover-effect-target ratio ratio-1x1">
                <img src="/themes/cartzilla/assets/img/instagram/04.jpg" alt="Instagram image">
              </div>
            </a>
            <a class="hover-effect-scale hover-effect-opacity position-relative w-100 overflow-hidden" href="#!">
              <span class="hover-effect-target position-absolute top-0 start-0 w-100 h-100 bg-black bg-opacity-25 opacity-0 z-1"></span>
              <i class="ci-instagram hover-effect-target fs-4 text-white position-absolute top-50 start-50 translate-middle opacity-0 z-2"></i>
              <div class="hover-effect-target ratio ratio-1x1">
                <img src="/themes/cartzilla/assets/img/instagram/05.jpg" alt="Instagram image">
              </div>
            </a>
          </div>
        </div></div></div></div><div class="simplebar-placeholder" style="width: 1251px; height: 247px;"></div></div><div class="simplebar-track simplebar-horizontal" style="visibility: hidden;"><div class="simplebar-scrollbar" style="width: 0px; display: none;"></div></div><div class="simplebar-track simplebar-vertical" style="visibility: hidden;"><div class="simplebar-scrollbar" style="height: 0px; display: none;"></div></div></div>
      </section>
    </main>
    ...
    <footer class="footer pt-5 pb-4">
      <div class="container pt-sm-2 pt-md-3 pt-lg-4">
        ...
        <div class="d-flex justify-content-center justify-content-lg-start gap-2 mt-n2 mt-md-0">
          <a class="btn btn-icon fs-base btn-outline-secondary border-0" href="#!" data-bs-toggle="tooltip" data-bs-template="<div class=&quot;tooltip fs-xs mb-n2&quot; role=&quot;tooltip&quot;><div class=&quot;tooltip-inner bg-transparent text-body p-0&quot;></div></div>" aria-label="Follow us on YouTube" data-bs-original-title="YouTube">
            <i class="ci-youtube"></i>
          </a>
          <a class="btn btn-icon fs-base btn-outline-secondary border-0" href="#!" data-bs-toggle="tooltip" data-bs-template="<div class=&quot;tooltip fs-xs mb-n2&quot; role=&quot;tooltip&quot;><div class=&quot;tooltip-inner bg-transparent text-body p-0&quot;></div></div>" aria-label="Follow us on Facebook" data-bs-original-title="Facebook">
            <i class="ci-facebook"></i>
          </a>
          <a class="btn btn-icon fs-base btn-outline-secondary border-0" href="#!" data-bs-toggle="tooltip" data-bs-template="<div class=&quot;tooltip fs-xs mb-n2&quot; role=&quot;tooltip&quot;><div class=&quot;tooltip-inner bg-transparent text-body p-0&quot;></div></div>" aria-label="Follow us on Instagram" data-bs-original-title="Instagram">
            <i class="ci-instagram"></i>
          </a>
          <a class="btn btn-icon fs-base btn-outline-secondary border-0" href="#!" data-bs-toggle="tooltip" data-bs-template="<div class=&quot;tooltip fs-xs mb-n2&quot; role=&quot;tooltip&quot;><div class=&quot;tooltip-inner bg-transparent text-body p-0&quot;></div></div>" aria-label="Follow us on Telegram" data-bs-original-title="Telegram">
            <i class="ci-telegram"></i>
          </a>
          <a class="btn btn-icon fs-base btn-outline-secondary border-0" href="#!" data-bs-toggle="tooltip" data-bs-template="<div class=&quot;tooltip fs-xs mb-n2&quot; role=&quot;tooltip&quot;><div class=&quot;tooltip-inner bg-transparent text-body p-0&quot;></div></div>" aria-label="Follow us on Pinterest" data-bs-original-title="Pinterest">
      ...
      <div class="offcanvas-body d-flex flex-column gap-4 pt-2">
        ...
        <div class="d-flex align-items-center">
          <a class="flex-shrink-0" href="shop-product-fashion.html">
            <img src="/themes/cartzilla/assets/img/shop/fashion/thumbs/07.png" class="bg-body-tertiary rounded" width="110" alt="Thumbnail">
          </a>
        ...
        <div class="d-flex align-items-center">
          <a class="flex-shrink-0" href="shop-product-fashion.html">
            <img src="/themes/cartzilla/assets/img/shop/fashion/thumbs/08.png" class="bg-body-tertiary rounded" width="110" alt="Thumbnail">
          </a>
          <div class="w-100 min-w-0 ps-3">
            <h5 class="d-flex animate-underline mb-2">
        ...
        <div class="d-flex align-items-center">
          <a class="flex-shrink-0" href="shop-product-fashion.html">
            <img src="/themes/cartzilla/assets/img/shop/fashion/thumbs/09.png" class="bg-body-tertiary rounded" width="110" alt="Thumbnail">
          </a>
          <div class="w-100 min-w-0 ps-3">
            <h5 class="d-flex animate-underline mb-2">
    ...
    <div class="alert alert-dismissible bg-dark text-white rounded-0 py-2 px-0 m-0 fade show" data-bs-theme="dark">
      <div class="container position-relative d-flex min-w-0">
        <div class="d-flex flex-nowrap align-items-center g-2 w-100 min-w-0 mx-auto mt-n1" style="max-width: 458px">
          <div class="nav me-2">
            <button type="button" class="nav-link fs-lg p-0" id="topbarPrev" aria-label="Previous slide" tabindex="0" aria-controls="swiper-wrapper-b101c10cfa107868295">
              <i class="ci-chevron-left"></i>
            </button>
          </div>
          <div class="swiper fs-sm text-white swiper-initialized swiper-horizontal swiper-backface-hidden" data-swiper="{
            &quot;spaceBetween&quot;: 24,
            &quot;loop&quot;: true,
            &quot;autoplay&quot;: {
              &quot;delay&quot;: 5000,
            ...
            <div class="swiper-wrapper min-w-0" id="swiper-wrapper-b101c10cfa107868295" aria-live="off" style="transition-duration: 0ms; transform: translate3d(-430px, 0px, 0px); transition-delay: 0ms;">
              <div class="swiper-slide text-truncate text-center swiper-slide-prev" style="width: 406px; margin-right: 24px;" role="group" aria-label="1 / 3" data-swiper-slide-index="0">🎉 Free Shipping on orders over $250. <span class="d-none d-sm-inline">Don't miss a discount!</span></div>
              <div class="swiper-slide text-truncate text-center swiper-slide-active" style="width: 406px; margin-right: 24px;" role="group" aria-label="2 / 3" data-swiper-slide-index="1">💰 Money back guarantee. <span class="d-none d-sm-inline">We return money within 30 days.</span></div>
              <div class="swiper-slide text-truncate text-center swiper-slide-next" role="group" aria-label="3 / 3" data-swiper-slide-index="2" style="width: 406px; margin-right: 24px;">💪 Friendly 24/7 customer support. <span class="d-none d-sm-inline">We've got you covered!</span></div>
            </div>
          <span class="swiper-notification" aria-live="assertive" aria-atomic="true"></span></div>
          <div class="nav ms-2">
            <button type="button" class="nav-link fs-lg p-0" id="topbarNext" aria-label="Next slide" tabindex="0" aria-controls="swiper-wrapper-b101c10cfa107868295">
