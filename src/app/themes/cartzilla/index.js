...
export default class Index extends StorefrontLayout {
    // @ts-ignore
    constructor(args) {
        super(args);
				...
				<div class="row">
						...
						<div class="position-relative">
							...
							<div class="row justify-content-center position-relative z-2">
								<div class="col-xl-5 col-xxl-4 offset-xxl-1 d-flex align-items-center mt-xl-n3">
									...
									<div
										class="swiper px-5 pe-xl-0 ps-xxl-0 me-xl-n5 swiper-initialized swiper-horizontal swiper-backface-hidden"
										data-swiper='{
                    "spaceBetween": 64,
                    "loop": true,
                    "speed": 400,
                    ...
                    "scrollbar": {
                      "el": ".swiper-scrollbar"
										...
										<div
											...
											id="swiper-wrapper-d8b9f882207a1ff1"
											aria-live="off"
											style="transition-duration: 0ms; transform: translate3d(-836px, 0px, 0px); transition-delay: 0ms;">
											<div
												class="swiper-slide text-center text-xl-start pt-5 py-xl-5 swiper-slide-next"
												role="group"
												aria-label="3 / 3"
												data-swiper-slide-index="2"
												style="width: 354px; margin-right: 64px;">
											...
											><div
												class="swiper-slide text-center text-xl-start pt-5 py-xl-5 swiper-slide-prev"
												role="group"
												aria-label="1 / 3"
											...
											><div
												class="swiper-slide text-center text-xl-start pt-5 py-xl-5 swiper-slide-active"
												role="group"
												aria-label="2 / 3"
								...
								<div class="col-9 col-sm-7 col-md-6 col-lg-5 col-xl-7">
									...
									<div
										class="swiper user-select-none swiper-fade swiper-initialized swiper-horizontal swiper-watch-progress swiper-backface-hidden"
										id="sliderImages"
										data-swiper='{
                    ...
                    "fadeEffect": {
                      "crossFade": true
										...
										<div
											class="swiper-wrapper"
											id="swiper-wrapper-e752113312b44e87"
											aria-live="polite"
											style="transition-duration: 0ms; transition-delay: 0ms;">
											<div
												class="swiper-slide d-flex justify-content-end swiper-slide-next"
												role="group"
												aria-label="3 / 3"
												data-swiper-slide-index="2"
												style="width: 553px; opacity: 0; transform: translate3d(0px, 0px, 0px); transition-duration: 0ms;">
												<div
													class="ratio rtl-flip"
													style="max-width: 495px; --cz-aspect-ratio: calc(537 / 495 * 100%)">
													<img
														src="/themes/cartzilla/assets/img/home/electronics/hero-slider/03.png"
														alt="Image" />
												</div> </div
											><div
												class="swiper-slide d-flex justify-content-end swiper-slide-prev"
												role="group"
												aria-label="1 / 3"
												data-swiper-slide-index="0"
												style="width: 553px; opacity: 0; transform: translate3d(-553px, 0px, 0px); transition-duration: 0ms;">
												<div
													class="ratio rtl-flip"
													style="max-width: 495px; --cz-aspect-ratio: calc(537 / 495 * 100%)">
													<img
														src="/themes/cartzilla/assets/img/home/electronics/hero-slider/01.png"
														alt="Image" />
												</div> </div
											><div
												class="swiper-slide d-flex justify-content-end swiper-slide-visible swiper-slide-fully-visible swiper-slide-active"
												role="group"
												aria-label="2 / 3"
												data-swiper-slide-index="1"
												style="width: 553px; opacity: 1; transform: translate3d(-1106px, 0px, 0px); transition-duration: 0ms;">
												<div
													class="ratio rtl-flip"
													style="max-width: 495px; --cz-aspect-ratio: calc(537 / 495 * 100%)">
													<img
														src="/themes/cartzilla/assets/img/home/electronics/hero-slider/02.png"
														alt="Image" />
												</div> </div
										></div>
										<span
							...
							<div class="row justify-content-center" data-bs-theme="dark">
								<div class="col-xxl-10">
									<div class="position-relative mx-5 mx-xxl-0">
										<div class="swiper-scrollbar mb-4 swiper-scrollbar-horizontal"
											><div
												class="swiper-scrollbar-drag"
												style="transform: translate3d(275.739px, 0px, 0px); width: 233.521px; transition-duration: 0ms;"></div
										></div>
									</div>
								</div>
							</div>
			...
			<section class="container pt-5 mt-1 mt-sm-2 mt-md-3 mt-lg-4">
				...
				<div class="row">
					...
					<div class="col-lg-4" data-bs-theme="dark">
						<div
							...
							<div
								...
								<img src="/themes/cartzilla/assets/img/home/electronics/banner/laptop.png" alt="Laptop" />
							</div>
					...
					<div class="col-sm-6 col-lg-4 d-flex flex-column gap-3 pt-4 py-lg-4">
						...
						<div class="position-relative animate-underline d-flex align-items-center ps-xl-3">
							<div class="ratio ratio-1x1 flex-shrink-0" style="width: 110px">
								<img src="/themes/cartzilla/assets/img/shop/electronics/thumbs/01.png" alt="Smart Watch" />
							</div>
						...
						<div class="position-relative animate-underline d-flex align-items-center ps-xl-3">
							<div class="ratio ratio-1x1 flex-shrink-0" style="width: 110px">
								<img src="/themes/cartzilla/assets/img/shop/electronics/thumbs/03.png" width="110" alt="VR Glasses" />
							</div>
							<div class="w-100 min-w-0 ps-2 ps-sm-3">
								<div class="d-flex align-items-center gap-2 mb-2">
									<div class="d-flex gap-1 fs-xs">
						...
						<div class="position-relative animate-underline d-flex align-items-center ps-xl-3">
							<div class="ratio ratio-1x1 flex-shrink-0" style="width: 110px">
								<img
									src="/themes/cartzilla/assets/img/shop/electronics/thumbs/05.png"
									width="110"
						...
						<div class="position-relative animate-underline d-flex align-items-center ps-xl-3">
							<div class="ratio ratio-1x1 flex-shrink-0" style="width: 110px">
								<img src="/themes/cartzilla/assets/img/shop/electronics/thumbs/07.png" width="110" alt="MacBook" />
							</div>
							<div class="w-100 min-w-0 ps-2 ps-sm-3">
								<div class="d-flex align-items-center gap-2 mb-2">
									<div class="d-flex gap-1 fs-xs">
					...
					<div class="col-sm-6 col-lg-4 d-flex flex-column gap-3 pt-3 py-lg-4">
						...
						<div class="position-relative animate-underline d-flex align-items-center ps-xl-3">
							<div class="ratio ratio-1x1 flex-shrink-0" style="width: 110px">
								<img src="/themes/cartzilla/assets/img/shop/electronics/thumbs/02.png" width="110" alt="iPad Pro" />
							</div>
							<div class="w-100 min-w-0 ps-2 ps-sm-3">
								<div class="d-flex align-items-center gap-2 mb-2">
									<div class="d-flex gap-1 fs-xs">
						...
						<div class="position-relative animate-underline d-flex align-items-center ps-xl-3">
							<div class="ratio ratio-1x1 flex-shrink-0" style="width: 110px">
								<img src="/themes/cartzilla/assets/img/shop/electronics/thumbs/04.png" width="110" alt="AirPods 2 Pro" />
							</div>
							<div class="w-100 min-w-0 ps-2 ps-sm-3">
								<div class="d-flex align-items-center gap-2 mb-2">
									<div class="d-flex gap-1 fs-xs">
								...
								<h4 class="mb-2">
									<a
										class="stretched-link d-block fs-sm fw-medium text-truncate"
										href="shop-product-general-electronics.html"
										><span class="animate-target">Headphones Apple AirPods 2 Pro</span></a
									>
								</h4>
								<div class="h5 mb-0"
									>$209.99 <del class="text-body-tertiary fs-sm fw-normal">$356.00</del></div
								>
							</div>
						</div>
						...
						<div class="position-relative animate-underline d-flex align-items-center ps-xl-3">
							<div class="ratio ratio-1x1 flex-shrink-0" style="width: 110px">
								<img src="/themes/cartzilla/assets/img/shop/electronics/thumbs/06.png" width="110" alt="Power Bank" />
							</div>
							<div class="w-100 min-w-0 ps-2 ps-sm-3">
								<div class="d-flex align-items-center gap-2 mb-2">
									<div class="d-flex gap-1 fs-xs">
						...
						<div class="position-relative animate-underline d-flex align-items-center ps-xl-3">
							<div class="ratio ratio-1x1 flex-shrink-0" style="width: 110px">
								<img src="/themes/cartzilla/assets/img/shop/electronics/thumbs/08.png" width="110" alt="iPhone 14" />
							</div>
							<div class="w-100 min-w-0 ps-2 ps-sm-3">
								<div class="d-flex align-items-center gap-2 mb-2">
									<div class="d-flex gap-1 fs-xs">
								...
								<div class="h5 mb-0"
									>$899.00 <del class="text-body-tertiary fs-sm fw-normal">$958.00</del></div
								>
							</div>
						</div>
					</div>
							...
							<div class="position-relative">
								...
								<a
									...
									<div class="ratio" style="--cz-aspect-ratio: calc(240 / 258 * 100%)">
										<img src="/themes/cartzilla/assets/img/shop/electronics/01.png" alt="VR Glasses" />
									</div>
								</a>
							</div>
							<div class="w-100 min-w-0 px-1 pb-2 px-sm-3 pb-sm-3">
								...
								<div class="d-flex align-items-center justify-content-between">
									<div class="h5 lh-1 mb-0"
										>$340.99 <del class="text-body-tertiary fs-sm fw-normal">$430.00</del></div
									>
									<button
										type="button"
						...
						<div class="product-card animate-underline hover-effect-opacity bg-body rounded">
							<div class="position-relative">
								...
								<a
									...
									href="shop-product-general-electronics.html">
									<div class="ratio" style="--cz-aspect-ratio: calc(240 / 258 * 100%)">
										<img src="/themes/cartzilla/assets/img/shop/electronics/02.png" alt="iPhone 14" />
									</div>
								</a>
							</div>
							<div class="w-100 min-w-0 px-1 pb-2 px-sm-3 pb-sm-3">
						...
						<div class="product-card animate-underline hover-effect-opacity bg-body rounded">
							<div class="position-relative">
								...
								<a
									...
									href="shop-product-general-electronics.html">
									<div class="ratio" style="--cz-aspect-ratio: calc(240 / 258 * 100%)">
										<img src="/themes/cartzilla/assets/img/shop/electronics/03.png" alt="Smart Watch" />
									</div>
								</a>
							</div>
							<div class="w-100 min-w-0 px-1 pb-2 px-sm-3 pb-sm-3">
						...
						<div class="product-card animate-underline hover-effect-opacity bg-body rounded">
							<div class="position-relative">
								...
								<a
									...
									href="shop-product-general-electronics.html">
									<span
										class="badge bg-info position-absolute top-0 start-0 mt-2 ms-2 mt-lg-3 ms-lg-3"
										>New</span
									>
									<div class="ratio" style="--cz-aspect-ratio: calc(240 / 258 * 100%)">
										<img src="/themes/cartzilla/assets/img/shop/electronics/04.png" alt="MacBook" />
									</div>
								</a>
							</div>
							<div class="w-100 min-w-0 px-1 pb-2 px-sm-3 pb-sm-3">
						...
						<div class="product-card animate-underline hover-effect-opacity bg-body rounded">
							<div class="posittion-relative">
								...
								<a
									...
									href="shop-product-general-electronics.html">
									<div class="ratio" style="--cz-aspect-ratio: calc(240 / 258 * 100%)">
										<img src="/themes/cartzilla/assets/img/shop/electronics/05.png" alt="iPad Air" />
									</div>
								</a>
							</div>
							<div class="w-100 min-w-0 px-1 pb-2 px-sm-3 pb-sm-3">
						...
						<div class="product-card animate-underline hover-effect-opacity bg-body rounded">
							<div class="position-relative">
								...
								<a
									...
									href="shop-product-general-electronics.html">
									<div class="ratio" style="--cz-aspect-ratio: calc(240 / 258 * 100%)">
										<img src="/themes/cartzilla/assets/img/shop/electronics/06.png" alt="AirPods 2" />
									</div>
								</a>
							</div>
							<div class="w-100 min-w-0 px-1 pb-2 px-sm-3 pb-sm-3">
						...
						<div class="product-card animate-underline hover-effect-opacity bg-body rounded">
							<div class="posittion-relative">
								...
								<a
									...
									href="shop-product-general-electronics.html">
									<div class="ratio" style="--cz-aspect-ratio: calc(240 / 258 * 100%)">
										<img src="/themes/cartzilla/assets/img/shop/electronics/07.png" alt="iPad Pro" />
									</div>
								</a>
							</div>
							<div class="w-100 min-w-0 px-1 pb-2 px-sm-3 pb-sm-3">
						...
						<div class="product-card animate-underline hover-effect-opacity bg-body rounded">
							<div class="posittion-relative">
								...
								<a
									...
									href="shop-product-general-electronics.html">
									<div class="ratio" style="--cz-aspect-ratio: calc(240 / 258 * 100%)">
										<img src="/themes/cartzilla/assets/img/shop/electronics/08.png" alt="Bluetooth Headphones" />
									</div>
								</a>
							</div>
							<div class="w-100 min-w-0 px-1 pb-2 px-sm-3 pb-sm-3">
						...
						<div class="position-relative">
							...
							<div class="row align-items-center position-relative z-2">
								...
								<div class="col-md-6 d-flex justify-content-center justify-content-md-end pb-5 pb-md-0">
									<div class="me-xxl-4">
										<img
											src="/themes/cartzilla/assets/img/home/electronics/banner/camera.png"
			...
			<section class="container pt-5 mt-2 mt-sm-3 mt-lg-4">
				...
				<div class="position-relative mx-md-1">
					...
					<button
						...
						tabindex="0"
						aria-controls="swiper-wrapper-2ad2aacdf6d3310a4">
					...
					<!-- Slider -->
					<div
						class="swiper py-4 px-sm-3 swiper-initialized swiper-horizontal swiper-backface-hidden"
						data-swiper='{
            "slidesPerView": 2,
            "spaceBetween": 24,
            "loop": true,
            ...
            "breakpoints": {
              ...
              "992": {
                "slidesPerView": 4
						...
						<div class="swiper-wrapper" id="swiper-wrapper-2ad2aacdf6d3310a4" aria-live="polite">
							<!-- Item -->
							<div
								...
								<div class="product-card animate-underline hover-effect-opacity bg-body rounded">
									<div class="position-relative">
										...
										<a
											...
											href="shop-product-general-electronics.html">
											<div class="ratio" style="--cz-aspect-ratio: calc(240 / 258 * 100%)">
												<img src="/themes/cartzilla/assets/img/shop/electronics/09.png" alt="Wireless Buds" />
											</div>
										</a>
									</div>
									<div class="w-100 min-w-0 px-1 pb-2 px-sm-3 pb-sm-3">
										...
										<div class="d-flex align-items-center justify-content-between pb-2 mb-1">
											<div class="h5 lh-1 mb-0"
												>$129.99
												<del class="text-body-tertiary fs-sm fw-normal">$156.00</del></div
											>
											<button
												type="button"
												class="product-card-button btn btn-icon btn-secondary animate-slide-end ms-2"
										...
										<div class="text-body-secondary fs-sm"
											>Available: <span class="text-dark-emphasis fw-medium">112</span></div
										>
									</div>
								</div>
							</div>
								...
								<div class="product-card animate-underline hover-effect-opacity bg-body rounded">
									...
									<div class="w-100 min-w-0 px-1 pb-2 px-sm-3 pb-sm-3">
										...
										<div class="d-flex align-items-center justify-content-between pb-2 mb-1">
											<div class="h5 lh-1 mb-0"
												>$429.00
												<del class="text-body-tertiary fs-sm fw-normal">$486.00</del></div
											>
											<button
												type="button"
												class="product-card-button btn btn-icon btn-secondary animate-slide-end ms-2"
										...
										<div class="text-body-secondary fs-sm"
											>Available: <span class="text-dark-emphasis fw-medium">45</span></div
										>
									</div>
								</div>
							</div>
								...
								<div class="product-card animate-underline hover-effect-opacity bg-body rounded">
									<div class="position-relative">
										...
										<a
											...
											href="shop-product-general-electronics.html">
											<div class="ratio" style="--cz-aspect-ratio: calc(240 / 258 * 100%)">
												<img src="/themes/cartzilla/assets/img/shop/electronics/11.png" alt="Nikon Camera" />
											</div>
										</a>
									</div>
									<div class="w-100 min-w-0 px-1 pb-2 px-sm-3 pb-sm-3">
										...
										<div class="d-flex align-items-center justify-content-between pb-2 mb-1">
											<div class="h5 lh-1 mb-0"
												>$652.00
												<del class="text-body-tertiary fs-sm fw-normal">$785.00</del></div
											>
											<button
												type="button"
												class="product-card-button btn btn-icon btn-secondary animate-slide-end ms-2"
										...
										<div class="text-body-secondary fs-sm"
											>Available: <span class="text-dark-emphasis fw-medium">13</span></div
										>
									</div>
								</div>
							</div>
								...
								<div class="product-card animate-underline hover-effect-opacity bg-body rounded">
									<div class="position-relative">
										...
										<a
											...
											href="shop-product-general-electronics.html">
											<div class="ratio" style="--cz-aspect-ratio: calc(240 / 258 * 100%)">
												<img src="/themes/cartzilla/assets/img/shop/electronics/10.png" alt="iPhone 14" />
											</div>
										</a>
									</div>
									<div class="w-100 min-w-0 px-1 pb-2 px-sm-3 pb-sm-3">
										...
										<div class="text-body-secondary fs-sm"
											>Available: <span class="text-dark-emphasis fw-medium">7</span></div
										>
									</div>
								</div>
							</div>
								...
								<div class="product-card animate-underline hover-effect-opacity bg-body rounded">
									...
									<div class="w-100 min-w-0 px-1 pb-2 px-sm-3 pb-sm-3">
										...
										<div class="d-flex align-items-center justify-content-between pb-2 mb-1">
											<div class="h5 lh-1 mb-0"
												>$340.99
												<del class="text-body-tertiary fs-sm fw-normal">$430.00</del></div
											>
											<button
												type="button"
												class="product-card-button btn btn-icon btn-secondary animate-slide-end ms-2"
										...
										<div class="text-body-secondary fs-sm"
											>Available: <span class="text-dark-emphasis fw-medium">16</span></div
										>
									</div>
								</div>
							</div>
				...
				<div class="row row-cols-2 row-cols-sm-3 row-cols-md-4 row-cols-lg-6 g-3 g-md-4 g-lg-3 g-xl-4">
					<div class="col">
						<a class="btn btn-outline-secondary w-100 rounded-4 p-3" href="shop-catalog-electronics.html">
							<img
								src="/themes/cartzilla/assets/img/shop/electronics/brands/apple-light-mode.svg"
								class="d-none-dark"
								alt="Apple" />
							<img
								src="/themes/cartzilla/assets/img/shop/electronics/brands/apple-dark-mode.svg"
					...
					<div class="col">
						<a class="btn btn-outline-secondary w-100 rounded-4 p-3" href="shop-catalog-electronics.html">
							<img
								src="/themes/cartzilla/assets/img/shop/electronics/brands/motorola-light-mode.svg"
								class="d-none-dark"
								alt="Apple" />
							<img
								src="/themes/cartzilla/assets/img/shop/electronics/brands/motorola-dark-mode.svg"
								class="d-none d-block-dark"
								alt="Apple" />
						</a>
					</div>
					<div class="col">
						<a class="btn btn-outline-secondary w-100 rounded-4 p-3" href="shop-catalog-electronics.html">
							<img
								src="/themes/cartzilla/assets/img/shop/electronics/brands/canon-light-mode.svg"
								class="d-none-dark"
								alt="Apple" />
							<img
								src="/themes/cartzilla/assets/img/shop/electronics/brands/canon-dark-mode.svg"
								class="d-none d-block-dark"
								alt="Apple" />
						</a>
					</div>
					<div class="col">
						<a class="btn btn-outline-secondary w-100 rounded-4 p-3" href="shop-catalog-electronics.html">
							<img
								src="/themes/cartzilla/assets/img/shop/electronics/brands/samsung-light-mode.svg"
								class="d-none-dark"
								alt="Apple" />
							<img
								src="/themes/cartzilla/assets/img/shop/electronics/brands/samsung-dark-mode.svg"
								class="d-none d-block-dark"
								alt="Apple" />
						</a>
					</div>
					<div class="col">
						<a class="btn btn-outline-secondary w-100 rounded-4 p-3" href="shop-catalog-electronics.html">
							<img
								src="/themes/cartzilla/assets/img/shop/electronics/brands/sony-light-mode.svg"
								class="d-none-dark"
								alt="Apple" />
							<img
								src="/themes/cartzilla/assets/img/shop/electronics/brands/sony-dark-mode.svg"
								class="d-none d-block-dark"
								alt="Apple" />
						</a>
					</div>
						...
						<div class="col-md-6 col-lg-5 col-xl-4 offset-lg-1 offset-xl-2">
							<ul class="list-unstyled d-flex flex-column gap-4 ps-md-4 ps-lg-0 mb-3">
								<li class="nav flex-nowrap align-items-center position-relative">
									<img
										src="/themes/cartzilla/assets/img/home/electronics/vlog/01.jpg"
										class="rounded"
										width="140"
										alt="Video cover" />
									<div class="ps-3">
										...
										<a class="nav-link fs-sm hover-effect-underline stretched-link p-0" href="#!"
											>5 New Cool Gadgets You Must See on Cartzilla - Cheap Budget</a
										>
									</div>
								</li>
								<li class="nav flex-nowrap align-items-center position-relative">
									<img
										src="/themes/cartzilla/assets/img/home/electronics/vlog/02.jpg"
										class="rounded"
										width="140"
										alt="Video cover" />
									<div class="ps-3">
										...
										<a class="nav-link fs-sm hover-effect-underline stretched-link p-0" href="#!"
											>5 Super Useful Gadgets on Cartzilla You Must Have in 2023</a
										>
									</div>
								</li>
								<li class="nav flex-nowrap align-items-center position-relative">
									<img
										src="/themes/cartzilla/assets/img/home/electronics/vlog/03.jpg"
										class="rounded"
										width="140"
										alt="Video cover" />
									<div class="ps-3">
