            ...
            backOfficeTheme :{   
                ...
                container: {
                    controllers: {
                        apiController: {
                            class: "ApiController",
                            module: import("paykhom-fw/app/theme/back-office/controller/api-controller"),
                            config: {
                                ctor:{}
                            }
                        },
                        storefrontBackendController: {
                            class: "StorefrontBackendController",
                            module: import("paykhom-fw/app/theme/back-office/controller/storefront-backend-controller"),
                            config: {
                                ctor:{}
                            }
                        },
