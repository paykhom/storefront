...
export class StorefrontController extends Controller {
    ...
    async $onGetIndex(c: Context): Promise<Response> {
        ...
        try {
            ...
            return await this.$render(c, import('../../theme/storefront-theme/view/index'), {
                test: { a: "b" },
                cat: cat,
                products: products,
                attribs: attribs,
    ...
    private async $searchProductVariants(c: Context, src: string /*, slug: string, extra: string | undefined*/) {
        ...
        try {
            ...
            if (request.method === 'GET') {
                return await this.$render(c, import('../../theme/storefront-theme/view/product-variant-search'), {
                    src: "category",
                    attribs: attribs,
                    products: products,
    ...
    async $viewProduct(c: Context): Promise<Response> {
        ...
        try {
            ...
            return await this.$render(c, import('../../theme/storefront-theme/view/product-single'), { meta: { title: "Paykhom Platform" } });
    ...
    async $viewProductVariant(c: Context): Promise<Response> {
        ...
        try {
            ...
            return await this.$render(c, import('../../theme/storefront-theme/view/product-variant-single'), { product: ret_data, meta: { title: "Paykhom Platform" } });
    ...
    async $onGetCategoryPaginator(c: Context): Promise<Response> {
        ...
        try {
            ...
            return await this.$render(c, import('../../theme/storefront-theme/view/category-all'), { test: { a: "b" }, cat: cat, paginationHtml: htmlPagination, meta: { title: "Paykhom Platform" } });
    ...
    async $paginateBrands(c: Context): Promise<Response> {
        ...
        try {
            ...
            return await this.$render(c, import('../../theme/storefront-theme/view/brand-all'), { test: { a: "b" }, brand: brand, paginationHtml: htmlPagination, meta: { title: "Paykhom Platform" } });
    ...
    async $onGetInfoCompany(c: Context): Promise<Response> {
      return await this.$render(c, import('../../theme/storefront-theme/view/info/company'), { meta: { title: 'Dashboard' } });
    }
  
    async $onGetInfoCareer(c: Context): Promise<Response> {
      return await this.$render(c, import('../../theme/storefront-theme/view/info/career'), { meta: { title: 'Dashboard' } });
    }
  
    async $onGetInfoAbout(c: Context): Promise<Response> {
      return await this.$render(c, import('../../theme/storefront-theme/view/info/about'), { meta: { title: 'Dashboard' } });
    }
  
    async $onGetInfoHelp(c: Context): Promise<Response> {
      return await this.$render(c, import('../../theme/storefront-theme/view/info/help'), { meta: { title: 'Dashboard' } });
    }
  
    async $onGetInfoValue(c: Context): Promise<Response> {
      return await this.$render(c, import('../../theme/storefront-theme/view/info/value'), { meta: { title: 'Dashboard' } });
    }
  
    async $onGetInfoPayment(c: Context): Promise<Response> {
      return await this.$render(c, import('../../theme/storefront-theme/view/info/payment'), { meta: { title: 'Dashboard' } });
    }
  
    async $onGetInfoShipping(c: Context): Promise<Response> {
      return await this.$render(c, import('../../theme/storefront-theme/view/info/shipping'), { meta: { title: 'Dashboard' } });
    }
  
    async $onGetInfoReturn(c: Context): Promise<Response> {
      return await this.$render(c, import('../../theme/storefront-theme/view/info/returns'), { meta: { title: 'Dashboard' } });
    }
  
    async $onGetInfoFaq(c: Context): Promise<Response> {
      return await this.$render(c, import('../../theme/storefront-theme/view/info/faq'), { meta: { title: 'Dashboard' } });
    }
  
    async $onGetInfoCheckout(c: Context): Promise<Response> {
      return await this.$render(c, import('../../theme/storefront-theme/view/info/checkout'), { meta: { title: 'Dashboard' } });
    }
  
    async $onGetInfoOpportunity(c: Context): Promise<Response> {
      return await this.$render(c, import('../../theme/storefront-theme/view/info/opportunity'), { meta: { title: 'Dashboard' } });
    }
  
    async $onGetInfoEntrepreneur(c: Context): Promise<Response> {
      return await this.$render(c, import('../../theme/storefront-theme/view/info/entrepreneur'), { meta: { title: 'Dashboard' } });
    }
  
    async $onGetInfoEarning(c: Context): Promise<Response> {
      return await this.$render(c, import('../../theme/storefront-theme/view/info/earning'), { meta: { title: 'Dashboard' } });
    }
  
    async $onGetInfoIdea(c: Context): Promise<Response> {
      return await this.$render(c, import('../../theme/storefront-theme/view/info/idea'), { meta: { title: 'Dashboard' } });
    }
  
    async $onGetInfoRetailer(c: Context): Promise<Response> {
      return await this.$render(c, import('../../theme/storefront-theme/view/info/retailer'), { meta: { title: 'Dashboard' } });
    }
  
    async $onGetInfoGiftCard(c: Context): Promise<Response> {
      return await this.$render(c, import('../../theme/storefront-theme/view/info/gift-card'), { meta: { title: 'Dashboard' } });
    }
  
    async $onGetInfoPromo(c: Context): Promise<Response> {
      return await this.$render(c, import('../../theme/storefront-theme/view/info/promo'), { meta: { title: 'Dashboard' } });
    }
  
    async $onGetInfoAd(c: Context): Promise<Response> {
      return await this.$render(c, import('../../theme/storefront-theme/view/info/ad'), { meta: { title: 'Dashboard' } });
    }
  
    async $onGetInfoContact(c: Context): Promise<Response> {
      return await this.$render(c, import('../../theme/storefront-theme/view/info/contact'), { meta: { title: 'Dashboard' } });
    }
    ...
    async $onPostShowCart(c: Context): Promise<Response> {
      return await this.$render(c, import("cart" /* not created yet */), {});
    }
