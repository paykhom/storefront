...
`
  ...
  //foreach ($product["product_variant_detail"]??[] as $item) {
    for (var i = 0; i < product["variant_detail"].length; i++) {
        var item = product["variant_detail"][i];
...
yield html`
                                       ...
                                       <div class="d-flex justify-content-between align-items-center mt-3">
                                          ...
                                          <div>
                                             <a href="#!" class="btn btn-primary btn-sm pvs-btn-add-to-cart" data-product-variant-id="${product['product_variant_detail']}" data-product-price="${product['price']}" data-product-title="${product['title']}" data-product-media-path="/theme/freshcart/assets/images/product-single-img-1.jpg" data-product-link-product-slug="${product['slug']}" data-product-list-price="${product["list_price"]}">
