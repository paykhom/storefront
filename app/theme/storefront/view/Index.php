...
use App\Views\MarketplaceLayout;


class Index extends MarketplaceLayout {
    ...
    <!-- </div> -->
         ...
         <section class="mb-lg-14 mb-8 xd-none for-the-time-being">
            <div class="container-fluid">
               ...
               <div id="productViewContainer" class="<?= true ? "row g-4 row-cols-xl-4 row-cols-lg-3 row-cols-2 row-cols-md-2 mt-2 product-view-container": "row g-4 row-cols-1 mt-2 product-view-container"; ?>">
...
?>
                                       ...
                                       <div class="d-flex justify-content-between align-items-center mt-3">
                                          ...
                                          <div>
                                             <a href="#!" class="btn btn-primary btn-sm pvs-btn-add-to-cart" data-product-variant-id="<?= $product["product_variant_id"] ?>" data-product-price="<?= $product["price"] ?>" data-product-title="<?= $product["title"] ?>" data-product-media-path="/theme/freshcart/assets/images/product-single-img-1.jpg" data-product-link-product-slug="<?= $product["slug"] ?>" data-product-list-price="<?= $product["list_price"] ?>">
