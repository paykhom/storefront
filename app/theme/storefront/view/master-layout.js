                    ...
                    <div class="sidebar-inner slimscroll">
                        <div id="sidebar-menu" class="sidebar-menu">
                            <ul>
                                ...
                                ${this.renderAllPluginMenus(this.menus)}
...
`;
    ...
    renderAllPluginMenus(menus) {
        let html = ""
        for (const menu of menus) {
            html += this.renderPluginMenus(menu)
            
        }
        return html;
    }
    
    renderPluginMenus(menu) {
            ...
            html += `
                <li class="submenu xd-none">
                    ...
                    <ul style="display: block;">
                        ${menu.children.map(child => this.renderPluginMenus(child)).join('')}
                    </ul>
                </li>
            `;
        } else {
