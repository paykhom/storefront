...
export default class AttribGroupPaginator extends SaasLayout {
        ...
        <div class="page-header">
            <div class="add-item d-flex">
                <div class="page-title">
                    ...
                    <h6>Manage your attribute groups</h6>
                </div>
            </div>
            ...
            async uponReady() {
                ...
                let table = new DataTable(
                    '#myDataTable',
                    {
                        ...
                        ajax: '/api/dtx/ecom/attrib_group/search',
                        processing: false,
                        serverSide: true,
                        pageLength: 25,
                        columns: [
								...
								render: function (data, type, row) {
									return ~
										<div class="edit-delete-action">
											...
											<a class="me-2 p-2" href="/saas/catalog/attrib-group/editor/~{row.attrib_group_id}">
