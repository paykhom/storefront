...
export default class DepartmentPaginator extends SaasLayout {
            ...
            async uponReady() {
                ...
                let table = new DataTable(
                    '#myDataTable',
                    {
                        ...
                        ajax: '/api/dtx/ecom/department/search',
                        processing: false,
                        serverSide: true,
                        pageLength: 25,
                         columns: [
                            ...
                            { data: 'meta_title', title: "Meta Title" },
                            { data: 'meta_description', title: "Meta Description"},
                            {
                                ...
                                render: function (data, type, row) {
                                    return ~
                                        <div class="edit-delete-action">
                                            ...
                                            <a class="me-2 p-2" href="/saas/catalog/department/editor/~{row.department_id}">
