...
export default class CategoryPaginator extends SaasLayout {
                    ...
                    '#myDataTable',
                    {
                        ...
                        pageLength: 25,
                         columns: [
                            ...
                            //{ data: 'base_category_conversion_factor', title: "Conversion Factor", render: $.fn.dataTable.render.number(',', '.', 4) },
                            //{ data: 'base_category_id', title: "Base Category ID" },
                            {
								...
								render: function (data, type, row) {
									return ~
										<div class="edit-delete-action">
											...
											<a class="me-2 p-2" href="/saas/catalog/category/editor/~{row.category_id}">
