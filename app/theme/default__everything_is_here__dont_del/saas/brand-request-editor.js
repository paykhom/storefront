...
export default class BrandRequestEditor extends SaasLayout {
...
yield html`
    ...
    class Page extends SaasLayout {
        ...
        async uponReady() {
			...
			await this.loadEditor(~/api/dbx/ecom/brand/load_editor~, { publication_status_id:4 });
