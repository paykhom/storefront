...
export default class AttribGroupEditor extends SaasLayout {
...
yield html`
    ...
    <input type="hidden" data-state="attrib_group_id" />
</form>
					<!-- /form -->
...
yield html`
    ...
    class Page extends SaasLayout {
        ...
        async uponReady() {
			...
			await this.loadEditor(~/api/dbx/ecom/attrib_group/load_editor~, {});
