...
export default class DropshipPaginator extends SaasLayout {
					...
					<div class="page-header">
						<div class="add-item d-flex">
							<div class="page-title">
								<h4>Dropship Stores</h4>
								<h6>Manage your shops</h6>
							</div>
						</div>
			...
			async uponReady() {
				...
				let table = new DataTable(
					'#myDataTable',
					{
						...
						xsDom: 'fBtlpi',
						xordering: true,
                        order: [[1, 'asc']],  // Sort by the second column (shop_id) ascending
						xinitComplete: (settings, json)=>{
							$('.dataTables_filter').appendTo('#tableSearch');
							$('.dataTables_filter').appendTo('.search-input');
						},
						ajax: '/api/dtx/ecom/shop/search',
						processing: true,
						serverSide: true,
						pageLength: 25,
						columns: [
								...
								render: function (data, type, row) {
									return ~
										<div class="edit-delete-action">
											...
											<a class="me-2 p-2" href="/saas/catalog/dropship/editor/~{row.shop_id}">
