...
export default class CurrencyEditor extends SaasLayout {
...
yield html`
                        ...
                        <div class="accordion-button" data-bs-toggle="collapse" data-bs-target="#collapseOne"
                            ...
                            <div class="addproduct-icon">
                                <h5><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    ...
                                    </svg><span>Currency Information</span></h5>
                           ...
                           <div class="row">
                            ...
                            <div class="row">
                             ...
                             <div class="row">
                                <div class="col-lg-6 col-sm-6 col-12">
                                    <div class="mb-3 add-product">
                                        <label class="form-label">Base Currency ID</label>
                                        <input type="text" class="form-control" data-state="base_currency_id">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-sm-6 col-12">
                                    <div class="mb-3 add-product">
                                       <label class="form-label">Base Currency Conversion Factor</label>
                                         <input type="number" class="form-control" data-state="base_currency_conversion_factor" value="0">
                                   </div>
                                </div>
                           </div>
                        </div>
    ...
    <input type="hidden" data-state="currency_id" />
</form>
					<!-- /form -->
...
<script>
    class Page extends SaasLayout {
        ...
        async uponReady() 
        {
            ...
            await this.loadEditor(~/api/dbx/ecom/currency/load_editor~, {});
