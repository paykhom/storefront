...
export default class CurrencyPaginator extends SaasLayout {
            ...
            async uponReady() {
                ...
                let table = new DataTable(
                    '#myDataTable',
                    {
                        ...
                        ajax: '/api/dtx/ecom/currency/search',
                        processing: false,
                        serverSide: true,
                        pageLength: 25,
                         columns: [
                            ...
                            { data: 'base_currency_conversion_factor', title: "Conversion Factor", render: $.fn.dataTable.render.number(',', '.', 4) },
                            { data: 'base_currency_id', title: "Base Currency ID" },
                            {
								...
								render: function (data, type, row) {
									return ~
										<div class="edit-delete-action">
											...
											<a class="me-2 p-2" href="/saas/catalog/currency/editor/~{row.currency_id}">
