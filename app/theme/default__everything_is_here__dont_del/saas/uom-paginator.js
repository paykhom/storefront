...
export default class UomPaginator extends SaasLayout {
                                    ...
                                    render: function (data, type, row) {
                                        return ~
											<div class="edit-delete-action">
												...
												<a class="me-2 p-2" href="/saas/catalog/uom/editor/~{row.uom_id}">
