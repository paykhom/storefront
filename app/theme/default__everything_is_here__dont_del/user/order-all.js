...
`; foreach(this.so as $o) { yield html`
                                    ...
                                    <td class="align-middle border-top-0">`$o["sales_order_status_title"] `</td>
                                    <!-- <td class="align-middle border-top-0">
                                       <span class="badge bg-warning">Processing</span>
                                    </td> -->
                                    <td class="align-middle border-top-0 text-end">`$o["total"] `</td>
                                    <td class="text-muted align-middle border-top-0">
                                       <a href="/user/shopping/order/`$o["sales_order_id"] `" class="text-inherit" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="View"><i class="feather-icon icon-eye"></i></a>
                                    </td>
                                 </tr>
`; } `
                              </tbody>
