...
export default class BuyEditor extends UserLayout {
...
yield html`
    ...
    <div class="card">
                        ...
                        <div class="accordion-button" data-bs-toggle="collapse" data-bs-target="#collapseOne"
                            ...
                            <div class="addproduct-icon">
                                <h5><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    ...
                                    </svg><span>Buy Information</span></h5>
                    ...
                    <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                        ...
                        <div class="accordion-body">
                            ...
                            <div class="row">
                                 <div class="col-lg-3 col-sm-6 col-12">
                                     <div class="mb-3 add-product">
                                         <label class="form-label">Buy Status ID</label>
                                         <input type="text" class="form-control" data-state="buy_status_id" required>
                                    </div>
                                </div>
                                  <div class="col-lg-3 col-sm-6 col-12">
                                    <div class="mb-3 add-product">
                                 ...
                                 <div class="col-lg-3 col-sm-6 col-12">
                                     <div class="mb-3 add-product">
                                        <label class="form-label">Buy Type ID</label>
                                          <input type="text" class="form-control" data-state="buy_type_id" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
     ...
     <input type="hidden" data-state="buy_id" />
</form>
					<!-- /form -->
...
<script>
    class Page extends UserLayout {
        ...
        async uponReady() {
			...
			await this.loadEditor(~/api/dbx/ecom/buy/load_editor~, {});
		}
    }
    page = new Page();
</script>
