...
export default class RfqInPaginator extends AdminLayout {
					...
					<div class="page-header">
						<div class="add-item d-flex">
							<div class="page-title">
								<h4>Requests for Quote - Inward</h4>
								...
								render: function (data, type, row) {
									return ~
										<div class="edit-delete-action">
											<a class="me-2 edit-icon  p-2" href="/admin/sales/rfq/editor/~{row.rfq_id}">
