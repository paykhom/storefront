...
export default class PurchaseWarrantyClaimEditor extends AdminLayout {
...
yield html`
                        ...
                        <div class="accordion-button" data-bs-toggle="collapse" data-bs-target="#collapseOne"
                            ...
                            <div class="addproduct-icon">
                                <h5><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    ...
                                    </svg><span>Warranty Claim Information</span></h5>
                            ...
                            <div class="row">
                                  <div class="col-lg-6 col-sm-6 col-12">
                                        <div class="mb-3 add-product">
                                            ...
                                            <input type="number" class="form-control" data-state="customer_id" required>
                                        </div>
                                  </div>
                                <div class="col-lg-6 col-sm-6 col-12">
                                    <div class="mb-3 add-product">
                                       <label class="form-label">Order ID</label>
                                        <input type="number" class="form-control" data-state="order_id">
                                     </div>
                                </div>
                           </div>
                                ...
                                <div class="col-lg-6 col-sm-6 col-12">
                                      <div class="mb-3 add-product">
                                        <label class="form-label">Product ID</label>
                                         <input type="number" class="form-control" data-state="product_id" required>
                                     </div>
                                 </div>
                                <div class="col-lg-6 col-sm-6 col-12">
                                    <div class="mb-3 add-product">
                                         <label class="form-label">Purchase Date</label>
                                          <div class="input-groupicon calender-input">
                                                ...
                                                <input type="text" class="datetimepicker" placeholder="Choose Date" data-state="purchase_date">
                                            </div>
                                    </div>
                                </div>
                             </div>
                                       ...
                                       <div class="mb-3 add-product">
                                           <label class="form-label">Claim Date</label>
                                            <div class="input-groupicon calender-input">
                                                ...
                                                <input type="text" class="datetimepicker" placeholder="Choose Date" data-state="claim_date" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-sm-6 col-12">
                                       <div class="mb-3 add-product">
                                           <label class="form-label">Claim Status ID</label>
                                             <input type="number" class="form-control" data-state="claim_status_id">
                                       </div>
                                   </div>
                              </div>
                             <div class="row">
                                <div class="col-lg-6 col-sm-6 col-12">
                                     <div class="mb-3 add-product">
                                          <label class="form-label">Rejection Reason</label>
                                            <textarea class="form-control" rows="3" data-state="rejection_reason"></textarea>
                                       </div>
                                 </div>
                                <div class="col-lg-6 col-sm-6 col-12">
                                        <div class="mb-3 add-product">
                                          <label class="form-label">Repaired Date</label>
                                           <div class="input-groupicon calender-input">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                                 ...
                                                 <input type="text" class="datetimepicker" placeholder="Choose Date" data-state="repaired_date">
                                            </div>
                                       </div>
                                   </div>
                             </div>
                                       ...
                                       <div class="mb-3 add-product">
                                         <label class="form-label">Replacement Date</label>
                                          <div class="input-groupicon calender-input">
                                                ...
                                                <input type="text" class="datetimepicker" placeholder="Choose Date" data-state="replacement_date">
                                            </div>
                                        </div>
                                  </div>
                                  <div class="col-lg-6 col-sm-6 col-12">
                                      <div class="mb-3 add-product">
                                          <label class="form-label">Replacement Product ID</label>
                                         <input type="number" class="form-control" data-state="replacement_product_id">
                                      </div>
                                 </div>
                             </div>
                            <div class="row">
                            ...
                            <div class="row">
                                 <div class="col-lg-12 col-sm-12 col-12">
                                    <div class="mb-3 add-product">
                                        ...
                                        <textarea class="form-control" rows="5" data-state="issue_description"></textarea>
                                   </div>
                                </div>
                            </div>
                             <div class="row">
                                 <div class="col-lg-12 col-sm-12 col-12">
                                    <div class="mb-3 add-product">
                                        <label class="form-label">Notes</label>
                                         <textarea class="form-control" rows="5" data-state="notes"></textarea>
                                    </div>
                                </div>
                             </div>
                        </div>
   ...
   <div class="col-lg-12">
     ...
     <input type="hidden" data-state="purchase_warranty_claim_id"/>
</form>
					<!-- /form -->
...
yield html`
    ...
    class Page extends AdminLayout {
        ...
        async uponReady() {
			...
			await this.loadEditor(~/api/dbx/ecom/purchase_warranty_claim/load_editor~, {});
		}
    }
    page = new Page();
</script>
