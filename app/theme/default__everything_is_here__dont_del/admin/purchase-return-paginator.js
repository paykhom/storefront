...
export default class PurchaseReturnPaginator extends AdminLayout {
                    ...
                    let table = new DataTable(
                        '#myDataTable',
                        {
                           xbFilter: true,
                            ...
                            ajax: '/api/dtx/ecom/purchase_return/search',
                            processing: false,
                            serverSide: true,
                            pageLength: 25,
                            columns: [
                                ...
                                { data: 'purchase_return_id', title: "Return ID" },
                                {
                                    data: 'return_date',
                                    title: "Return Date",
                                ...
                                { data: 'purchase_id', title: "Purchase ID" },
                                    ...
                                    render: function (data, type, row) {
                                        return ~
											<div class="edit-delete-action">
												...
												<a class="me-2 p-2" href="/admin/purchase/return/editor/~{row.purchase_return_id}">
