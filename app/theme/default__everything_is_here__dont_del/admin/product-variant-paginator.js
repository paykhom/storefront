...
export default class ProductVariantPaginator extends AdminLayout {
        ...
        <div class="page-header">
            <div class="add-item d-flex">
                <div class="page-title">
                    ...
                    <h6>Manage your product variants</h6>
                </div>
            </div>
            ...
            async uponReady() {
                ...
                let table = new DataTable(
                    '#myDataTable',
                    {
                        ...
                        ajax: '/api/dtx/ecom/product_variant/search',
                        processing: false,
                        serverSide: true,
                        pageLength: 25,
                       columns: [
                            ...
                            },
                             {
								...
								data: 'title',
								/* PENDING render: function (data, type, row) {
									return ~
                            ...
                            { data: 'product_variant_id', title: "ID" },
                            { data: 'product_id', title: "Product ID" },
                            //{ data: 'sku', title: "SKU" },
                            //{ data: 'cost', title: "Cost" , render: $.fn.dataTable.render.number(',', '.', 2)},
                            { data: 'list_price', title: "List Price" , render: $.fn.dataTable.render.number(',', '.', 2)},
                            ...
                            { data: 'discount_per', title: "Discount %" , render: $.fn.dataTable.render.number(',', '.', 2) },
                            //  {
							...
							// 					<img  loading="lazy" data-src="~{'/db/ecom/saas/user/~{data}/logo-image'}" alt="user">
							// 				</a>
							// 				<a href="javascript:void(0);">~{data}</a>
							// 			</div>
							// 		~;
                                ...
                                render: function (data, type, row) {
                                    return ~
                                        <div class="edit-delete-action">
                                            ...
                                            <a class="me-2 p-2" href="/admin/catalog/product-variant/editor/~{row.product_variant_id}">
