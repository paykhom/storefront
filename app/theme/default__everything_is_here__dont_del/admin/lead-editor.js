...
export default class LeadEditor extends AdminLayout {
...
yield html`
                        ...
                        <div class="accordion-button" data-bs-toggle="collapse" data-bs-target="#collapseOne"
                            ...
                            <div class="addproduct-icon">
                                <h5><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    ...
                                    </svg><span>Lead Information</span></h5>
    ...
    <input type="hidden" data-state="lead_id"/>
</form>
					<!-- /form -->
...
<script>
    class Page extends AdminLayout {
        ...
        async uponReady() {
			...
			await this.loadEditor(~/api/dbx/ecom/lead/load_editor~, {});
		}
    }
    page = new Page();
</script>
