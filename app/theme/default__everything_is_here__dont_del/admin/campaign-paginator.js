...
export default class CampaignPaginator extends AdminLayout {
								...
								render: function (data, type, row) {
									return ~
										<div class="edit-delete-action">
											<a class="me-2 edit-icon  p-2" href="/admin/marketing/campaign/editor/~{row.campaign_id}">
                ...
                if(confirm("Are you sure you want to delete this discount?")) {
                   let r = await (await fetch(~/ecom/discount/delete/~{id}~, {method: 'DELETE'})).json();
                    if(r.success) {
                       ...
                       alert("Campaign could not be deleted.");
                    }
                }
			}			
		}
