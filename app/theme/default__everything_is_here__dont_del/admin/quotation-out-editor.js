...
export default class QuotationOutEditor extends AdminLayout {
...
yield html`
                        ...
                        <div class="accordion-button" data-bs-toggle="collapse" data-bs-target="#collapseOne"
                            ...
                            <div class="addproduct-icon">
                                <h5><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    ...
                                    </svg><span>Quotation Information</span></h5>
                        ...
                        <div class="accordion-body">
                             ...
                             <div class="row">
                                  <div class="col-lg-6 col-sm-6 col-12">
                                    ...
                                    <div class="col-lg-6 col-sm-6 col-12">
                                       <div class="mb-3 add-product">
                                          <label class="form-label">Quotation Type ID</label>
                                         <input type="number" class="form-control" data-state="xquotation_type_id">
                                        </div>
                                   </div>
                             </div>
    ...
    <div class="col-lg-12">
       ...
       <input type="hidden" data-state="quotation_id"/>
</form>
					<!-- /form -->
