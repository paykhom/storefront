...
export default class StockLocationEditor extends AdminLayout {
...
yield html`
					...
					<!-- form -->
					<form action="add-stock-location.html">
    <div class="card">
                        ...
                        <div class="accordion-button" data-bs-toggle="collapse" data-bs-target="#collapseOne"
                            ...
                            <div class="addproduct-icon">
                                <h5><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    ...
                                    </svg><span>Stock Location Information</span></h5>
      ...
      <input type="hidden" data-state="stock_location_id"/>
</form>
					<!-- /form -->
...
<script>
    class Page extends AdminLayout {
        ...
        async uponReady() {
			...
			await this.loadEditor(~/api/dbx/ecom/stock_location/load_editor~, {});
		}
    }
    page = new Page();
</script>
