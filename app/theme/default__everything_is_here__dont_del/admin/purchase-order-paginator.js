...
export default class PurchaseOrderPaginator extends AdminLayout {
                ...
                async uponReady() {
                    ...
                    let table = new DataTable(
                        '#myDataTable',
                        {
                            ...
                            ajax: '/api/dtx/ecom/purchase_order/search',
                            processing: false,
                            serverSide: true,
                            pageLength: 25,
                            columns: [
                                ...
                                { data: 'purchase_order_id', title: "Order ID" },
                                 {
                                    ...
                                    render: function (data, type, row) {
                                        return ~
											<div class="edit-delete-action">
												...
												<a class="me-2 p-2" href="/admin/purchase/order/editor/~{row.purchase_order_id}">
