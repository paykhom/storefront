...
export default class QuotationInPaginator extends AdminLayout {
		...
		class Page extends AdminLayout {
								...
								render: function (data, type, row) {
									return ~
										<div class="edit-delete-action">
											<a class="me-2 edit-icon  p-2" href="/admin/purchase/quotation/editor/~{row.quotation_id}">
			...
			async onClickDeleteRow(e, id) {
                if(confirm("Are you sure you want to delete this quotation?")) {
                    ...
                    if(r.success) {
                        alert("QuotationIn deleted.");
                         window.location.reload()
                    } else {
                        alert("QuotationIn could not be deleted.");
                    }
                }
			}			
		}
