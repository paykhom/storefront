...
export default class ShopEditor extends AdminLayout {
...
yield html`
                        ...
                        <div class="accordion-button" data-bs-toggle="collapse" data-bs-target="#collapseOne"
                            ...
                            <div class="addproduct-icon">
                                <h5><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    ...
                                    </svg><span>Shop Information</span></h5>
                           ...
                           <div class="row">
                                <div class="col-12">
                                    <div class="mb-3 add-product">
                                         <label class="form-label">Shop Type ID</label>
                                         <select class="form-select" xdata-select2-id="select2-data-7-owwb"
												tabindex="-1" aria-hidden="true" data-state="shop_type_id">
										</select>
                                    </div>
                                </div>
                                    ...
                                    <div class="mb-3 add-product">
                                        <label class="form-label">Establishment Date</label>
                                         <div class="input-groupicon calender-input">
                                          ...
                                          <input type="date"  class="xdatetimepicker form-control"" data-state="establishment_date" placeholder="Choose Date">
                                      </div>
                                    </div>
                                </div>
                                 <div class="col-lg-3 col-sm-6 col-12">
   ...
   <input type="hidden" data-state="shop_id" />
</form>
					<!-- /form -->
