...
export default class AudienceEditor extends AdminLayout {
...
yield html`
                        ...
                        <div class="accordion-button" data-bs-toggle="collapse" data-bs-target="#collapseOne"
                            ...
                            <div class="addproduct-icon">
                                <h5><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    ...
                                    </svg><span>Audience Information</span></h5>
                        ...
                        <div class="accordion-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-sm-6 col-12">
                                    <div class="mb-3 add-product">
                                        ...
                                        <input type="tel" class="form-control" data-state="phone_number">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                             ...
                             <div class="row">
                                   <div class="col-lg-6 col-sm-6 col-12">
                                      <div class="mb-3 add-product">
                                         <label class="form-label">Audience Status ID</label>
                                        <select data-state="audience_status_id" class="form-select">
                                    ...
                                    <div class="col-lg-6 col-sm-6 col-12">
                                        <div class="mb-3 add-product">
                                            ...
                                            <input type="number" class="form-control" data-state="audience_score">
                                        </div>
                                    </div>
                                </div>
                            <div class="row">
                                    ...
                                    <div class="mb-3 add-product">
                                        <label class="form-label">Last Activity Date</label>
                                         <div class="input-groupicon calender-input">
                                                ...
                                                <input type="text" class="datetimepicker" placeholder="Choose Date" data-state="last_activity_date">
                                            </div>
                                    </div>
                                </div>
                            </div>
    ...
    <input type="hidden" data-state="audience_id" />
</form>
					<!-- /form -->
...
yield html`
    ...
    class Page extends AdminLayout {
        ...
        async uponReady() {
			...
			await this.loadEditor(~/api/dbx/ecom/audience/load_editor~, {});
		}
    }
    page = new Page();
</script>
