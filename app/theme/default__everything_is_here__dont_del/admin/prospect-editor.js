...
export default class ProspectEditor extends AdminLayout {
...
yield html`
                        ...
                        <div class="accordion-button" data-bs-toggle="collapse" data-bs-target="#collapseOne"
                            ...
                            <div class="addproduct-icon">
                                <h5><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    ...
                                    </svg><span>Prospect Information</span></h5>
                    ...
                    <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                        ...
                        <div class="accordion-body">
                           ...
                           <div class="row">
                                <div class="col-lg-6 col-sm-6 col-12">
                                      <div class="mb-3 add-product">
                                        <label class="form-label">Lead Status ID</label>
                                          <select data-state="lead_status_id" class="form-select">
                                   ...
                                   <div class="col-lg-6 col-sm-6 col-12">
                                      <div class="mb-3 add-product">
                                         ...
                                         <input type="number" class="form-control" data-state="lead_score">
                                       </div>
                                    </div>
                            </div>
                             <div class="row">
    ...
    <div class="col-lg-12">
     ...
     <input type="hidden" data-state="prospect_id"/>
</form>
					<!-- /form -->
...
<script>
    class Page extends AdminLayout {
        ...
        async uponReady() {
			...
			await this.loadEditor(~/api/dbx/ecom/prospect/load_editor~, {});
		}
    }
    page = new Page();
</script>
