...
export default class ShipmentPaginator extends AdminLayout {
                           ...
                           xbFilter: true,
                            ...
                            pageLength: 25,
                             columns: [
                                ...
                                { data: 'shipment_id', title: "Shipment ID" },
                                {
                                     data: 'shipment_date', title: "Shipment Date",
                                     render: function(data) {
                                         return new Date(data).toLocaleDateString(); // Format date
                                     }
                                 },
                                { data: 'sales_id', title: "Sales ID" },
                                { data: 'shipping_carrier', title: "Shipping Carrier" },
                                    ...
                                    render: function (data, type, row) {
                                        return ~
											<div class="edit-delete-action">
												...
												<a class="me-2 p-2" href="/admin/shipment/editor/~{row.shipment_id}">
