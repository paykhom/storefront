...
export default class SalesWarrantyClaimPaginator extends AdminLayout {
								...
								render: function (data, type, row) {
									return ~
										<div class="edit-delete-action">
											<a class="me-2 edit-icon  p-2" href="/admin/sales/warranty-claim/edit/~{row.sales_warranty_claim_id}">
