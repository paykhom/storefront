...
export default class PurchaseEditor extends AdminLayout {
...
yield html`
                        ...
                        <div class="accordion-button" data-bs-toggle="collapse" data-bs-target="#collapseOne"
                            ...
                            <div class="addproduct-icon">
                                <h5><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    ...
                                    </svg><span>Purchase Information</span></h5>
                           ...
                           <div class="row">
                                <div class="col-lg-6 col-sm-6 col-12">
                                    <div class="mb-3 add-product">
                                        ...
                                        <input type="number" class="form-control" data-state="quotation_id">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-sm-6 col-12">
                                    <div class="mb-3 add-product">
                                       <label class="form-label">Purchase Type ID</label>
                                          <input type="number" class="form-control" data-state="purchase_type_id">
                                       </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-sm-6 col-12">
                                     <div class="mb-3 add-product">
                                        <label class="form-label">Purchase Status ID</label>
                                        <input type="number" class="form-control" data-state="purchase_status_id">
                                      </div>
                                  </div>
                                  <div class="col-lg-6 col-sm-6 col-12">
                                    <div class="mb-3 add-product">
                                      <label class="form-label">Coupon Code</label>
                                      <input type="text" class="form-control" data-state="coupon_code">
                                  </div>
                                </div>
                            </div>
                            <div class="row">
                                  ...
                                  <div class="col-lg-6 col-sm-6 col-12">
                                       <div class="mb-3 add-product">
                                           <label class="form-label">Supplier ID</label>
                                            <input type="number" class="form-control" data-state="supplier_id">
                                        </div>
                                   </div>
                            </div>
                           <div class="row">
    ...
    <div class="col-lg-12">
     ...
     <input type="hidden" data-state="purchase_id"/>
</form>
					<!-- /form -->
...
<script>
    class Page extends AdminLayout {
        ...
        async uponReady() {
			...
			await this.loadEditor(~/api/dbx/ecom/purchase/load_editor~, {});
		}
    }
    page = new Page();
</script>
