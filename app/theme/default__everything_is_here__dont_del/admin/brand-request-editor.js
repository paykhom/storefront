...
export default class BrandRequestEditor extends AdminLayout {
...
yield html`
                        ...
                        <div class="accordion-button" data-bs-toggle="collapse" data-bs-target="#collapseOne"
                            ...
                            <div class="addproduct-icon">
                                <h5><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    ...
                                    </svg><span>Brand Information</span></h5>
                                ...
                                <div class="col-lg-6 col-sm-6 col-12">
                                 ...
                                 <div class="col-lg-6 col-sm-6 col-12">
                                      <div class="mb-3 add-product">
                                        ...
                                        <textarea class="form-control" rows="5" data-state="meta_description"></textarea>
                                    </div>
                                 </div>
                           </div>
                             ...
                             <div class="row">
                                 <div class="col-lg-12 col-sm-12 col-12">
                                   <div class="mb-3 add-product">
                                          ...
                                          <textarea class="form-control" rows="5" data-state="content"></textarea>
                                     </div>
                                 </div>
                             </div>
    ...
    <div class="col-lg-12">
     ...
     <input type="hidden" data-state="brand_id"/>
</form>
					<!-- /form -->
...
<script>
    class Page extends AdminLayout {
        ...
        async uponReady() {
			...
			await this.loadEditor(~/api/dbx/ecom/brand/load_editor~, {});
		}
    }
    page = new Page();
</script>
