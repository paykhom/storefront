...
export default class SubscriberEditor extends AdminLayout {
...
yield html`
					...
					<!-- form -->
					<form action="add-subscriber.html">
    <div class="card">
                        ...
                        <div class="accordion-button" data-bs-toggle="collapse" data-bs-target="#collapseOne"
                            ...
                            <div class="addproduct-icon">
                                <h5><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    ...
                                    </svg><span>Subscriber Information</span></h5>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-sm-6 col-12">
                                    <div class="mb-3 add-product">
                                        ...
                                        <input type="text" class="form-control" data-state="phone_number">
                                    </div>
                                </div>
                            </div>
                             <div class="row">
                                <div class="col-lg-6 col-sm-6 col-12">
                                  ...
                                  <div class="col-lg-6 col-sm-6 col-12">
                                   <div class="mb-3 add-product">
                                        ...
                                        <input type="text" class="form-control" data-state="job_title">
                                    </div>
                                </div>
                             </div>
                                  ...
                                  <div class="col-lg-6 col-sm-6 col-12">
                                     <div class="mb-3 add-product">
                                        <label class="form-label">Industry</label>
                                         <input type="text" class="form-control" data-state="industry">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-sm-6 col-12">
                                     <div class="mb-3 add-product">
                                        <label class="form-label">Source</label>
                                         <input type="text" class="form-control" data-state="source">
                                    </div>
                                </div>
                             </div>
                            <div class="row">
                                <div class="col-lg-3 col-sm-6 col-12">
                                    <div class="mb-3 add-product">
                                        ...
                                        <input type="text" class="form-control" data-state="subscriber_status_id">
                                    </div>
                                </div>
                                <div class="col-lg-3 col-sm-6 col-12">
                                    <div class="mb-3 add-product">
                                       <label class="form-label">Subscriber Score</label>
                                        <input type="number" class="form-control" data-state="subscriber_score" value="0">
                                    </div>
                                </div>
                                 <div class="col-lg-3 col-sm-6 col-12">
                                    <div class="mb-3 add-product">
                                        <label class="form-label">Opted In</label>
                                        <select data-state="opted_in" class="form-select">
                                        ...
                                        <label>Last Activity Date</label>
                                         <div class="input-groupicon calender-input">
                                           <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-calendar info-img"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>
                                            <input type="text" class="datetimepicker" data-state="last_activity_date" placeholder="Choose Date">
                                        </div>
                                    </div>
                                </div>
                             </div>
                             ...
                             <div class="row">
                                  <div class="col-lg-12">
                                    <div class="input-blocks summer-description-box transfer mb-3">
                                        <label>Notes</label>
                                        <textarea class="form-control h-100" rows="3" data-state="notes"></textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                  ...
                                  <div class="col-lg-3 col-sm-6 col-12">
                                        <div class="mb-3 add-product">
                                            ...
                                            <input type="text" class="form-control" data-state="region">
                                        </div>
                                   </div>
                                    <div class="col-lg-3 col-sm-6 col-12">
                                        <div class="mb-3 add-product">
                                    ...
                                    <div class="col-lg-3 col-sm-6 col-12">
                                         <div class="mb-3 add-product">
                                            ...
                                            <input type="text" class="form-control" data-state="postal_code">
                                        </div>
                                    </div>
                            </div>
    ...
    <input type="hidden" data-state="subscriber_id" />
</form>
					<!-- /form -->
...
yield html`
    ...
    class Page extends AdminLayout {
        ...
        async uponReady() {
			...
			await this.loadEditor(~/api/dbx/ecom/subscriber/load_editor~, {});
		}
    }
    page = new Page();
</script>
