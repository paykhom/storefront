...
export default class VendorEditor extends AdminLayout {
...
yield html`
                        ...
                        <div class="accordion-button" data-bs-toggle="collapse" data-bs-target="#collapseOne"
                            ...
                            <div class="addproduct-icon">
                                <h5><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    ...
                                    </svg><span>Vendor Information</span></h5>
                        ...
                        <div class="accordion-body">
                            <div class="row">
                             ...
                             <div class="row">
                               <div class="col-lg-6 col-sm-6 col-12">
                                   <div class="mb-3 add-product">
                                        <label class="form-label">Vendor Type ID</label>
                                        <input type="text" class="form-control" data-state="vendor_type_id">
                                   </div>
                                </div>
                                <div class="col-lg-6 col-sm-6 col-12">
                                    <div class="mb-3 add-product">
                             ...
                             <div class="row">
                                <div class="col-lg-12">
                                    <div class="input-blocks summer-description-box transfer mb-3">
                                        <label>Excerpt</label>
                                        <textarea class="form-control h-100" rows="3" data-state="excerpt"></textarea>
   ...
   <input type="hidden" data-state="vendor_id"/>
</form>
					<!-- /form -->
...
yield html`
    ...
    class Page extends AdminLayout {
        ...
        async uponReady() {
			...
			await this.loadEditor(~/api/dbx/ecom/vendor/load_editor~, {});
		}
    }
    page = new Page();
</script>
