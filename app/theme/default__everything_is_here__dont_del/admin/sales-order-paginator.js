...
export default class SalesOrderPaginator extends AdminLayout {
                ...
                async uponReady() {
                    ...
                    let table = new DataTable(
                        '#myDataTable',
                        {
                            ...
                            ajax: '/api/dtx/ecom/sales_order/search',
                            processing: false,
                            serverSide: true,
                            pageLength: 25,
                            columns: [
                                ...
                                { data: 'sales_order_id', title: "Order ID" },
                                {
                                    ...
                                    render: function (data, type, row) {
                                        return ~
											<div class="edit-delete-action">
												...
												<a class="me-2 p-2" href="/admin/sales/order/editor/~{row.sales_order_id}">
