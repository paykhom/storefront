...
export default class RefundPaginator extends AdminLayout {
    ...
    *script() {
        ...
        <script>
            class Page extends AdminLayout {
                ...
                async uponReady() {
                    ...
                    let table = new DataTable(
                        '#myDataTable',
                        {
                            ...
                            ajax: '/api/dtx/ecom/refund/search', // API endpoint for refunds
                            processing: false,
                            serverSide: true,
                            pageLength: 25,
                            columns: [
                                    ...
                                    render: function (data, type, row) {
                                        return ~
                                            <div class="edit-delete-action">
                                                ...
                                                <a class="me-2 p-2" href="/admin/sales/refund/editor/~{row.sales_refund_id}">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit">
                                                        <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path>
                                                        <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path>
                                                    </svg>
                                                </a>
                                                <a class="confirm-text p-2" href="#" onclick="page.onClickDeleteRow(this, ~{row.refund_id})">
                ...
                async onClickDeleteRow(e, refundId) {
                     if(confirm("Are you sure you want to delete this refund?")) {
                         
                         
                         const response = await fetch(~/api/dtx/ecom/refund/~{refundId}~, {
                               method: 'DELETE',
                               headers: {
                           ...
                           if (response.ok) {
                              ...
                              alert("Error deleting refund record: " + errorData.error);
                           } 
                     }
