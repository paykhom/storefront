...
export default class StockLedgerEditor extends AdminLayout {
...
yield html`
					...
					<!-- form -->
					<form action="add-stock-ledger.html">
    <div class="card">
                        ...
                        <div class="accordion-button" data-bs-toggle="collapse" data-bs-target="#collapseOne"
                            ...
                            <div class="addproduct-icon">
                                <h5><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    ...
                                    </svg><span>Stock Ledger Information</span></h5>
                        ...
                        <div class="accordion-body">
                            <div class="row">
                                <div class="col-lg-6 col-sm-6 col-12">
                                 ...
                                 <div class="col-lg-6 col-sm-6 col-12">
                                      <div class="mb-3 add-product">
                                        <label class="form-label">Stock Location ID</label>
                                        <input type="text" class="form-control" data-state="stock_location_id">
                                    </div>
                                </div>
                            </div>
                             <div class="row">
                                <div class="col-lg-6 col-sm-6 col-12">
                                    <div class="mb-3 add-product">
                                        <label class="form-label">Stock Transaction Type ID</label>
                                         <input type="text" class="form-control" data-state="stock_transaction_type_id">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-sm-6 col-12">
                                     <div class="mb-3 add-product">
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-sm-6 col-12">
                                    <div class="mb-3 add-product">
                                        ...
                                        <input type="number" class="form-control" data-state="rel_id" value="0" required>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-sm-6 col-12">
                                   <div class="mb-3 add-product">
                                        <label class="form-label">Date</label>
                                         ...
                                         <input type="text" class="datetimepicker" data-state="date" placeholder="Choose Date">
                                    </div>
                                </div>
                           </div>
                            <div class="row">
                               <div class="col-lg-12">
                                    <div class="input-blocks summer-description-box transfer mb-3">
                                        ...
                                        <textarea class="form-control h-100" rows="5" data-state="particulars"></textarea>
                                    </div>
                                </div>
                           </div>
    ...
    <input type="hidden" data-state="stock_ledger_id" />
</form>
					<!-- /form -->
...
yield html`
    ...
    class Page extends AdminLayout {
        ...
        async uponReady() {
			...
			await this.loadEditor(~/api/dbx/ecom/stock_ledger/load_editor~, {});
		}
    }
    page = new Page();
</script>
