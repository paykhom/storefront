...
export default class PurchasePaginator extends AdminLayout {
                    ...
                    let table = new DataTable(
                        '#myDataTable',
                        {
                           xbFilter: true,
                            ...
                            ajax: '/api/dtx/ecom/purchase/search',
                            processing: false,
                            serverSide: true,
                            pageLength: 25,
                             columns: [
                                ...
                                { data: 'quotation_id', title: "Quotation ID" },
                                 {
                                    ...
                                    render: function (data, type, row) {
                                        return ~
											<div class="edit-delete-action">
												...
												<a class="me-2 p-2" href="/admin/purchase/editor/~{row.purchase_id}">
