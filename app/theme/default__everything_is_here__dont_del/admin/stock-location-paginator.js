...
export default class StockLocationPaginator extends AdminLayout {
        ...
        <div class="page-header">
            <div class="add-item d-flex">
                <div class="page-title">
                    ...
                    <h6>Manage your stock locations</h6>
                </div>
            </div>
                ...
                async uponReady() {
                    ...
                    let table = new DataTable(
                        '#myDataTable',
                        {
                            ...
                            ajax: '/api/dtx/ecom/stock_location/search',
                            processing: false,
                            serverSide: true,
                            pageLength: 25,
                            columns: [
                                ...
                                { data: 'stock_location_id', title: "Stock Location ID" },
                                { data: 'title', title: "Title" },
                                { data: 'slug', title: "Slug" },
                                 { data: 'node_path', title: "Node Path" },
                                    ...
                                    render: function (data, type, row) {
                                        return ~
											<div class="edit-delete-action">
												...
												<a class="me-2 p-2" href="/admin/stock/location/editor/~{row.stock_location_id}">
