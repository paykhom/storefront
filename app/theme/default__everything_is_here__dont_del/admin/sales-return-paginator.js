...
export default class SalesReturnPaginator extends AdminLayout {
                ...
                async uponReady() {
                    ...
                    let table = new DataTable(
                        '#myDataTable',
                        {
                            ...
                            ajax: '/api/dtx/ecom/sales_return/search',
                            processing: false,
                            serverSide: true,
                            pageLength: 25,
                            columns: [
                                ...
                                { data: 'sales_return_id', title: "Return ID" },
                                {
                                    data: 'return_date',
                                    title: "Return Date",
                                    ...
                                    render: function (data, type, row) {
                                        return ~
											<div class="edit-delete-action">
												...
												<a class="me-2 p-2" href="/admin/sales/return/editor/~{row.sales_return_id}">
