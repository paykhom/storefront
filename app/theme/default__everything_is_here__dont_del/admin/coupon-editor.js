...
export default class CouponEditor extends AdminLayout {
...
yield html`
                          ...
                          <div class="row">
                                <div class="col-lg-6 col-sm-6 col-12">
                                    <div class="mb-3 add-product">
                                        ...
                                        <input type="text" class="form-control" data-state="code" required>
                                    </div>
                                </div>
                                 <div class="col-lg-6 col-sm-6 col-12">
                                      <div class="mb-3 add-product">
                                  ...
                                  <div class="col-lg-6 col-sm-6 col-12">
                                   ...
                                   <div class="col-lg-6 col-sm-6 col-12">
                                        <div class="mb-3 add-product">
                                                ...
                                                <input type="number" class="form-control" data-state="usage_limit">
                                        </div>
                                  </div>
                            </div>
    ...
    <input type="hidden" data-state="coupon_id"/>
</form>
					<!-- /form -->
