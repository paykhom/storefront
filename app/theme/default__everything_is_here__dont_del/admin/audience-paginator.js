...
export default class AudiencePaginator extends AdminLayout {
								...
								render: function (data, type, row) {
									return ~
										<div class="edit-delete-action">
											<a class="me-2 edit-icon  p-2" href="/admin/marketing/audience/editor/~{row.audience_id}">
