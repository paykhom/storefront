...
export default class SalesOrderEditor extends AdminLayout {
                                 ...
                                 <div class="col-lg-6 col-sm-6 col-12">
                                      <div class="mb-3 add-product">
                                         <label class="form-label">Sales Order Status ID</label>
                                          <input type="number" class="form-control" data-state="sales_order_status_id" value="1">
                                       </div>
                                 </div>
                             </div>
                                  ...
                                  <div class="col-lg-6 col-sm-6 col-12">
                                     <div class="mb-3 add-product">
                                         <label class="form-label">Sales Type ID</label>
                                          <input type="number" class="form-control" data-state="sales_order_type_id" value="0">
                                      </div>
                                  </div>
                                  <div class="col-lg-6 col-sm-6 col-12">
                                      <div class="mb-3 add-product">
...
<script>
    class Page extends AdminLayout {
        ...
        async uponReady() {
			...
			await this.loadEditor(~/api/dbx/ecom/sales_order/load_editor~, {});
		}
    }
    page = new Page();
</script>
