...
export default class ProductReviewPaginator extends AdminLayout {
								...
								render: function (data, type, row) {
									return ~
										<div class="edit-delete-action">
											<a class="me-2 edit-icon  p-2" href="/admin/catalog/product-review/edit/~{row.product_review_id}">
