...
export default class SalesReturnEditor extends AdminLayout {
...
yield html`
  ...
  <div class="card">
    ...
    <input type="hidden" data-state="sales_return_id"/>
</form>
					<!-- /form -->
...
yield html`
    ...
    class Page extends AdminLayout {
        ...
        async uponReady() {
			...
			await this.loadEditor(~/api/dbx/ecom/sales_return/load_editor~, {});
		}
    }
    page = new Page();
</script>
