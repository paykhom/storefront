...
export default class ShipmentDeliveryEditor extends AdminLayout {
...
yield html`
                        ...
                        <div class="accordion-button" data-bs-toggle="collapse" data-bs-target="#collapseOne"
                            ...
                            <div class="addproduct-icon">
                                <h5><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    ...
                                    </svg><span>Shipment Detail Information</span></h5>
                                ...
                                <div class="col-lg-6 col-sm-6 col-12">
                                    <div class="mb-3 add-product">
                                         <label class="form-label">Shipment ID</label>
                                          <input type="number" class="form-control" data-state="shipment_id" required>
                                      </div>
                                  </div>
                                 <div class="col-lg-6 col-sm-6 col-12">
                                      <div class="mb-3 add-product">
                                            <label class="form-label">Product Variant ID</label>
                                            <input type="number" class="form-control" data-state="product_variant_id" required>
                                        </div>
                                   </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-6 col-sm-6 col-12">
                                     <div class="mb-3 add-product">
                                        ...
                                        <input type="number" class="form-control" data-state="quantity" required>
                                   </div>
                                </div>
                                  <div class="col-lg-6 col-sm-6 col-12">
                                      <div class="mb-3 add-product">
                                            <label class="form-label">Unit of Measure ID</label>
                                            <input type="number" class="form-control" data-state="uom_id" required>
                                        </div>
                                  </div>
                            </div>
                            <div class="row">
                                  <div class="col-lg-6 col-sm-6 col-12">
                                       <div class="mb-3 add-product">
                                           ...
                                           <input type="number" step="0.01" class="form-control" data-state="price">
                                        </div>
                                  </div>
                                  <div class="col-lg-6 col-sm-6 col-12">
                                         <div class="mb-3 add-product">
                                  ...
                                  <div class="col-lg-12 col-sm-12 col-12">
                                      <div class="mb-3 add-product">
                                            <label class="form-label">Particulars</label>
                                              <textarea class="form-control" rows="5" data-state="particulars"></textarea>
                                        </div>
                                    </div>
                            </div>
                        </div>
    ...
    <div class="col-lg-12">
     ...
     <input type="hidden" data-state="shipment_id"/>
</form>
					<!-- /form -->
...
yield html`
    ...
    class Page extends AdminLayout {
        ...
        async uponReady() {
			...
			await this.loadEditor(~/api/dbx/ecom/shipment/load_editor~, {});
		}
    }
    page = new Page();
</script>
