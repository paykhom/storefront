...
export default class NotificationEditor extends UserLayout {
...
yield html`
					...
					<!-- form -->
					<form action="add-notification.html">
    <div class="card">
                        ...
                        <div class="accordion-button" data-bs-toggle="collapse" data-bs-target="#collapseOne"
                            ...
                            <div class="addproduct-icon">
                                <h5><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    ...
                                    </svg><span>Notification Information</span></h5>
                           ...
                           <div class="row">
                                ...
                                <div class="col-lg-6 col-sm-6 col-12">
                                    <div class="mb-3 add-product">
                                        <label class="form-label">Notification Type</label>
                                          <select data-state="type" class="form-select">
                                ...
                                <div class="col-lg-6 col-sm-6 col-12">
                                     <div class="mb-3 add-product">
                                        <label class="form-label">Is Read</label>
                                          <select data-state="is_read" class="form-select">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="input-blocks summer-description-box transfer mb-3">
                                        <label>Message</label>
                                        <textarea class="form-control h-100" rows="5" data-state="message" required></textarea>
                                    </div>
                                </div>
                             </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                     <div class="input-blocks summer-description-box transfer mb-3">
                                        <label>Data</label>
                                        <textarea class="form-control h-100" rows="3" data-state="data"></textarea>
                                     </div>
                                </div>
                            </div>
     ...
     <input type="hidden" data-state="notification_id"/>
</form>					<!-- /form -->
...
<script>
    class Page extends UserLayout {
        ...
        async uponReady() {
			...
			await this.loadEditor(~/api/dbx/ecom/notification/load_editor~, {});
		}
    }
    page = new Page();
</script>
