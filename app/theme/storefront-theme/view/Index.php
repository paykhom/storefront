...
?>
                                       ...
                                       <div class="d-flex justify-content-between align-items-center mt-3">
                                          ...
                                          <div>
                                             <a href="#!" class="btn btn-primary btn-sm pvs-btn-add-to-cart" data-product-variant-id="<?= $product["inventory_id"] ?>" data-product-price="<?= $product["price"] ?>" data-product-title="<?= $product["title"] ?>" data-product-media-path="/theme/freshcart/assets/images/product-single-img-1.jpg" data-product-link-product-slug="<?= $product["slug"] ?>" data-product-list-price="<?= $product["list_price"] ?>">
