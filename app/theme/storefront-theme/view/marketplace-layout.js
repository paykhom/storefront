import View from "paykhom-fw/component/view";
...
<html lang="en-US" itemscope="itemscope" itemtype="http://schema.org/WebPage">
   <head>
      ...
      <!-- preload -->
      <!-- Favicon icon-->
      <link rel="preload" type="image/x-icon" href="/theme/freshcart/assets/images/favicon/favicon.ico" as="image"/>
      

      <!-- images -->
      <link rel="preload" href="/_assets/images/info/bg-001-0-deg.png" as="image/png" as="image"/>
                  ...
                  <div>
                     ...
                     <ul class="navbar-nav align-items-center">
                        <li class="nav-item w-100 w-lg-auto">
                           <a class="nav-link" href="./dashboard/index.html">Home</a>
                        </li>
                        <li class="nav-item w-100 w-lg-auto">
                           <a class="nav-link" href="./dashboard/index.html">Categories</a>
                        </li>
                        <li class="nav-item w-100 w-lg-auto">
                           <a class="nav-link" href="./dashboard/index.html">Brands</a>
                        </li>
                        <li class="nav-item w-100 w-lg-auto">
                           <a class="nav-link" href="./dashboard/index.html">Products</a>
                        </li>
                        <li class="nav-item w-100 w-lg-auto">
                           <a class="nav-link" href="./dashboard/index.html">(Variants)</a>
                        </li>
                        <li class="nav-item w-100 w-lg-auto">
                           <a class="nav-link" href="./dashboard/index.html">Departments</a>
                        </li>
                        <li class="nav-item w-100 w-lg-auto">
                           <a class="nav-link" href="./dashboard/index.html">New</a>
                        </li>
                        <li class="nav-item w-100 w-lg-auto">
                           <a class="nav-link" href="./dashboard/index.html">Bestsellers</a>
                        </li>
                        <li class="nav-item w-100 w-lg-auto">
                           <a class="nav-link" href="./dashboard/index.html">Trending</a>
                        </li>
                        <li class="nav-item w-100 w-lg-auto">
                           <a class="nav-link" href="./dashboard/index.html">Offers</a>
                        </li>
                        <li class="nav-item w-100 w-lg-auto">
                           <a class="nav-link" href="./dashboard/index.html">Popular</a>
                        </li>
                        <li class="nav-item w-100 w-lg-auto">
                           <a class="nav-link" href="./dashboard/index.html">Highlights</a>
                        </li>
                     </ul>
      ...
      if(t.classList.contains("already-in-cart")) {
         ...
         createCartItemElement(item) {
            ...
            <div class="ms-3">
               ...
               <a class="text-decoration-none text-inherit btn-remove-product-from-cart" role="button" data-item-id="~{item.inventory_id}">
            ...
            <div class="input-group input-spinner" data-product-variant-id="~{item.inventory_id}">
            ...
            <input type="hidden" data-list-item-field="inventory_id" value="~{item.inventory_id}">
         ...
         async updateCartItem(itemId, quantity) {
            ...
            try {
            this.state.cart[itemId].inventory_id = itemId;
         ...
         async removeItemFromCart(itemId) {
            try {
            const response = await this.apiRequest(~/shopping/cart/remove~, 'POST', {"inventory_id": itemId});
         ...
         try {
            ...
            this.state.cart[cartRow.inventory_id] = cartRow;
            ...
            displaySearchResults(results, container) {
              ...
              container.classList.remove('d-none'); // Show the container
               ...
               if (results.inventory && results.inventory.length > 0) {
                  ...
                  const productTbody = document.getElementById('tbody_inventory');
                  productTbody.innerHTML = '';

                  results.inventory.forEach(product => {
                        ...
                        tableRow.innerHTML = ~
                           ...
                           <!-- 
                           <td class="align-middle border-top-0">
                                 <a href="/shopping/product-variant/~{product.slug}" class="text-inherit">~{product.inventory_id}</a>
                           </td>
                           -->
