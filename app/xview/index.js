            ...
            <main class="page-wrapper">
                ...
                <section class="bg-secondary position-relative pt-lg-3 pt-xl-4 pt-xxl-5">
                    ...
                    <div class="container position-relative z-5 mt-2 pt-5 pb-2 pb-sm-4 pb-lg-5">
                        <h1 class="display-3 text-center mx-auto pt-5 my-2 my-sm-4" style="max-width: 680px;">Ready to Turn Your Passion into a Thriving Online Store?</h1>
                        <p class="text-center lead">[Your Platform Name] empowers you to easily create, manage, and grow a successful e-commerce business, even if you're a complete beginner.</p>
                        ...
                        <div class="row justify-content-center pt-3 pt-sm-4 pt-md-5 mt-sm-1">
                            <div class="col-8 col-lg-4 order-lg-2" style="margin-top: -105px;">
                                ...
                                <div class="position-lg-sticky top-0 mb-5 pb-sm-2 pb-xl-4" style="padding-top: 110px;">
                                    <img class="d-block mx-auto" src="/theme/around/assets/img/landing/mobile-app-showcase/hero/screen02.png" width="322" alt="App screen">
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6 col-lg-4 order-lg-1 overflow-hidden mt-lg-4 pt-xl-3">
                                ...
                                <!-- Left app sceen -->
                                <img class="d-none d-lg-block rounded-4 ms-auto" src="/theme/around/assets/img/landing/mobile-app-showcase/hero/screen01.png" width="297" alt="App screen" style="box-shadow: 0 .9375rem 3rem -.5rem rgba(18,34,50, .05);">
                                ...
                                <div class="text-center text-sm-start mb-5 mx-auto mx-sm-0 pb-lg-2 pb-xl-4" style="max-width: 340px;" data-aos="fade-right" data-aos-offset="300" data-aos-easing="ease-out-back" data-disable-parallax-down="lg">
                                    ...
                                    <h2 class="h4 text-white mb-2 mb-lg-3">Stop Dreaming, Start Selling</h2>
                                    <p class="text-white opacity-80 mb-0"> Setting up an online store can be complex, time-consuming, and expensive.</p>
                                </div>
                                <div class="text-center text-sm-start mb-5 mx-auto mx-sm-0 pb-lg-2 pb-xl-4" style="max-width: 340px;" data-aos="fade-right" data-aos-delay="200" data-aos-offset="250" data-aos-easing="ease-out-back" data-disable-parallax-down="lg">
                                    ...
                                    <h2 class="h4 text-white mb-2 mb-lg-3">We Make it Easy</h2>
                                    <p class="text-white opacity-80 mb-0">Our intuitive platform provides all the tools and support you need to succeed, without the technical headaches</p>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6 col-lg-4 order-lg-3 overflow-hidden mt-lg-4 pt-xl-3">
                                ...
                                <!-- Right app screen -->
                                <img class="d-none d-lg-block rounded-4" src="/theme/around/assets/img/landing/mobile-app-showcase/hero/screen03.png" width="297" alt="App screen" style="box-shadow: 0 .9375rem 3rem -.5rem rgba(18,34,50, .05);">
                                ...
                                <div class="text-center text-sm-start mb-5 mx-auto me-sm-0 pb-lg-2 pb-xl-4" style="max-width: 340px;" data-aos="fade-left" data-aos-offset="250" data-aos-delay="400" data-aos-easing="ease-out-back" data-disable-parallax-down="lg">
                                    ...
                                    <h2 class="h4 text-white mb-2 mb-lg-3">Focus on Growth, Not Technicalities</h2>
                                    <p class="text-white opacity-80 mb-0">Finally, you can focus on what you love: creating amazing products and connecting with your customers</p>
                                </div>
                            </div>
                        </div>
                        <div class="text-center">
                            <a class="btn btn-primary btn-lg px-5 py-3" href="[Link to Pricing Page]">Start Your Free Trial Now</a>
                            <p class="text-white opacity-70 mt-2">No credit card required. Get started in minutes.</p>
                        </div>
                    </div>
                </section>
                ...
                <section class="container pt-5 mt-lg-3 mt-xl-4 mt-xxl-5">
                    <div class="row pt-2 pt-sm-3 pt-md-4 pt-lg-5 pb-xxl-2 mt-md-3 mt-lg-0">
                        <div class="col-lg-5 mb-5 mb-lg-0">
                            <div class="h1 text-center text-lg-start pb-md-2 pb-xl-0 mb-4 mb-xl-5">Start Living Your E-commerce Dream</div>

                            <!-- Market buttons -->
                            <div class="d-flex justify-content-center justify-content-lg-start">
                                <a class="btn btn-dark btn-lg px-3 py-2 me-3" href="#">
                                    <img class="d-dark-mode-none mx-1" src="/theme/around/assets/img/market/appstore-light.svg" width="136" alt="App Store">
                                    <img class="d-none d-dark-mode-block mx-1" src="/theme/around/assets/img/market/appstore-dark.svg" width="136" alt="App Store">
                                </a>
                                <a class="btn btn-dark btn-lg px-3 py-2" href="#">
                                    <img class="d-dark-mode-none mx-1" src="/theme/around/assets/img/market/googleplay-light.svg" width="135" alt="Google Play">
                                    <img class="d-none d-dark-mode-block mx-1" src="/theme/around/assets/img/market/googleplay-dark.svg" width="135" alt="Google Play">
                                </a>
                            </div>
                        </div>
                            ...
                            <div class="row row-cols-1 row-cols-sm-2 g-3 g-md-4">
                                <div class="col">
                                    <div class="d-flex flex-column h-100 bg-primary bg-opacity-10 rounded-3 text-center p-4">
                                        <div class="h3 display-5 mt-1 mb-0">[Number]+</div>
                                        <div class="fs-lg mb-1">Stores Launched</div>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="d-flex flex-column h-100 bg-info bg-opacity-10 rounded-3 text-center p-4">
                                        <div class="h3 display-5 mt-1 mb-0">[Percent]%</div>
                                        <div class="fs-lg mb-1">Average Sales Increase</div>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="d-flex flex-column h-100 bg-warning bg-opacity-10 rounded-3 text-center p-4">
                                        <div class="h3 display-5 mt-1 mb-0">[Number]+</div>
                                        <div class="fs-lg mb-1">Integrated Apps</div>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="d-flex flex-column h-100 bg-danger bg-opacity-10 rounded-3 text-center p-4">
                                        <div class="h3 display-5 mt-1 mb-0">24/7</div>
                                        <div class="fs-lg mb-1">Expert Support</div>
                                    </div>
                                </div>
                            </div>
                        </div>
...
291.253 51.5223 290.257 44.8019 286.15 38.6548C276.062 23.5577 257.645 38.0693 231.392 81.802C229.48 84.987 223.898 94.9317 218.988 103.901C199.782 138.985 195.822 145.462 192.294 147.561L191.853 147.823C191.125 148.256 190.18 147.984 189.793 147.231C188.667 145.037 187.961 141.017 186.717 129.714C184.189 106.732 180.914 98.5708 173.15 95.8985C165.844 93.3837 153.123 103.378 140.69 121.402C131.347 134.945 113.831 166.078 91.0128 209.694C69.8233 250.198 66.3837 256.187 64.5396 255.784C63.9143 255.647 63.7312 251.161 63.5858 232.448C63.305 196.288 62.4571 188.893 57.6271 180.481C48.7649 165.045 38.9039 173.309 18.4076 213.349C4.9308 239.676 -5.25857 266.339 -16.531 304.775C-22.481 325.063 -23.547 329.347 -22.9161 330.435C-22.4361 331.262 -21.607 330.886 -21.8104 329.933C-21.9715 329.175 -19.829 322.329 -16.6872 313.564C-15.5519 310.397 -13.4645 304.212 -12.0486 299.819C-5.17897 278.51 8.39215 243.529 15.5497 228.681C28.8615 201.067 39.4459 183.801 45.7893 179.352C49.4163 176.808 50.6601 177.421 53.7621 183.285C57.7184 190.764 58.7369 200.207 59.1715 233.43C59.5061 259.004 59.9209 261.21 64.3216 260.814C69.8899 260.313 73.9997 254.012 96.5793 211.354C137.787 133.504 155.164 107.073 168.666 101.708C175.088 99.156 179.298 108.555 181.934 131.331C183.982 149.026 185.558 153.247 190.21 153.495C196.679 153.841 201.275 147.557 225.333 105.473C246.313 68.7723 259.369 50.518 270.19 42.7571C276.503 38.2285 278.497 38.5429 281.567 44.5509C284.012 49.336 284.551 54.6178 284.232 70.6599C283.754 94.6223 286.717 101.264 296.665 98.5284C307.305 95.6024 314.857 86.8209 345.622 41.5992C362.049 17.4536 367.831 9.29258 380.682 -7.88343C385.241 -13.9779 391.495 -22.7637 394.579 -27.4072C397.663 -32.051 402.878 -39.7522 406.167 -44.5213C409.456 -49.2904 412.734 -54.0439 413.452 -55.0844C415.191 -57.6056 414.626 -57.1815 412.197 -54.1417Z"></path>
                                ...
                                <div class="binded-item" id="image3">
                                    ...
                                    <img class="d-block position-relative z-2" src="/theme/around/assets/img/landing/mobile-app-showcase/features/03.png" alt="App screen">
                                </div>
                            </div>
                        </div>
                                ...
                                "nextEl": "#next-feature"
                                    ...
                                    <div class="swiper-wrapper">
                                        ...
                                        <div class="swiper-slide" data-swiper-binded="#image1">
                                            ...
                                            <h2 class="h1 mb-lg-4">Intuitive Drag-and-Drop Store Builder</h2>
                                            <p class="mb-0">No coding skills required! Easily customize your layout, add content, and showcase your brand.  Launch a visually appealing store that attracts customers and boosts conversions in hours, not weeks.</p>
                                        </div>

                                        <!-- Item -->
                                        <div class="swiper-slide" data-swiper-binded="#image2">
                                            <div class="text-primary fs-xl fw-bold mb-3">02</div>
                                            <h2 class="h1 mb-lg-4">Built-in Marketing Tools</h2>
                                            <p class="mb-0">Access a suite of powerful marketing tools to drive traffic and increase sales.Optimize your SEO, create email campaigns, and promote your products on social media directly from your dashboard.</p>
                                        </div>

                                        <!-- Item -->
                                        <div class="swiper-slide" data-swiper-binded="#image3">
                                            <div class="text-primary fs-xl fw-bold mb-3">03</div>
                                            <h2 class="h1 mb-lg-4">Secure and Reliable Platform</h2>
                                            <p class="mb-0">[Your Platform Name] is built on a secure and reliable infrastructure.  Benefit from PCI-compliant payment processing, data encryption, and 24/7 monitoring.Rest assured that your customer data and financial transactions are always safe and protected.</p>
                                        </div>
                                    </div>
                                </div>
                ...
                <section class="container py-5 mb-1 mb-sm-2 my-lg-3 my-xl-4 my-xxl-5">
                    <div class="row justify-content-center pt-2 pt-sm-4 pb-4 mb-2 mb-lg-3">
                        <div class="col-lg-8 col-xl-7 col-xxl-6 text-center pt-2">
                            <h2 class="h1 mb-1">What Our Merchants Say</h2>
                            ...
                            <div class="swiper-slide h-auto">
                                <div class="card border-0 bg-info bg-opacity-10 h-100 text-center">
                                    <div class="polygon-avatar bg-info mx-auto translate-middle-y">
                                        <img src="/theme/around/assets/img/landing/mobile-app-showcase/testimonials/01.png" alt="[Merchant Name]">
                                    </div>
                                    <div class="card-body pt-0 mt-n4">
                                        <p class="card-text fs-xl">"I was able to launch my online store in just a few days with [Your Platform Name]! The drag-and-drop builder was so easy to use, and the support team was always available to answer my questions."</p>
                                    </div>
                                    <div class="card-footer border-0 pt-0">
                                        <div class="h4 mb-1">[Merchant Name]</div>
                            ...
                            <div class="swiper-slide h-auto">
                                <div class="card border-0 bg-warning bg-opacity-10 h-100 text-center">
                                    <div class="polygon-avatar bg-warning mx-auto translate-middle-y">
                                        <img src="/theme/around/assets/img/landing/mobile-app-showcase/testimonials/02.png" alt="[Merchant Name]">
                                    </div>
                                    <div class="card-body pt-0 mt-n4">
                                        <p class="card-text fs-xl">"Before using [Your Platform Name], I was struggling to manage my inventory and shipping. Now, everything is streamlined, and I can focus on growing my business."</p>
                                    </div>
                                    <div class="card-footer border-0 pt-0">
                                        <div class="h4 mb-1">[Merchant Name]</div>
                                        <span>[Store Name]</span>
                ...
                <section class="container py-5">
                    <div class="row justify-content-center">
                        <div class="col-lg-8 text-center">
                            <h2 class="h1 mb-4">Start Risk-Free Today</h2>
                            <p class="lead">We're so confident you'll love [Your Platform Name] that we offer a [Duration] money-back guarantee. Try [Your Platform Name] risk-free for [Duration]. If you're not completely satisfied, simply cancel your account, and you won't be charged.</p>
                        </div>
                    </div>
                </section>
                    ...
                    <div class="container py-md-2 py-lg-3 py-xl-5 my-2 my-sm-3 my-md-4 my-xxl-5">
                        <div class="row">
                            <div class="col-md-4 text-center text-md-start">
                                ...
                                <p class="pb-3 pb-sm-4">Find answers to common questions below.</p>
                                ...
                                <div class="accordion" id="faq">
                                    <div class="accordion-item bg-light">
                                        ...
                                        <div class="accordion-collapse collapse show" id="questionOne" aria-labelledby="headingOne" data-bs-parent="#faq">
                                            <div class="accordion-body fs-sm">Yes! We offer a free [Duration] trial so you can explore all the features of [Your Platform Name] before committing.</div>
                                        </div>
                                    </div>
                                    <div class="accordion-item bg-light">
                                        ...
                                        <div class="accordion-collapse collapse" id="questionTwo" aria-labelledby="headingTwo" data-bs-parent="#faq">
                                            <div class="accordion-body fs-sm">If you're not satisfied with [Your Platform Name] within the trial period, simply cancel your account, and you won't be charged. If you're on a paid plan and cancel within [Refund Period], you'll receive a full refund.</div>
                                        </div>
                                    </div>
                                    <div class="accordion-item bg-light">
                                        <h3 class="accordion-header" id="headingThree">
                                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#questionThree" aria-expanded="false" aria-controls="questionThree">What payment methods do you accept?</button>
                                        </h3>
                                        <div class="accordion-collapse collapse" id="questionThree" aria-labelledby="headingThree" data-bs-parent="#faq">
                                            <div class="accordion-body fs-sm">We accept all major credit cards (Visa, Mastercard, American Express, Discover), as well as PayPal and other payment options depending on your location.</div>
                                        </div>
                                    </div>
                                    <div class="accordion-item bg-light">
                                        <h3 class="accordion-header" id="headingFour">
                                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#questionFour" aria-expanded="false" aria-controls="questionFour">What kind of support do you offer?</button>
                                        </h3>
                                        <div class="accordion-collapse collapse" id="questionFour" aria-labelledby="headingFour" data-bs-parent="#faq">
                                            <div class="accordion-body fs-sm">We offer 24/7 email and chat support, as well as a comprehensive knowledge base and tutorial videos.</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="position-relative overflow-hidden rounded-5 px-4 px-sm-5 px-lg-0">
                            ...
                            <div class="row align-items-center position-relative z-2">
                                <div class="col-md-6 col-lg-5 col-xl-4 offset-lg-1 pb-sm-3 pt-5 py-md-0 py-lg-5" data-aos="fade-up" data-aos-duration="500" data-aos-offset="250" data-disable-parallax-down="lg">
                                    <h2 class="display-3 text-white text-center text-md-start mb-4 mb-lg-5">Ready to <br class="d-none d-xxl-inline">Start Building Your Dream Store?</h2>

                                    <!-- Market buttons -->
                                    <div class="d-flex flex-column flex-sm-row justify-content-center justify-content-md-start">
                                        <a class="btn btn-light btn-lg px-3 py-2 me-sm-3 mb-3 mb-sm-0" href="[Link to Pricing Page]">
                                            Start Free Trial
                                        </a>
                                    </div>
                                ...
                                <div class="col-md-6 col-lg-5 offset-xl-1">
                                    ...
                                    <img class="d-block d-md-none mx-auto" src="/theme/around/assets/img/landing/mobile-app-showcase/features/03.png" width="420" alt="App screen">
                                    ...
                                    <div class="d-none d-md-block position-relative mx-auto" style="max-width: 484px;">
                                        ...
                                        <img src="/theme/around/assets/img/landing/mobile-app-showcase/cta-screens.png" alt="App screens" data-aos="fade-left" data-aos-duration="600" data-aos-delay="200" data-aos-offset="300" data-disable-parallax-down="lg">
                                    </div>
                                </div>
                            </div>
                        </div>
