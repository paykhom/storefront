...
export default class ProductReviewEditor extends AdminLayout {
...
yield html`
                        ...
                        <div class="accordion-button" data-bs-toggle="collapse" data-bs-target="#collapseOne"
                            ...
                            <div class="addproduct-icon">
                                <h5><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    ...
                                    </svg><span>Product Review Information</span></h5>
                            ...
                            <div class="row">
                                 <div class="col-lg-6 col-sm-6 col-12">
                                        <div class="mb-3 add-product">
                                            ...
                                            <input type="number" class="form-control" min="1" max="5" data-state="rating" required>
                                        </div>
                                    </div>
                                     <div class="col-lg-6 col-sm-6 col-12">
                                            <div class="mb-3 add-product">
                                                <label class="form-label">Review Date</label>
                                                  <div class="input-groupicon calender-input">
                                                    ...
                                                    <input type="text" class="datetimepicker" placeholder="Choose Date" data-state="review_date">
                                            </div>
                                        </div>
                                  </div>
                            </div>
                                 ...
                                 <div class="col-lg-12 col-sm-12 col-12">
                                    <div class="mb-3 add-product">
                                         <label class="form-label">Review Text</label>
                                          <textarea class="form-control" rows="5" data-state="review_text"></textarea>
                                      </div>
                                   </div>
                             </div>
    ...
    <div class="col-lg-12">
     ...
     <input type="hidden" data-state="product_review_id"/>
</form>
					<!-- /form -->
...
<script>
    class Page extends AdminLayout {
        ...
        async uponReady() {
			...
			await this.loadEditor(~/api/dbx/ecom/product_review/load_editor~, {});
		}
    }
    page = new Page();
</script>
