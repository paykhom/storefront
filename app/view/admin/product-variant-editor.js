...
export default class ProductVariantEditor extends AdminLayout {
							...
							<div class="row">
								<div class="col-lg-3 col-sm-6 col-12">
                                    <div class="mb-3 add-product">
                                        ...
                                        <input type="number" data-state="list_price" class="form-control">
                                    </div>
                                </div>
								 <div class="col-lg-3 col-sm-6 col-12">
                                    <div class="mb-3 add-product">
                                        <label class="form-label">Price</label>
                                         <input type="number" data-state="price" class="form-control">
                                    </div>
                                </div>
                                 <div class="col-lg-3 col-sm-6 col-12">
                                    <div class="mb-3">
                                         ...
                                         <div class="input-groupicon calender-input">
                                             ...
                                             <input type="date" data-state="new_from" class="xdatetimepicker form-control" placeholder="Choose Date">
                                         </div>
                                    </div>
                                </div>
                                 <div class="col-lg-3 col-sm-6 col-12">
                                     <div class="mb-3">
                                        ...
                                        <div class="input-groupicon calender-input">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-calendar info-img"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>
                                            <input type="date" data-state="new_to" class="xdatetimepicker form-control" placeholder="Choose Date">
                                        </div>
                                     </div>
                                 </div>
                            </div>
							...
							<div class="row">
                                <div class="col-lg-3 col-sm-6 col-12">
                                    <div class="mb-3 add-product">
                                        ...
                                        <input type="number" data-state="discount" class="form-control">
                                    </div>
                                </div>
                                <div class="col-lg-3 col-sm-6 col-12">
                                    <div class="mb-3 add-product">
                                        <label class="form-label">Discount Per</label>
                                        <input type="number" data-state="discount_per" class="form-control">
                                    </div>
                                </div>
							    <div class="col-lg-6 col-sm-6 col-12">
                                    <div class="mb-3 add-product">
                                        <label class="form-label">Product Id</label>
                                          <select data-state="product_id" class="form-select">
...
<script>
    ...
    class Page extends AdminLayout {
        ...
        async uponReady() {
			...
			await this.loadEditor(~/api/dbx/ecom/product_variant/load_editor~, {});

            if (this.state.ret_data.product_variant_id < 1) {
                this.state.ret_data.product_variant_detail = [];
            }

            // Filter and map data for regular products
            const paTableData = this.state.ret_data.product_variant_detail;
            ...
            this.populateCombo(~[data-state="product_id"]~, this.state.view_collection["ecom.product"], "product_id", "title", this.state.ret_data.product_id);
		...
		async onClickSaveEditor(e) {
            ...
            this.state.payload["product_variant_detail"] = mpaTableData;
            ...
            for (const row of rows) {
                ...
                if (data[visibleFirstColumnField]) {
                    for (let field in data) {
                        ...
                        if (field === "product_variant_detail_id") {
        ...
        setupTabulator(tableKey, data) {
            ...
            // Step 1: Map product_variant_detail for Tabulator
            const tableData = (data||[]).map(detail => ({
                product_variant_detail_id: detail.product_variant_detail_id,
            ...
            this[tableKey] = new Tabulator("#"+tableKey, {
                ...
                columns:[ //Define Table Columns
                    {title:"Product Variant Detail ID", field:"product_variant_detail_id", visible: false},
        ...
        getTabulatorData(table, isProductVariant = false) {
            ...
            let myData= filteredRows.map(row => {
                ...
                //if(data.attrib_group_id && data.attrib_id) {
                    return {
                        product_variant_detail_id: data.product_variant_detail_id||0,
