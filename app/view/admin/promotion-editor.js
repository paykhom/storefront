...
export default class PromotionEditor extends AdminLayout {
...
yield html`
               ...
               <div class="row">
                   <div class="col-lg-6 col-sm-6 col-12">
                       <div class="mb-3 add-product">
                         ...
                         <input type="number" step="0.01" class="form-control" data-state="discount_value" required>
                       </div>
                    </div>
                     <div class="col-lg-6 col-sm-6 col-12">
                          <div class="mb-3 add-product">
                             <label class="form-label">Min Purchase Amount</label>
                            <input type="number" step="0.01" class="form-control" data-state="min_purchase_amount">
                         </div>
                     </div>
               </div>
               <div class="row">
                      <div class="col-lg-6 col-sm-6 col-12">
                           <div class="mb-3 add-product">
                              <label class="form-label">Max Discount Amount</label>
                               <input type="number" step="0.01" class="form-control" data-state="max_discount_amount">
                            </div>
                      </div>
                       <div class="col-lg-6 col-sm-6 col-12">
                          <div class="mb-3 add-product">
  ...
  <div class="col-lg-12">
   ...
   <input type="hidden" data-state="promotion_id"/>
</form>
					<!-- /form -->
