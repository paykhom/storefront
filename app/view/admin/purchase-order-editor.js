...
export default class PurchaseOrderEditor extends AdminLayout {
...
yield html`
                        ...
                        <div class="accordion-button" data-bs-toggle="collapse" data-bs-target="#collapseOne"
                            ...
                            <div class="addproduct-icon">
                                <h5><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    ...
                                    </svg><span>Purchase Order Information</span></h5>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-sm-6 col-12">
                                      <div class="mb-3 add-product">
                                          ...
                                          <input type="number" class="form-control" data-state="supplier_id" required>
                                        </div>
                                    </div>
                             </div>
                            <div class="row">
    ...
    <input type="hidden" data-state="purchase_order_id"/>
</form>
					<!-- /form -->
...
yield html`
    ...
    class Page extends AdminLayout {
        ...
        async uponReady() {
			...
			await this.loadEditor(~/api/dbx/ecom/purchase_order/load_editor~, {});
		}
    }
    page = new Page();
</script>
