...
export default class DroneDeliveryMarketplaceEditor extends AdminLayout {
...
yield html`
					<div class="page-header">
						<div class="add-item d-flex">
							<div class="page-title">
								<h4>Drone Delivery Marketplace</h4>
								<h6>&nbsp;</h6>
							</div>
						</div>
                        ...
                        <div class="accordion-button" data-bs-toggle="collapse" data-bs-target="#collapseOne"
                            ...
                            <div class="addproduct-icon">
                                <h5><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    ...
                                    </svg><span>Sales Order Information</span></h5>
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-sm-6 col-12">
                                      <div class="mb-3 add-product">
                                        ...
                                        <input type="number" step="0.01" class="form-control" data-state="discount_amount">
                                      </div>
                                  </div>
                                 <div class="col-lg-6 col-sm-6 col-12">
                                    <div class="mb-3 add-product">
                                        <label class="form-label">Sales Order Status ID</label>
                                       <input type="number" class="form-control" data-state="sales_order_status_id">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-6 col-sm-6 col-12">
                                 ...
                                 <div class="col-lg-6 col-sm-6 col-12">
                                      <div class="mb-3 add-product">
                                        ...
                                        <input type="number" class="form-control" data-state="ref_id">
                                      </div>
                                  </div>
                             </div>
                              <div class="row">
                                 <div class="col-lg-6 col-sm-6 col-12">
                                        <div class="mb-3 add-product">
                                            <label class="form-label">Sales Order Type ID</label>
                                           <input type="number" class="form-control" data-state="sales_order_type_id">
                                        </div>
                                  </div>
                                <div class="col-lg-6 col-sm-6 col-12">
                                     <div class="mb-3 add-product">
                                          <label class="form-label">Payment Status ID</label>
                                            <input type="number" class="form-control" data-state="payment_status_id">
                                        </div>
                                  </div>
                            </div>
                             <div class="row">
                                 <div class="col-lg-6 col-sm-6 col-12">
                                    <div class="mb-3 add-product">
                                        <label class="form-label">Payment Amount</label>
                                         <input type="number" step="0.01" class="form-control" data-state="payment_amount">
                                     </div>
                                  </div>
                                 <div class="col-lg-6 col-sm-6 col-12">
                                      <div class="mb-3 add-product">
                                        <label class="form-label">Drone Pickup Address ID</label>
                                        <input type="number" class="form-control" data-state="drone_pickup_address_id">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-6 col-sm-6 col-12">
                                    <div class="mb-3 add-product">
                                        <label class="form-label">Drone Pickup Latitude</label>
                                         <input type="number" step="0.00000001" class="form-control" data-state="drone_pickup_latitude">
                                    </div>
                                </div>
                                  <div class="col-lg-6 col-sm-6 col-12">
                                    <div class="mb-3 add-product">
                                        <label class="form-label">Drone Pickup Longitude</label>
                                         <input type="number" step="0.00000001" class="form-control" data-state="drone_pickup_longitude">
                                    </div>
                                </div>
                            </div>
                           <div class="row">
                                  <div class="col-lg-6 col-sm-6 col-12">
                                       <div class="mb-3 add-product">
                                            <label class="form-label">Drone Dropoff Latitude</label>
                                             <input type="number" step="0.00000001" class="form-control" data-state="drone_dropoff_latitude">
                                       </div>
                                   </div>
                                  <div class="col-lg-6 col-sm-6 col-12">
                                      <div class="mb-3 add-product">
                                        <label class="form-label">Drone Dropoff Longitude</label>
                                        <input type="number" step="0.00000001" class="form-control" data-state="drone_dropoff_longitude">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                 <div class="col-lg-6 col-sm-6 col-12">
                                      <div class="mb-3 add-product">
                                        <label class="form-label">Drone Package Details</label>
                                        <textarea class="form-control" rows="3" data-state="drone_package_details"></textarea>
                                    </div>
                                </div>
                                  <div class="col-lg-6 col-sm-6 col-12">
                                          <div class="mb-3 add-product">
                                            <label class="form-label">Drone Delivery Window Start</label>
                                             <div class="input-groupicon calender-input">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                                    stroke-linejoin="round" class="feather feather-calendar info-img">
                                                 ...
                                                 <input type="text" class="datetimepicker" placeholder="Choose Date" data-state="drone_delivery_window_start">
                                             </div>
                                        </div>
                                   </div>
                            </div>
                             <div class="row">
                                <div class="col-lg-6 col-sm-6 col-12">
                                        <div class="mb-3 add-product">
                                           <label class="form-label">Drone Delivery Window End</label>
                                            <div class="input-groupicon calender-input">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                                    stroke-linejoin="round" class="feather feather-calendar info-img">
                                                ...
                                                <input type="text" class="datetimepicker" placeholder="Choose Date" data-state="drone_delivery_window_end">
                                            </div>
                                        </div>
                                   </div>
                                    <div class="col-lg-6 col-sm-6 col-12">
                                        <div class="mb-3 add-product">
                                             <label class="form-label">Drone Compensation</label>
                                             <input type="number" step="0.01" class="form-control" data-state="drone_compensation" value="0">
                                        </div>
                                   </div>
    ...
    <div class="col-lg-12">
     ...
     <input type="hidden" data-state="sales_order_id"/>
</form>
					<!-- /form -->
...
<script>
    class Page extends AdminLayout {
        ...
        async uponReady() {
			...
			await this.loadEditor(~/dbx/ecom/drone_delivery/load_editor~, {});
		}
    }
    page = new Page();
</script>
