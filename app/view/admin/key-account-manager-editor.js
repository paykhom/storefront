...
export default class KeyAccountManagerEditor extends AdminLayout {
...
yield html`
            ...
            <div class="accordion-button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-controls="collapseOne">
              <div class="addproduct-icon">
                <h5>
                  ...
                  <span>Key Account Manager Information</span>
                </h5>
                    ...
                    <div class="col-lg-6 col-sm-6 col-12">
                        <div class="mb-3 add-product">
                             ...
                             <div class="input-groupicon calender-input">
                                                ...
                                                <input type="text" class="datetimepicker" placeholder="Choose Date" data-state="start_date" required>
                                             </div>
                                      </div>
                                </div>
                                 <div class="col-lg-6 col-sm-6 col-12">
                            ...
                            <div class="row">
                                 <div class="col-lg-6 col-sm-6 col-12">
                                        <div class="mb-3 add-product">
                                            ...
                                            <input type="number" step="0.01" class="form-control" data-state="sales_target">
                                        </div>
                                  </div>
                           </div>
  ...
  <div class="col-lg-12">
   ...
   <input type="hidden" data-state="key_account_manager_id"/>
</form>
					<!-- /form -->
...
<script>
    class Page extends AdminLayout {
        ...
        async uponReady() {
			...
			await this.loadEditor(~/api/dbx/ecom/key_account_manager/load_editor~, {});
		}
    }
    page = new Page();
</script>
