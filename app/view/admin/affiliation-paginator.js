...
export default class AffiliationPaginator extends AdminLayout {
			...
			async uponReady() {
				...
				let table = new DataTable(
					'#myDataTable',
					{
						...
						ajax: '/dtx/ecom/affiliation/search',
						processing: true,
						serverSide: true,
						pageLength: 25,
						columns: [
								...
								render: function (data, type, row) {
									return ~
										<div class="edit-delete-action">
											...
											<a class="me-2 p-2" href="/admin/marketing/affiliation/editor/-{row.affiliation_id}">
