...
export default class UomEditor extends SaasLayout {
...
yield html`
                        ...
                        <div class="accordion-button" data-bs-toggle="collapse" data-bs-target="#collapseOne"
                            ...
                            <div class="addproduct-icon">
                                <h5><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    ...
                                    </svg><span>Unit of Measure Information</span></h5>
                        ...
                        <div class="accordion-body">
                           ...
                           <div class="row">
                              <div class="col-lg-3 col-sm-6 col-12">
                                    <div class="mb-3 add-product">
                                        <label class="form-label">Base UOM ID</label>
                                        <input type="text" class="form-control" data-state="base_uom_id">
                                    </div>
                                </div>
                                 <div class="col-lg-3 col-sm-6 col-12">
                                     <div class="mb-3 add-product">
                                        <label class="form-label">Base UOM Conversion Factor</label>
                                          <input type="number" class="form-control" data-state="base_uom_conversion_factor" value="0">
                                    </div>
                                </div>
                                 <div class="col-lg-3 col-sm-6 col-12">
                                     <div class="mb-3 add-product">
                                          <label class="form-label">Has Each UOM</label>
                                        <select data-state="xhas_each_uom" class="form-select">
                            ...
                            <div class="row">
                                 <div class="col-lg-3 col-sm-6 col-12">
                                    <div class="mb-3 add-product">
                                          <label class="form-label">Each Quantity</label>
                                        <input type="number" class="form-control" data-state="xeach_quantity" value="0">
                                     </div>
                                </div>
                                <div class="col-lg-3 col-sm-6 col-12">
                                    <div class="mb-3 add-product">
                                          <label class="form-label">Each UOM ID</label>
                                         <input type="text" class="form-control" data-state="xeach_uom_id">
                                    </div>
                                </div>
                           </div>
    ...
    <div class="col-lg-12">
      ...
      <input type="hidden" data-state="uom_id" />
</form>
					<!-- /form -->
...
<script>
    class Page extends SaasLayout {
        ...
        async uponReady() {
			...
			await this.loadEditor(~/api/dbx/ecom/uom/load_editor~, {});
		}
    }
    page = new Page();
</script>
