...
export default class DepartmentEditor extends SaasLayout {
...
yield html`
					...
					<!-- form -->
					<form action="add-department.html">
    <div class="card">
                        ...
                        <div class="accordion-button" data-bs-toggle="collapse" data-bs-target="#collapseOne"
                            ...
                            <div class="addproduct-icon">
                                <h5><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    ...
                                    </svg><span>Department Information</span></h5>
    ...
    <input type="hidden" data-state="department_id"/>
</form>
					<!-- /form -->
...
<script>
    class Page extends SaasLayout {
        ...
        async uponReady() 
        {
            ...
            await this.loadEditor(~/api/dbx/ecom/department/load_editor~, {});
