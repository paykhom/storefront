...
export default class AttribEditor extends SaasLayout {
                             ...
                             <div class="row">
                                 <div class="col-lg-6 col-sm-6 col-12">
                                     <div class="mb-3 add-product">
                                        ...
                                        <!-- <select 
                                            data-state="attrib_group_id" 
                                            class="select select2-hidden-accessible" 
                                            data-select2-id="select2-data-1-2z5m" 
                                            tabindex="-1" 
                                            aria-hidden="true">
                                        </select> -->
                                        <select data-state="attrib_group_id" class="form-select">
                                            <option value="0" selected></option>
                                        </select>        
...
<script>
    class Page extends SaasLayout {
        ...
        async uponReady() {
			...
			await this.loadEditor(~/dbx/ecom/attrib/load_editor~, {});
