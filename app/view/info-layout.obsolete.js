...
<html lang="en">
   ...
   <body style="background-color: #f5f5f5;background: url(/_assets/images/info/bg-001-0-deg.png); background-size: contain; ; background-repeat: no-repeat">
      <!-- navigation -->
      <header class="xbg-dark" style="background-color: #ddd0">
         <div class="container-fluid">
            
            <div class="row align-items-center pt-4 pb-4 mt-4 mt-lg-0">
               <div class="col-xl-3 col-md-6 xcol-xl-2 xcol-md-3 mb-4 mb-md-0 xcol-12 text-center text-md-start">
               ...
               <div class="col-xl-6 col-md-6 xcol-xxl-6 xcol-xl-5 xcol-lg-6 xcol-md-9">
                  <form id="frm_global_search" action="#">
                     <div class="input-group">
                        <input class="form-control" type="search" placeholder="Search for products" aria-label="Global Search" aria-describedby="btn_global_search" style="background-color: #ddd0" />
                        <button class="btn btn-primary" type="button" id="btn_global_search">Search</button>
                     </div>
                  </form>
               </div>
               <div class="col-xl-3 col-md-12 xcol-xxl-4 xcol-xl-5 xcol-lg-3 d-lg-block">
      ...
      <nav class="navbar navbar-expand-lg navbar-light navbar-default p-0 p-sm-0 navbar-offcanvas-color" aria-label="Offcanvas navbar large" style="background-color: #ddd0">
         <div class="container-fluid">
            <div class="offcanvas offcanvas-start" tabindex="-1" id="navbar-default" aria-labelledby="navbar-defaultLabel">
               <div class="offcanvas-header pb-1">
                  <a href="/"><img  loading="lazy" data-src="/paykhom-nobg.png" alt="Paykhom Limited" /></a>
               ...
               <div class="offcanvas-body">
                  <div>
                     <ul class="navbar-nav align-items-center">
                        ...
                        <li class="nav-item">
                           <a class="nav-link" href="/shopping/category/page/1">Categories</a>
                        </li>
                        <!-- <li class="nav-item">
                           ...
                           <ul class="dropdown-menu">
                              ...
                              <li class="dropdown-submenu dropend">
                                 ...
                                 <ul class="dropdown-menu">
                                    ...
                                    <li><a class="dropdown-item" href="/user/notification">Notification</a></li>
                                 </ul>
                              </li>
                           </ul>
                        </li>
`; } `                         
            ...
            <div class="row g-4">
               <div class="col-xl-3 col-6">
                  ...
                  <ul class="nav flex-column">
                     ...
                     <li class="nav-item mb-2"><a href="/info/about" class="nav-link">About</a></li>
               ...
               <div class="col-xl-3 col-6">
                  <h6 class="mb-4 text-white">Become a Entrepreneur</h6>
                  <ul class="nav flex-column">
                     <!-- list -->
                     <li class="nav-item mb-2"><a href="/info/opportunity" class="nav-link">Entrepreneur Opportunities</a></li>
                     <li class="nav-item mb-2"><a href="/info/entrepreneur" class="nav-link">Become a Entrepreneur</a></li>
      ...
      <!--WHY: <script type="text/javascript">
      ...
      <script>
         ...
         class InfoLayout extends AppPage {
            constructor(args) {
               super(args);
         ...
         page = new InfoLayout(); // just, the fall-back, if no Page is instantiated by a particular page
         ////////////////////////////////////////////
