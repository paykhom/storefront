...
export default class OrderEditor extends UserLayout {
...
yield html`
					...
					<!-- form -->
					<form action="add-sales-order.html">
    <div class="card">
                                 ...
                                 <div class="col-lg-3 col-sm-6 col-12">
                                    <div class="mb-3 add-product">
                                        <label class="form-label">Order Date</label>
                                         ...
                                         <input type="text" class="datetimepicker" data-state="order_date" placeholder="Choose Date">
                                    </div>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-sm-6 col-12">
                                     <div class="mb-3 add-product">
                                        ...
                                        <input type="text" class="form-control" data-state="billing_address_id">
                                    </div>
                                </div>
                                <div class="col-lg-3 col-sm-6 col-12">
                                    <div class="mb-3 add-product">
                                         <label class="form-label">Shipping Address ID</label>
                                        <input type="text" class="form-control" data-state="shipping_address_id">
                                    </div>
                                </div>
                                 <div class="col-lg-3 col-sm-6 col-12">
                                    <div class="mb-3 add-product">
                            ...
                            <div class="row">
                                 <div class="col-lg-3 col-sm-6 col-12">
                                    <div class="mb-3 add-product">
                                        <label class="form-label">Shipping Method ID</label>
                                         <input type="text" class="form-control" data-state="shipping_method_id">
                                    </div>
                                </div>
                                 <div class="col-lg-3 col-sm-6 col-12">
                                     <div class="mb-3 add-product">
                                          <label class="form-label">Order Status ID</label>
                                         <input type="text" class="form-control" data-state="order_status_id">
                                    </div>
                                </div>
                                 <div class="col-lg-3 col-sm-6 col-12">
                                     <div class="mb-3 add-product">
                                ...
                                <div class="col-lg-3 col-sm-6 col-12">
                                    <div class="mb-3 add-product">
                                        ...
                                        <input type="text" class="form-control" data-state="coupon_id">
                                    </div>
                                </div>
                            </div>
                           ...
                           <div class="row">
                               <div class="col-lg-3 col-sm-6 col-12">
                                     <div class="mb-3 add-product">
                                         ...
                                         <input type="text" class="form-control" data-state="sales_order_status_id" required>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-sm-6 col-12">
                                    <div class="mb-3 add-product">
                                         <label class="form-label">Ref ST</label>
                                ...
                                <div class="col-lg-3 col-sm-6 col-12">
                                     <div class="mb-3 add-product">
                                         ...
                                         <input type="text" class="form-control" data-state="ref_id" required>
                                    </div>
                                </div>
                                  <div class="col-lg-3 col-sm-6 col-12">
                                      <div class="mb-3 add-product">
                                          <label class="form-label">Sales Order Type ID</label>
                                          <input type="text" class="form-control" data-state="sales_order_type_id" required>
                                      </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-3 col-sm-6 col-12">
                                    <div class="mb-3 add-product">
                                        ...
                                        <input type="text" class="form-control" data-state="payment_status_id" required>
                                    </div>
                                </div>
                                 <div class="col-lg-3 col-sm-6 col-12">
                                    <div class="mb-3 add-product">
                                  ...
                                  <div class="col-lg-3 col-sm-6 col-12">
                                     <div class="mb-3 add-product">
                                         <label class="form-label">WA Quantity</label>
                                         <input type="number" class="form-control" data-state="wa_quantity" value="0">
                                    </div>
                                </div>
                                  <div class="col-lg-3 col-sm-6 col-12">
                                      <div class="mb-3 add-product">
                                        <label class="form-label">WA Price</label>
                                        <input type="number" class="form-control" data-state="wa_price" value="0">
                                   </div>
                                </div>
                            </div>
                           ...
                           <div class="row">
                              <div class="col-lg-3 col-sm-6 col-12">
                                    <div class="mb-3 add-product">
                                        ...
                                        <input type="number" class="form-control" data-state="subtotal" value="0">
                                    </div>
                                </div>
                                 <div class="col-lg-3 col-sm-6 col-12">
                                      <div class="mb-3 add-product">
                                  ...
                                  <div class="col-lg-3 col-sm-6 col-12">
                                        <div class="mb-3 add-product">
                                            ...
                                            <input type="number" class="form-control" data-state="discount_amount" value="0">
                                       </div>
                                  </div>
                                  <div class="col-lg-3 col-sm-6 col-12">
                                     <div class="mb-3 add-product">
                                          <label class="form-label">Payment Amount</label>
                                          <input type="number" class="form-control" data-state="payment_amount" value="0">
                                      </div>
                                </div>
                             </div>
                           <div class="row">
                               <div class="col-lg-4 col-sm-6 col-12">
                                     <div class="mb-3 add-product">
                                        ...
                                        <input type="number" class="form-control" data-state="shipping_charge" value="0">
                                   </div>
                               </div>
                                <div class="col-lg-4 col-sm-6 col-12">
                                   <div class="mb-3 add-product">
                                       <label class="form-label">VAT</label>
                                       <input type="number" class="form-control" data-state="vat" value="0">
                                    </div>
                                </div>
                                <div class="col-lg-4 col-sm-6 col-12">
                                   <div class="mb-3 add-product">
                                       <label class="form-label">Tax</label>
                                      <input type="number" class="form-control" data-state="tax" value="0">
                                   </div>
                                </div>
                            </div>
                           ...
                           <div class="row">
                               <div class="col-lg-12 col-sm-12 col-12">
                                   <div class="mb-3 add-product">
                                        ...
                                        <input type="number" class="form-control" data-state="total" value="0">
                                    </div>
                                </div>
                            </div>
...
yield html`
    ...
    class Page extends UserLayout {
        ...
        async uponReady() {
			...
			await this.loadEditor(~/api/dbx/ecom/order/load_editor~, {});
		}
    }
    page = new Page();
</script>
