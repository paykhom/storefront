...
export default class BuyReturnEditor extends UserLayout {
...
yield html`
					...
					<!-- form -->
					<form action="add-buy-return.html">
    <div class="card">
                        ...
                        <div class="accordion-button" data-bs-toggle="collapse" data-bs-target="#collapseOne"
                            ...
                            <div class="addproduct-icon">
                                <h5><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    ...
                                    </svg><span>Buy Return Information</span></h5>
                        ...
                        <div class="accordion-body">
                           ...
                           <div class="row">
                                ...
                                <div class="col-lg-6 col-sm-6 col-12">
                                    <div class="mb-3 add-product">
                                        <label class="form-label">Return Date</label>
                                         ...
                                         <input type="text" class="datetimepicker" data-state="return_date" placeholder="Choose Date">
                                    </div>
                                   </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                 <div class="col-lg-3 col-sm-6 col-12">
                                    <div class="mb-3 add-product">
                                        <label class="form-label">Return Status ID</label>
                                         <input type="text" class="form-control" data-state="return_status_id">
                                    </div>
                                </div>
                                <div class="col-lg-3 col-sm-6 col-12">
                                    <div class="mb-3 add-product">
    ...
    <input type="hidden" data-state="buy_return_id" />
</form>
					<!-- /form -->
...
<script>
    class Page extends UserLayout {
        ...
        async uponReady() {
			...
			await this.loadEditor(~/api/dbx/ecom/buy_return/load_editor~, {});
		}
    }
    page = new Page();
</script>
