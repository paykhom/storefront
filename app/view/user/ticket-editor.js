...
export default class TicketEditor extends UserLayout {
...
yield html`
                        ...
                        <div class="accordion-button" data-bs-toggle="collapse" data-bs-target="#collapseOne"
                            ...
                            <div class="addproduct-icon">
                                <h5><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    ...
                                    </svg><span>Ticket Information</span></h5>
                            ...
                            <!-- <div class="row">
                                ...
                                <div class="col-lg-6 col-sm-6 col-12">
                                    <div class="mb-3 add-product">
                                        ...
                                        <input type="text" class="form-control" data-state="order_id">
                                    </div>
                                </div>
                            </div> -->
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-sm-6 col-12">
                                     <div class="mb-3 add-product">
                                         ...
                                         <select data-state="shop_id" class="form-select">
                                               <option xdata-select2-id="select2-data-3-uspg" value="0">Choose</option>
                                                <option value="1">Paykhom</option>
                                        </select>
                                     </div>
                                </div>
                                <div class="col-lg-6 col-sm-6 col-12">
                                    <div class="mb-3 add-product">
                                        ...
                                        <input type="text" class="form-control" data-state="subject" required>
                                    </div>
                                </div>
                            </div>
                             <div class="row">
                                 <div class="col-lg-6 col-sm-6 col-12">
                                     <div class="mb-3 add-product">
                                         ...
                                         <select data-state="ticket_priority_id" class="form-select">
                                 ...
                                 <div class="col-lg-6 col-sm-6 col-12">
                                    <div class="mb-3 add-product">
                                         ...
                                         <select data-state="department_id" class="form-select">
                            ...
                            <!-- <div class="row">
                                <div class="col-lg-6 col-sm-6 col-12">
                                    <div class="mb-3 add-product">
                                        ...
                                        <input type="text" class="form-control" data-state="assigned_to">
                                    </div>
                                </div>
                                 <div class="col-lg-6 col-sm-6 col-12">
                                    <div class="mb-3 add-product">
    ...
    <input type="hidden" data-state="ticket_id" />
</form>
					<!-- /form -->
...
<script>
    class Page extends UserLayout {
        ...
        async uponReady() {
			...
			await this.loadEditor(~/api/dbx/ecom/ticket/load_editor~, {});
		}
    }
    page = new Page();
</script>
