...
export default class RefundEditor extends UserLayout {
...
yield html`
					...
					<!-- form -->
					<form action="add-sales-refund.html">
    <div class="card">
                        ...
                        <div class="accordion-button" data-bs-toggle="collapse" data-bs-target="#collapseOne"
                            ...
                            <div class="addproduct-icon">
                                <h5><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    ...
                                    </svg><span>Sales Refund Information</span></h5>
                    ...
                    <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                        ...
                        <div class="accordion-body">
                            <div class="row">
                                <div class="col-lg-6 col-sm-6 col-12">
                                    <div class="mb-3 add-product">
                                        <label class="form-label">Sales Return ID</label>
                                        <input type="text" class="form-control" data-state="sales_return_id" required>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-sm-6 col-12">
                                    <div class="mb-3 add-product">
                                        <label class="form-label">Customer ID</label>
                                        <input type="text" class="form-control" data-state="customer_id" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-sm-6 col-12">
                                    <div class="mb-3 add-product">
                                        <label class="form-label">Sales Refund Date</label>
                                        <div class="input-groupicon calender-input">
                                           <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-calendar info-img"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>
                                             <input type="text" class="datetimepicker" data-state="sales_refund_date" placeholder="Choose Date">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-sm-6 col-12">
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-sm-6 col-12">
                                    <div class="mb-3 add-product">
                                        <label class="form-label">Sales Refund Amount</label>
                                        <input type="number" class="form-control" data-state="sales_refund_amount">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-sm-6 col-12">
                                    <div class="mb-3 add-product">
                                         <label class="form-label">Sales Refund Status</label>
                                        <input type="text" class="form-control" data-state="sales_refund_status_id">
                                    </div>
                                </div>
                            </div>
                             ...
                             <div class="row">
                                <div class="col-lg-12">
                                    <div class="input-blocks summer-description-box transfer mb-3">
                                        <label>Sales Refund Reason</label>
                                        <textarea class="form-control h-100" rows="3" data-state="sales_refund_reason"></textarea>
                                    </div>
                                </div>
                            </div>
                             <div class="row">
                                <div class="col-lg-12">
                                    <div class="input-blocks summer-description-box transfer mb-3">
                                        ...
                                        <textarea class="form-control h-100" rows="3" data-state="narration"></textarea>
                                    </div>
                                </div>
                            </div>
    ...
    <input type="hidden" data-state="sales_refund_id" />
</form>
					<!-- /form -->
...
<script>
    class Page extends UserLayout {
        ...
        async uponReady() {
			...
			await this.loadEditor(~/api/dbx/ecom/buy_refund/load_editor~, {});
		}
    }
    page = new Page();
</script>
