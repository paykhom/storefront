...
export default class ProductReviewEditor extends UserLayout {
...
yield html`
					...
					<!-- form -->
					<form action="add-product-review.html">
    <div class="card">
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-sm-6 col-12">
                                    <div class="mb-3 add-product">
                                        ...
                                        <input type="text" class="form-control" data-state="product_id" required>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-sm-6 col-12">
                                    <div class="mb-3 add-product">
