...
export default class Opportunity extends MarketplaceLayout {
            ...
            <div class="container-fluid">
               <div class="row align-items-center">
                  <div class="col-md-6">
                   ...
                   <div class="col-md-6">
                        <img  loading="lazy" data-src="/_assets/images/info/opportunity.webp" width="100%"  alt="Entrepreneur Image" class="img-fluid rounded">
                    </div>
                </div>
            </div>
        </section>
