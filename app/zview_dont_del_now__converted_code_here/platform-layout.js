...
export default class  PlatformLayout extends View /* TODO: Theme*/
{
...
<html lang="en" data-bs-theme="light"><head>
    ...
    <link rel="icon" type="image/png" href="/theme/around/assets/app-icons/icon-32x32.png" sizes="32x32">
    <link rel="apple-touch-icon" href="/theme/around/assets/app-icons/icon-180x180.png">
        
    <!-- Theme switcher (color modes) -->
    <script type="text/javascript" async="" src="https://www.google-analytics.com/analytics.js"></script><script type="text/javascript" async="" src="https://www.googletagmanager.com/gtag/js?id=G-TXTBFKF5EW&amp;l=dataLayer&amp;cx=c&amp;gtm=45He52d0v813450744za200"></script><script async="" src="https://www.googletagmanager.com/gtm.js?id=GTM-WKV3GT5"></script><script src="/theme/around/assets/js/theme-switcher.js"></script>
    ...
    <!-- Vendor styles -->
    <link rel="stylesheet" media="screen" href="/theme/around/assets/vendor/aos/dist/aos.css">
    <link rel="stylesheet" media="screen" href="/theme/around/assets/vendor/lightgallery/css/lightgallery-bundle.min.css">

    <!-- Font icons -->
    <link rel="stylesheet" href="/theme/around/assets/icons/around-icons.min.css">

    <!-- Theme styles + Bootstrap -->
    <link rel="stylesheet" media="screen" href="/theme/around/assets/css/theme.min.css">

    <!-- Customizer generated styles -->
    <style id="customizer-styles">:root{}.btn-primary{}.btn-warning{}.btn-info{}.btn-success{}.btn-danger{}.btn-outline-primary{}.btn-outline-warning{}.btn-outline-info{}.btn-outline-success{}.btn-outline-danger{}.accordion-button:not(.collapsed)::after{}</style>
  ...
  <header class="navbar navbar-expand-lg fixed-top">
      ...
      <div class="container position-relative z-2 pb-xl-2 pt-2 pt-sm-3 pt-xl-4 pt-xxl-5">
        <div class="row pb-5 pt-md-3 pt-lg-4 mb-md-3 mb-lg-4">
          <div class="col-md-6 col-xxl-5 pb-3 pb-md-0 mb-2 mb-sm-3 mb-md-0">
            <div class="h1 pb-3">Support us on Kickstarter and get <span style="background: linear-gradient(90.72deg, #cbfdb1 3.49%, #acbff1 50.67%, #efa7ec 100.79%); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">20% discount</span> on headphones</div>
      ...
      <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body py-4">
            ...
            <p class="mb-4"><span class="fw-medium">IMPORTANT:</span> In order for these styles to take effect you have to placed them below:<br><code>&lt;link rel="stylesheet" media="screen" href="/theme/around/assets/css/theme.min.css"&gt;</code></p>
    ...
    <script src="/theme/around/assets/vendor/@lottiefiles/lottie-player/dist/lottie-player.js"></script>
    <script src="/theme/around/assets/vendor/aos/dist/aos.js"></script>
    <script src="/theme/around/assets/vendor/lightgallery/lightgallery.min.js"></script>
    <script src="/theme/around/assets/vendor/lightgallery/plugins/video/lg-video.min.js"></script>

    <!-- Bootstrap + Theme scripts -->
    <script src="/theme/around/assets/js/theme.min.js"></script>
    ...
    <!-- Customizer -->
    <script src="/theme/around/assets/js/customizer.min.js"></script><iframe allow="join-ad-interest-group" data-tagging-id="G-TXTBFKF5EW" data-load-time="1739948658021" height="0" width="0" src="https://td.doubleclick.net/td/ga/rul?tid=G-TXTBFKF5EW&amp;gacid=547758297.1739945030&amp;gtm=45je52d0v884391085z8813450744za200zb813450744&amp;dma=0&amp;gcd=13l3l3l3l1l1&amp;npa=0&amp;pscdl=noapi&amp;aip=1&amp;fledge=1&amp;frm=0&amp;tag_exp=102067808~102482432~102539968~102558064~102587591~102605417~102640600~102658452&amp;z=1538780658" style="display: none; visibility: hidden;"></iframe>
...
yield html~
	<script>
         class PlatformLayout extends AppPage {
            constructor(args) {
                super(args);
         ...
         page = new PlatformLayout(); // just, the fall-back, if no Page is instantiated by a particular page
         ////////////////////////////////////////////
