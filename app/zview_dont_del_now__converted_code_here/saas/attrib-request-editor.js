...
export default class AttribRequestEditor extends SaasLayout {
...
yield html`
                        ...
                        <div class="accordion-button" data-bs-toggle="collapse" data-bs-target="#collapseOne"
                            ...
                            <div class="addproduct-icon">
                                <h5><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    ...
                                    </svg><span>Attribute Information</span></h5>
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-sm-6 col-12">
                                    <div class="mb-3 add-product">
                                        ...
                                        <input type="number" class="form-control" data-state="length">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-sm-6 col-12">
                                     <div class="mb-3 add-product">
                                        <label class="form-label">Precision</label>
                                        <input type="number" class="form-control" data-state="precision">
                                    </div>
                                </div>
                            </div>
                              <div class="row">
                                 <div class="col-lg-6 col-sm-6 col-12">
                                    <div class="mb-3 add-product">
                                        ...
                                        <input type="text" class="form-control" data-state="publication_status_id" value="1">
                                    </div>
                                </div>
                                   <div class="col-lg-6 col-sm-6 col-12">
                                    <div class="mb-3 add-product">
                                       <label class="form-label">User ID</label>
                                         <input type="text" class="form-control" data-state="user_id">
                                    </div>
                                </div>
                             </div>
                             <div class="row">
                                 <div class="col-lg-6 col-sm-6 col-12">
                                     <div class="mb-3 add-product">
                                          <label class="form-label">Attribute Group ID</label>
                                        <input type="text" class="form-control" data-state="attrib_group_id" value="0">
                                    </div>
                                </div>
                                 <div class="col-lg-6 col-sm-6 col-12">
                                     <div class="mb-3 add-product">
                                         <label class="form-label">Scope ID</label>
                                          <input type="text" class="form-control" data-state="scope_id" value="1" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                             ...
                             <div class="row">
                               <div class="col-lg-3 col-sm-6 col-12">
                                     <div class="mb-3 add-product">
                                        <label class="form-label">Value Has UOM</label>
                                          <select data-state="value_has_uom" class="form-select">
                                  ...
                                  <div class="col-lg-3 col-sm-6 col-12">
                                     <div class="mb-3 add-product">
                                           <label class="form-label">Is Searchable</label>
                                        <select data-state="is_searchable" class="form-select">
                                              <option value="true">Yes</option>
                                  ...
                                  <div class="col-lg-6 col-sm-6 col-12">
                                      <div class="mb-3 add-product">
                                        <label class="form-label">Is UOM Applicable</label>
                                         <select data-state="is_uom_applicable" class="form-select">
                                              <option value="true">Yes</option>
                                              <option value="false">No</option>
                                        </select>
                                    </div>
    ...
    <input type="hidden" data-state="attrib_id" />
</form>
					<!-- /form -->
...
yield html`
    ...
    class Page extends SaasLayout {
        ...
        async uponReady() {
			...
			await this.loadEditor(~/api/dbx/ecom/attrib/load_editor~, { publication_status_id:4 });
