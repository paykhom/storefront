...
export default class DropshipEditor extends SaasLayout {
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-sm-6 col-12">
                                    <div class="mb-3 add-product">
                                        ...
                                        <input type="text" class="form-control" data-state="site_id">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-sm-6 col-12">
                                    <div class="mb-3 add-product">
                                         <label class="form-label">Shop Type ID</label>
                                        <input type="text" class="form-control" data-state="shop_type_id">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="input-blocks summer-description-box transfer mb-3">
                                        <label>Excerpt</label>
                                         <textarea class="form-control h-100" rows="5" data-state="excerpt"></textarea>
