...
export default class RoleEditor extends SaasLayout {
...
yield html`
                        ...
                        <div class="accordion-button" data-bs-toggle="collapse" data-bs-target="#collapseOne"
                            ...
                            <div class="addproduct-icon">
                                <h5><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    ...
                                    </svg><span>Role Information</span></h5>
   ...
   <input type="hidden" data-state="role_id"/>
</form>
					<!-- /form -->
...
yield html`
    ...
    class Page extends SaasLayout {
        ...
        async uponReady() {
			...
			await this.loadEditor(~/dbx/saas/role/load_editor~, {});
		}
    }
    page = new Page();
</script>
