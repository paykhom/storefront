...
export default class IndexAdmin extends AdminLayout {
						...
						<div class="card-body" style="min-height: 200px">
                            <div class="looking-something">
                                <div class="section-header text-center aos aos-init aos-animate" data-aos="fade-up">
                                    <h2>Welcome back to <span>Paykhom Admin Panel</span></h2>		
                                </div>
                                <div class="banner-wrap-btn justify-content-center mb-0">
                                    <div class="banner-btns">
                                    </div>
                                    <div class="banner-btns me-0">
                                    </div>
                                </div>
                            </div>
