...
export default class RefundEditor extends AdminLayout {
                        ...
                        <div class="accordion-button" data-bs-toggle="collapse" data-bs-target="#collapseOne"
                            ...
                            <div class="addproduct-icon">
                                <h5><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    ...
                                    </svg><span>Refund Information</span></h5>
                             ...
                             <div class="row">
                                <div class="col-lg-6 col-sm-6 col-12">
                                        <div class="mb-3 add-product">
                                            ...
                                            <input type="number" class="form-control" data-state="sales_return_id" required>
                                        </div>
                                    </div>
                                   <div class="col-lg-6 col-sm-6 col-12">
                                         <div class="mb-3 add-product">
                                        ...
                                        <div class="mb-3 add-product">
                                            <label class="form-label">Refund Date</label>
                                             <div class="input-groupicon calender-input">
                                                ...
                                                <input type="text" class="datetimepicker" placeholder="Choose Date" data-state="refund_date">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-sm-6 col-12">
                                  ...
                                  <div class="col-lg-6 col-sm-6 col-12">
                                       <div class="mb-3 add-product">
                                         <label class="form-label">Refund Amount</label>
                                          <input type="number" step="0.01" class="form-control" data-state="refund_amount">
                                      </div>
                                  </div>
                                   <div class="col-lg-6 col-sm-6 col-12">
                                         <div class="mb-3 add-product">
                                            <label class="form-label">Refund Status ID</label>
                                             <input type="number" class="form-control" data-state="refund_status_id">
                                          </div>
                                      </div>
                            </div>
                            <div class="row">
                             ...
                             <div class="row">
                                 <div class="col-lg-12 col-sm-12 col-12">
                                    <div class="mb-3 add-product">
                                          ...
                                          <textarea class="form-control" rows="5" data-state="refund_reason"></textarea>
                                     </div>
                                  </div>
                             </div>
                             <div class="row">
...
yield html`
    ...
    class Page extends AdminLayout {
        ...
        async uponReady() {
			...
			await this.loadEditor(~/api/dbx/ecom/refunc/load_editor~, {});
		}
    }
    page = new Page();
</script>
