...
export default class StocktransferPaginator extends AdminLayout {
						...
						<div class="card-body">
							<div class="table-top">
								...
								<div class="form-sort">
									...
									<select class="select select2-hidden-accessible" data-select2-id="select2-data-1-na94" tabindex="-1" aria-hidden="true">
										<option data-select2-id="select2-data-3-bpzu">Sort by Date</option>
										<option>Newest</option>
										<option>Oldest</option>
									</select><span class="select2 select2-container select2-container--default" dir="ltr" data-select2-id="select2-data-2-bs07" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-disabled="false" aria-labelledby="select2-odgl-container" aria-controls="select2-odgl-container"><span class="select2-selection__rendered" id="select2-odgl-container" role="textbox" aria-readonly="true" title="Sort by Date">Sort by Date</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
								</div>
							</div>
							<!-- /Filter -->
									...
									<div class="row">
										<div class="col-lg-3 col-sm-6 col-12">
											<div class="input-blocks">
												...
												<select class="select select2-hidden-accessible" data-select2-id="select2-data-4-73is" tabindex="-1" aria-hidden="true">
													<option data-select2-id="select2-data-6-ivoc">Warehouse From</option>
													<option>Lobar Handy</option>
													<option>Quaint Warehouse</option>
													<option>Traditional Warehouse</option>
													<option>Cool Warehouse</option>
												</select><span class="select2 select2-container select2-container--default" dir="ltr" data-select2-id="select2-data-5-xulo" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-disabled="false" aria-labelledby="select2-i6p7-container" aria-controls="select2-i6p7-container"><span class="select2-selection__rendered" id="select2-i6p7-container" role="textbox" aria-readonly="true" title="Warehouse From">Warehouse From</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
											</div>
										</div>
										<div class="col-lg-3 col-sm-6 col-12">
											<div class="input-blocks">
												...
												<select class="select select2-hidden-accessible" data-select2-id="select2-data-7-yx1l" tabindex="-1" aria-hidden="true">
													<option data-select2-id="select2-data-9-kvwa">Warehouse To</option>
													<option>Selosy</option>
													<option>Logerro</option>
													<option>Vesloo</option>
													<option>Crompy</option>
												</select><span class="select2 select2-container select2-container--default" dir="ltr" data-select2-id="select2-data-8-3d5t" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-disabled="false" aria-labelledby="select2-oz4f-container" aria-controls="select2-oz4f-container"><span class="select2-selection__rendered" id="select2-oz4f-container" role="textbox" aria-readonly="true" title="Warehouse To">Warehouse To</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
											</div>
										</div>
										<div class="col-lg-3 col-sm-6 col-12">
											<div class="input-blocks">
								...
								<div id="DataTables_Table_0_wrapper" class="dataTables_wrapper dt-bootstrap5 no-footer table-responsive"><table class="table datanew dataTable no-footer" id="DataTables_Table_0" aria-describedby="DataTables_Table_0_info">
									<thead>
										<tr><th class="no-sort sorting sorting_asc" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-sort="ascending" aria-label="
											...
											: activate to sort column descending" style="width: 35.0312px;">
												<label class="checkboxs">
													<input type="checkbox" id="select-all">
													<span class="checkmarks"></span>
												</label>
											</th><th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="From Warehouse: activate to sort column ascending" style="width: 128.547px;">From Warehouse</th><th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="To Warehouse: activate to sort column ascending" style="width: 98.8125px;">To Warehouse</th><th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="No of Products: activate to sort column ascending" style="width: 101.828px;">No of Products</th><th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Quantity transfered: activate to sort column ascending" style="width: 133.984px;">Quantity transfered</th><th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Ref Number: activate to sort column ascending" style="width: 82.4375px;">Ref Number</th><th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Date: activate to sort column ascending" style="width: 60.2344px;">Date</th><th class="no-sort sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Action: activate to sort column ascending" style="width: 58.125px;">Action</th></tr>
									</thead>
									<tbody>
