...
export default class StockInventoryEditor extends AdminLayout {
...
yield html`
					...
					<!-- form -->
					<form action="add-product-variant.html">
    <div class="card">
                        ...
                        <div class="accordion-button" data-bs-toggle="collapse" data-bs-target="#collapseOne"
                            ...
                            <div class="addproduct-icon">
                                <h5><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    ...
                                    </svg><span>Product Variant Information</span></h5>
                             ...
                             <div class="row">
                                <div class="col-lg-6 col-sm-6 col-12">
                                    <div class="mb-3 add-product">
                                        ...
                                        <input type="text" class="form-control" data-state="product_id">
                                    </div>
                                </div>
                                 <div class="col-lg-6 col-sm-6 col-12">
                                    <div class="mb-3 add-product">
                                 ...
                                 <div class="col-lg-6 col-sm-6 col-12">
                                        <div class="mb-3 add-product">
                                            <label class="form-label">SKU</label>
                                             <input type="text" class="form-control" data-state="sku">
                                        </div>
                                    </div>
                            </div>
                             <div class="row">
                            ...
                            <div class="row">
                                <div class="col-lg-3 col-sm-6 col-12">
                                     <div class="mb-3 add-product">
                                        ...
                                        <input type="number" class="form-control" data-state="cost" value="0" required>
                                   </div>
                                </div>
                                <div class="col-lg-3 col-sm-6 col-12">
                                     <div class="mb-3 add-product">
                                         <label class="form-label">List Price</label>
                                          <input type="number" class="form-control" data-state="list_price">
                                    </div>
                                </div>
                                 <div class="col-lg-3 col-sm-6 col-12">
                                     <div class="mb-3 add-product">
                                         <label class="form-label">Price</label>
                                          <input type="number" class="form-control" data-state="price">
                                    </div>
                                </div>
                                 <div class="col-lg-3 col-sm-6 col-12">
                                    <div class="mb-3 add-product">
                                        <label class="form-label">Discount</label>
                                        <input type="number" class="form-control" data-state="discount" value="0">
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="mb-3 add-product">
                                         ...
                                         <div class="input-groupicon calender-input">
                                          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-calendar info-img"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>
                                           <input type="text" class="datetimepicker" data-state="new_from" placeholder="Choose Date">
                                       </div>
                                    </div>
                                </div>
                                 <div class="col-lg-3 col-sm-6 col-12">
                                     <div class="mb-3 add-product">
                                          ...
                                          <div class="input-groupicon calender-input">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-calendar info-img"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>
                                          <input type="text" class="datetimepicker" data-state="new_to" placeholder="Choose Date">
                                        </div>
                                     </div>
                                </div>
                                <div class="col-lg-3 col-sm-6 col-12">
                                    <div class="mb-3 add-product">
                                        ...
                                        <input type="number" class="form-control" data-state="discount_per" value="0">
                                    </div>
                                </div>
                                 <div class="col-lg-3 col-sm-6 col-12">
                                      <div class="mb-3 add-product">
                                          <label class="form-label">Discounted Price</label>
                                           <input type="number" class="form-control" data-state="discounted_price" value="0">
                                       </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                  <div class="col-lg-3 col-sm-6 col-12">
                                    <div class="mb-3 add-product">
                                        ...
                                        <input type="number" class="form-control" data-state="availability_id" value="1" required>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-sm-6 col-12">
                                    <div class="mb-3 add-product">
                                       <label class="form-label">Availability Const</label>
                                        <input type="text" class="form-control" data-state="availability_const">
                                     </div>
                                </div>
                                <div class="col-lg-3 col-sm-6 col-12">
                                   <div class="mb-3 add-product">
                                       <label class="form-label">Is Shorting Allowed</label>
                                        <select data-state="is_shorting_allowed" class="form-select">
                                             <option value="true" selected>Yes</option>
                                             <option value="false">No</option>
                                          </select>
                                    </div>
                            ...
                            <div class="row">
                               <div class="col-lg-3 col-sm-6 col-12">
                                    <div class="mb-3 add-product">
                                        ...
                                        <input type="number" class="form-control" data-state="quantity" value="0">
                                    </div>
                                </div>
                                 <div class="col-lg-3 col-sm-6 col-12">
                                    <div class="mb-3 add-product">
                                         <label>Quantity Perpetual</label>
                                        <input type="number" class="form-control" data-state="quantity_perpetual" value="0">
                                    </div>
                                </div>
                                <div class="col-lg-3 col-sm-6 col-12">
                                      <div class="mb-3 add-product">
                                           <label>Quantity Periodic</label>
                                           <input type="number" class="form-control" data-state="quantity_periodic" value="0">
                                    </div>
                                </div>
                                 <div class="col-lg-3 col-sm-6 col-12">
                                       <div class="mb-3 add-product">
                                            <label>Quantity FIFO</label>
                                            <input type="number" class="form-control" data-state="quantity_fifo" value="0">
                                       </div>
                                  </div>
                            </div>
                             <div class="row">
                                 <div class="col-lg-3 col-sm-6 col-12">
                                     <div class="mb-3 add-product">
                                          <label>Quantity LIFO</label>
                                        <input type="number" class="form-control" data-state="quantity_lifo" value="0">
                                   </div>
                                </div>
                                 <div class="col-lg-3 col-sm-6 col-12">
                                      <div class="mb-3 add-product">
                                           <label>Quantity On PO</label>
                                          <input type="number" class="form-control" data-state="quantity_on_po" value="0">
                                      </div>
                                 </div>
                                  <div class="col-lg-3 col-sm-6 col-12">
                                    <div class="mb-3 add-product">
                                         <label>Quantity On SO</label>
                                       <input type="number" class="form-control" data-state="quantity_on_so" value="0">
                                   </div>
                                </div>
                                   <div class="col-lg-3 col-sm-6 col-12">
                                    <div class="mb-3 add-product">
                                        <label class="form-label">Price WA</label>
                                       <input type="number" class="form-control" data-state="price_wa" value="0">
                                    </div>
                                </div>
                             </div>
                            <div class="row">
                                  <div class="col-lg-3 col-sm-6 col-12">
                                    <div class="mb-3 add-product">
                                         <label class="form-label">Price FIFO</label>
                                        <input type="number" class="form-control" data-state="price_fifo" value="0">
                                   </div>
                                 </div>
                                  <div class="col-lg-3 col-sm-6 col-12">
                                    <div class="mb-3 add-product">
                                         <label class="form-label">Price LIFO</label>
                                         <input type="number" class="form-control" data-state="price_lifo" value="0">
                                    </div>
                                </div>
                                   <div class="col-lg-3 col-sm-6 col-12">
                                    <div class="mb-3 add-product">
                                         <label class="form-label">Cost WA</label>
                                          <input type="number" class="form-control" data-state="cost_wa" value="0">
                                    </div>
                                </div>
                                  <div class="col-lg-3 col-sm-6 col-12">
                                   <div class="mb-3 add-product">
                                       <label class="form-label">Cost FIFO</label>
                                         <input type="number" class="form-control" data-state="cost_fifo" value="0">
                                    </div>
                                </div>
                           </div>
                          <div class="row">
                               <div class="col-lg-3 col-sm-6 col-12">
                                    <div class="mb-3 add-product">
                                       <label class="form-label">Cost LIFO</label>
                                       <input type="number" class="form-control" data-state="cost_lifo" value="0">
                                    </div>
                                </div>
                                <div class="col-lg-3 col-sm-6 col-12">
                                    <div class="mb-3 add-product">
                                         <label class="form-label">Min Level</label>
                                          <input type="number" class="form-control" data-state="min_level">
                                    </div>
                                </div>
                                  <div class="col-lg-3 col-sm-6 col-12">
                                       <div class="mb-3 add-product">
                                           <label class="form-label">Max Level</label>
                                          <input type="number" class="form-control" data-state="max_level">
                                       </div>
                                   </div>
                                    <div class="col-lg-3 col-sm-6 col-12">
                                        <div class="mb-3 add-product">
                                             <label class="form-label">Reorder Level</label>
                                            <input type="number" class="form-control" data-state="reorder_level">
                                        </div>
                                    </div>
                           </div>
                           <div class="row">
                                <div class="col-lg-3 col-sm-6 col-12">
                                    <div class="mb-3 add-product">
                                        <label class="form-label">Reorder Quantity</label>
                                         <input type="number" class="form-control" data-state="reorder_quantity">
                                    </div>
                                </div>
                                 <div class="col-lg-3 col-sm-6 col-12">
                                     <div class="mb-3 add-product">
                                         <label class="form-label">Lead Time Days</label>
                                        <input type="number" class="form-control" data-state="lead_time_days">
                                   </div>
                                </div>
                            </div>
     ...
     <input type="hidden" data-state="product_variant_id"/>
</form>
					<!-- /form -->
...
<script>
    class Page extends AdminLayout {
        ...
        async uponReady() {
			...
			await this.loadEditor(~/api/dbx/ecom/stock/load_editor~, {});
		}
    }
    page = new Page();
</script>
