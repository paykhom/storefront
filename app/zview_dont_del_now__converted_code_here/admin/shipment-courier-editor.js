...
export default class ShipmentCourierEditor extends AdminLayout {
            ...
            <div class="accordion-button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-controls="collapseOne">
              <div class="addproduct-icon">
                <h5>
                  ...
                  <span>Sales Return Information</span>
                </h5>
              ...
              <div class="row">
                <div class="col-lg-6 col-sm-6 col-12">
                  <div class="mb-3 add-product">
                    ...
                    <input type="number" class="form-control" data-state="sale_id" required>
                  </div>
                </div>
                 <div class="col-lg-6 col-sm-6 col-12">
                    <div class="mb-3 add-product">
                    ...
                    <div class="mb-3 add-product">
                        <label class="form-label">Return Date</label>
                          <div class="input-groupicon calender-input">
                                ...
                                <input type="text" class="datetimepicker" placeholder="Choose Date" data-state="return_date">
                            </div>
                       </div>
                </div>
             </div>
                     ...
                     <div class="col-lg-6 col-sm-6 col-12">
                         <div class="mb-3 add-product">
                             <label class="form-label">Return Status ID</label>
                              <input type="number" class="form-control" data-state="return_status_id">
                          </div>
                     </div>
               </div>
