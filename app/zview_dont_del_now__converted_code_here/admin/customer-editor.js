...
export default class CustomerEditor extends AdminLayout {
...
yield html`
    ...
    <div class="card">
                                     ...
                                     <div class="mb-3 add-product">
                                        <label class="form-label">Registration Date Time</label>
                                         <div class="input-groupicon calender-input">
                                                ...
                                                <input type="text" class="datetimepicker" placeholder="Choose Date" data-state="reg_dts">
                                            </div>
                                    </div>
                                 </div>
                            </div>
     ...
     <input type="hidden" data-state="customer_id"/>
</form>
					<!-- /form -->
